...
const DOMAIN_POLICIES = {
  ...
  event: {
    roles:
      '["staff", "event_coordinator", "catering_manager", "event_manager", "manager", "admin"]',
    desc: "Event and event-related entity management",
  },
  catering: {
    roles: '["event_coordinator", "catering_manager", "manager", "admin"]',
    desc: "Catering order management",
  },
  "ai-event": {
    roles: '["staff", "event_coordinator", "manager", "admin"]',
    desc: "AI event setup",
  },

  // Kitchen domain - all kitchen roles + staff for task viewing
  dish: {
    roles: '["staff", "kitchen_staff", "kitchen_lead", "manager", "admin"]',
    desc: "Kitchen dish management",
  },
  recipe: {
    roles: '["staff", "kitchen_staff", "kitchen_lead", "manager", "admin"]',
    desc: "Recipe management",
  },
  allergen: {
    roles: '["staff", "kitchen_staff", "kitchen_lead", "manager", "admin"]',
    desc: "Allergen warning management",
  },
  "prep-method": {
    roles: '["staff", "kitchen_staff", "kitchen_lead", "manager", "admin"]',
    desc: "Prep method management",
  },
  "prep-task": {
    roles: '["staff", "kitchen_staff", "kitchen_lead", "manager", "admin"]',
    desc: "Prep task management",
  },
  "prep-list": {
    roles: '["staff", "kitchen_staff", "kitchen_lead", "manager", "admin"]',
    desc: "Prep list management",
  },
  "prep-comment": {
    roles: '["staff", "kitchen_staff", "kitchen_lead", "manager", "admin"]',
    desc: "Prep comment management",
  },
  "kitchen-task": {
    roles: '["staff", "kitchen_staff", "kitchen_lead", "manager", "admin"]',
    desc: "Kitchen task management",
  },
  "kitchen-extended": {
    roles: '["staff", "kitchen_staff", "kitchen_lead", "manager", "admin"]',
    desc: "Kitchen extended entities",
  },
  menu: {
    roles: '["staff", "kitchen_staff", "kitchen_lead", "manager", "admin"]',
  ...
  inventory: {
    roles:
      '["kitchen_staff", "kitchen_lead", "inventory_manager", "manager", "admin"]',
    desc: "Inventory management",
  },
  ingredient: {
    roles:
      '["kitchen_staff", "kitchen_lead", "inventory_manager", "manager", "admin"]',
    desc: "Ingredient management",
  },
  waste: {
    roles:
      '["kitchen_staff", "kitchen_lead", "inventory_manager", "manager", "admin"]',
  ...
  "bulk-order": {
    roles:
      '["kitchen_staff", "kitchen_lead", "inventory_manager", "manager", "admin"]',
    desc: "Bulk order management",
  },

  // CRM/Sales domain
  client: {
    roles: '["sales", "sales_rep", "sales_manager", "manager", "admin"]',
    desc: "Client management",
  },
  "client-interaction": {
    roles: '["sales", "sales_rep", "sales_manager", "manager", "admin"]',
    desc: "Client interaction tracking",
  },
  lead: {
    roles: '["sales", "sales_rep", "sales_manager", "manager", "admin"]',
  ...
  // Finance domain
  invoice: {
    roles: '["finance", "finance_manager", "manager", "admin"]',
  ...
  collection: {
    roles: '["finance", "finance_manager", "manager", "admin"]',
    desc: "Collections management",
  },
  revenue: {
    roles: '["finance", "finance_manager", "manager", "admin"]',
    desc: "Revenue recognition",
  },
  budget: {
    roles: '["finance", "finance_manager", "manager", "admin"]',
    desc: "Budget management",
  },
  "labor-budget": {
    roles: '["finance", "finance_manager", "manager", "admin"]',
    desc: "Labor budget management",
  },
  "chart-of-account": {
    roles: '["finance", "finance_manager", "manager", "admin"]',
  ...
  "bank-account": {
    roles: '["finance", "finance_manager", "manager", "admin"]',
    desc: "Bank account management",
  },
  "pricing-tier": {
    roles: '["finance", "finance_manager", "manager", "admin"]',
    desc: "Pricing tier management",
  },

  // Staff/HR domain
  "employee-availability": {
    roles: '["hr_admin", "payroll_admin", "manager", "admin"]',
    desc: "Employee availability",
  },
  "employee-certification": {
    roles: '["hr_admin", "payroll_admin", "manager", "admin"]',
    desc: "Employee certifications",
  },
  payroll: {
    roles: '["hr_admin", "payroll_admin", "manager", "admin"]',
  ...
  "time-entry": {
    roles: '["hr_admin", "payroll_admin", "manager", "admin"]',
    desc: "Time entry management",
  },
  "time-off": {
    roles: '["hr_admin", "payroll_admin", "manager", "admin"]',
    desc: "Time off requests",
  },
  "staff-member": {
    roles: '["hr_admin", "payroll_admin", "manager", "admin"]',
    desc: "Staff member management",
  },
  "staff-performance": {
    roles: '["hr_admin", "payroll_admin", "manager", "admin"]',
  ...
  "staff-logistics": {
    roles: '["hr_admin", "payroll_admin", "manager", "admin"]',
    desc: "Staff logistics",
  },
  "training-assignment": {
    roles: '["hr_admin", "payroll_admin", "manager", "admin"]',
    desc: "Training assignments",
  },
  "training-module": {
    roles: '["hr_admin", "payroll_admin", "manager", "admin"]',
  ...
  // Procurement domain
  vendor: {
    roles: '["procurement_manager", "manager", "admin"]',
  ...
  "vendor-contract": {
    roles: '["procurement_manager", "manager", "admin"]',
    desc: "Vendor contract management",
  },
  "purchase-order": {
    roles: '["procurement_manager", "manager", "admin"]',
    desc: "Purchase order management",
  },
  procurement: {
    roles: '["procurement_manager", "manager", "admin"]',
    desc: "Procurement management",
  },

  // Logistics domain
  logistics: {
    roles: '["driver", "logistics_manager", "manager", "admin"]',
    desc: "Logistics management",
  },
  shipment: {
    roles: '["driver", "logistics_manager", "manager", "admin"]',
    desc: "Shipment management",
  },
  ...
  "email-template": {
    roles: '["manager", "admin"]',
    desc: "Email template management",
  },
  "email-workflow": {
    roles: '["manager", "admin"]',
    desc: "Email workflow management",
  },
  ...
  "alerts-config": {
    roles: '["manager", "admin"]',
    desc: "Alerts configuration",
  },

  // Facilities domain
  facilit: {
    roles: '["facility_manager", "facilities_manager", "manager", "admin"]',
    desc: "Facilities management",
  },
  equipment: {
    roles: '["facility_manager", "facilities_manager", "manager", "admin"]',
  ...
  "work-order": {
    roles: '["facility_manager", "facilities_manager", "manager", "admin"]',
    desc: "Work order management",
  },

  // Operations domain
  "command-board": {
    roles:
      '["kitchen_staff", "kitchen_lead", "event_coordinator", "manager", "admin"]',
    desc: "Command board",
  },
  "battle-board": {
    roles:
  ...
  // Knowledge domain
  knowledge: {
    roles: '["staff", "editor", "manager", "admin"]',
    desc: "Knowledge base",
  },
  document: {
    roles: '["staff", "editor", "manager", "admin"]',
    desc: "Document versioning",
  },
...
const FALLBACK = {
  roles: '["manager", "admin"]',
  desc: "Default management access",
};
...
function getPolicyForFile(filename) {
  ...
  const base = filename
    .replace("-rules.manifest", "")
    .replace("-workflow.manifest", "")
    .replace(".manifest", "");

  // Try exact match first
  if (DOMAIN_POLICIES[base]) {
    return DOMAIN_POLICIES[base];
  }
...
function processFile(filepath, filename) {
  ...
  if (
    ...
    content.match(/entity\s+\w+\s*\{[^}]*default policy/s)
  ) {
  ...
  for (let i = 0; i < lines.length; i++) {
    ...
    if (inEntity) {
      ...
      if (
        !(hasDefaultPolicy || insertedInThisEntity) &&
...
const files = readdirSync(SOURCE_DIR)
  ...
  .sort();
console.log(
  `Processing ${files.length} manifest files...${DRY_RUN ? " (DRY RUN)" : ""}`
);

const stats = { modified: 0, skipped: 0, unchanged: 0 };
