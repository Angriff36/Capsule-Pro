...
export const ENTITY_FIELD_OVERRIDES: Record<string, { tenantId?: string; createdAt?: string | null }>;
...
export function resolveAccessor(entityName: string): { naive: string; accessor: string | null; drop: boolean; overridden: boolean };
export function resolveDetailSegment(entityName: string): string;
export function applyFieldOverrides(content: string, entityName: string): { content: string; rewrites: string[] };
