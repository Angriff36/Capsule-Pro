...
divergences: D15, U12
pages: language/computed-properties
note: >-
...
# Manifest reference for `manifest/source/inventory`

**Why this file:** Inventory rules: quantityAvailable is a computed property — declare it in the IR with the correct formula (quantityOnHand - quantityReserved); do not hand-store it or read it without evaluation.

**Relevant divergences:** D15, U12 — see `manifest/MANIFEST-DIVERGENCES.md` for the full remediation detail.
