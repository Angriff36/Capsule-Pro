// Auto-generated Next.js API route for RevenueRecognitionLine
...
const revenueRecognitionLines = await database.revenueRecognitionLine.findMany({
    where: {
        tenantId
      },
    orderBy: {
    ...
    return manifestSuccessResponse({ revenueRecognitionLines });
  } catch (error) {
    ...
    console.error("Error fetching revenueRecognitionLines:", error);
