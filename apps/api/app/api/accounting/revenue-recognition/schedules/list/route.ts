// Auto-generated Next.js API route for RevenueRecognitionSchedule
...
const revenueRecognitionSchedules = await database.revenueRecognitionSchedule.findMany({
    where: {
        tenantId
      },
    orderBy: {
    ...
    return manifestSuccessResponse({ revenueRecognitionSchedules });
  } catch (error) {
    ...
    console.error("Error fetching revenueRecognitionSchedules:", error);
