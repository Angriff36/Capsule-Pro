// Auto-generated Next.js API route for CollectionAction
...
export async function GET(_request: NextRequest) {
  try {
    ...
    const collectionActions = await database.collectionAction.findMany({
      where: {
        tenantId,
      },
      orderBy: {
    ...
    return manifestSuccessResponse({ collectionActions });
  } catch (error) {
    ...
    console.error("Error fetching collectionActions:", error);
    return manifestErrorResponse(
      {
