// Auto-generated Next.js API detail route for CollectionAction
...
export async function GET(
  ...
  if (!tenantId) {
    ...
    if (!collectionAction) {
      return manifestErrorResponse({ error: "CollectionAction not found", diagnostics: [] }, 404);
    }

    return manifestSuccessResponse({ collectionAction });
  } catch (error) {
    ...
    console.error("Error fetching collectionAction:", error);
