// Auto-generated Next.js API route for CollectionPaymentPlan
...
const collectionPaymentPlans = await database.collectionPaymentPlan.findMany({
    where: {
        tenantId
      },
    orderBy: {
    ...
    return manifestSuccessResponse({ collectionPaymentPlans });
  } catch (error) {
    ...
    console.error("Error fetching collectionPaymentPlans:", error);
