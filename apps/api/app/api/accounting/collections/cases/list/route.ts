// Auto-generated Next.js API route for CollectionCase
...
const collectionCases = await database.collectionCase.findMany({
    where: {
        tenantId,
        deletedAt: null
      },
    ...
    return manifestSuccessResponse({ collectionCases });
  } catch (error) {
    ...
    console.error("Error fetching collectionCases:", error);
