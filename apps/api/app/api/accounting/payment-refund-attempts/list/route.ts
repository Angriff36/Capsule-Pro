// Auto-generated Next.js API route for PaymentRefundAttempt
...
const paymentRefundAttempts = await database.paymentRefundAttempt.findMany({
    where: {
        tenantId
      },
    orderBy: {
    ...
    return manifestSuccessResponse({ paymentRefundAttempts });
  } catch (error) {
    ...
    console.error("Error fetching paymentRefundAttempts:", error);
