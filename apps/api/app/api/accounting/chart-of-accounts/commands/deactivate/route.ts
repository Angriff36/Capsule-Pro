...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[chart-of-account/deactivate] Executing command:", {
    ...
    if (!result.success) {
      log.error("[chart-of-account/deactivate] Command failed:", {
    ...
    log.error("[chart-of-account/deactivate] Error:", error);
