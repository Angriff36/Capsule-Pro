// Auto-generated Next.js command handler for ChartOfAccount.deactivate
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[chart-of-account/deactivate] Executing command:", {
    ...
    if (!result.success) {
      console.error("[chart-of-account/deactivate] Command failed:", {
    ...
    console.error("[chart-of-account/deactivate] Error:", error);
