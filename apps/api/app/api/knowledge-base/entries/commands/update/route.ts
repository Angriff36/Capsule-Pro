// Knowledge Base Update Command Handler
// Updates an existing knowledge base entry through the Manifest runtime
  ...
  try {
    ...
    const result = await runtime.runCommand(
      "update",
      {
        ...
        relatedRecipeId: body.relatedRecipeId,
        relatedEquipment: body.relatedEquipment,
    ...
    console.error("Error executing KnowledgeEntry.update:", error);
