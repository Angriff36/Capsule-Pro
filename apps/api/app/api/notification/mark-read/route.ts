// Auto-generated Next.js command handler for Notification.markRead
...
export async function POST(request: NextRequest) {
  ...
  if (!tenantId) {
    ...
    const result = await runtime.runCommand("markRead", body, {
    ...
    console.error("Error executing Notification.markRead:", error);
