// Auto-generated Next.js API detail route for ProcurementBudgetAlert
...
export async function GET(
  ...
  if (!tenantId) {
    ...
    if (!procurementBudgetAlert) {
      return manifestErrorResponse({ error: "ProcurementBudgetAlert not found", diagnostics: [] }, 404);
    }

    return manifestSuccessResponse({ procurementBudgetAlert });
  } catch (error) {
    ...
    console.error("Error fetching procurementBudgetAlert:", error);
