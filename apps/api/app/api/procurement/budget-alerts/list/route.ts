// Auto-generated Next.js API route for ProcurementBudgetAlert
...
const procurementBudgetAlerts = await database.procurementBudgetAlert.findMany({
    where: {
        tenantId
      },
    orderBy: {
    ...
    return manifestSuccessResponse({ procurementBudgetAlerts });
  } catch (error) {
    ...
    console.error("Error fetching procurementBudgetAlerts:", error);
