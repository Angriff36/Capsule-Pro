// Auto-generated Next.js command handler for PurchaseRequisition.cancel
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[purchase-requisition/cancel] Executing command:", {
    ...
    if (!result.success) {
      console.error("[purchase-requisition/cancel] Command failed:", {
    ...
    console.error("[purchase-requisition/cancel] Error:", error);
