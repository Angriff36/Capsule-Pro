...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[purchase-requisition/cancel] Executing command:", {
    ...
    if (!result.success) {
      log.error("[purchase-requisition/cancel] Command failed:", {
    ...
    log.error("[purchase-requisition/cancel] Error:", error);
