// Auto-generated Next.js command handler for PurchaseRequisition.submit
...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[purchase-requisition/submit] Executing command:", {
    ...
    const result = await runtime.runCommand("submit", body, {
      entityName: "PurchaseRequisition",
      instanceId: body.id,
    });

    if (!result.success) {
      log.error("[purchase-requisition/submit] Command failed:", {
    ...
    log.error("[purchase-requisition/submit] Error:", error);
