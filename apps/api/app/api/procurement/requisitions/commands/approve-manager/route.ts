...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[purchase-requisition/approveManager] Executing command:", {
    ...
    if (!result.success) {
      log.error("[purchase-requisition/approveManager] Command failed:", {
    ...
    log.error("[purchase-requisition/approveManager] Error:", error);
