// Auto-generated Next.js command handler for PurchaseRequisition.approveManager
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[purchase-requisition/approveManager] Executing command:", {
    ...
    const result = await runtime.runCommand("approveManager", body, {
      entityName: "PurchaseRequisition",
    });

    if (!result.success) {
      console.error("[purchase-requisition/approveManager] Command failed:", {
    ...
    console.error("[purchase-requisition/approveManager] Error:", error);
