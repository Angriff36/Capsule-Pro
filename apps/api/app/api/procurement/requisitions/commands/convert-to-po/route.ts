// Auto-generated Next.js command handler for PurchaseRequisition.convertToPo
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[purchase-requisition/convertToPo] Executing command:", {
    ...
    const result = await runtime.runCommand("convertToPo", body, {
      entityName: "PurchaseRequisition",
    });

    if (!result.success) {
      console.error("[purchase-requisition/convertToPo] Command failed:", {
    ...
    console.error("[purchase-requisition/convertToPo] Error:", error);
