...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[purchase-requisition/convertToPo] Executing command:", {
    ...
    if (!result.success) {
      log.error("[purchase-requisition/convertToPo] Command failed:", {
    ...
    log.error("[purchase-requisition/convertToPo] Error:", error);
