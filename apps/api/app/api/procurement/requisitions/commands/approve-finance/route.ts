...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[purchase-requisition/approveFinance] Executing command:", {
    ...
    if (!result.success) {
      log.error("[purchase-requisition/approveFinance] Command failed:", {
    ...
    log.error("[purchase-requisition/approveFinance] Error:", error);
