// Auto-generated Next.js command handler for PurchaseRequisition.approveFinance
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[purchase-requisition/approveFinance] Executing command:", {
    ...
    const result = await runtime.runCommand("approveFinance", body, {
      entityName: "PurchaseRequisition",
    });

    if (!result.success) {
      console.error("[purchase-requisition/approveFinance] Command failed:", {
    ...
    console.error("[purchase-requisition/approveFinance] Error:", error);
