// Auto-generated Next.js command handler for PurchaseRequisition.update
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[purchase-requisition/update] Executing command:", {
    ...
    if (!result.success) {
      console.error("[purchase-requisition/update] Command failed:", {
    ...
    console.error("[purchase-requisition/update] Error:", error);
