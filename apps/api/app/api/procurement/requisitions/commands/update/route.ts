...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[purchase-requisition/update] Executing command:", {
    ...
    if (!result.success) {
      log.error("[purchase-requisition/update] Command failed:", {
    ...
    log.error("[purchase-requisition/update] Error:", error);
