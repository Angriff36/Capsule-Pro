// Auto-generated Next.js command handler for PurchaseRequisition.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[purchase-requisition/create] Executing command:", {
    ...
    if (!result.success) {
      log.error("[purchase-requisition/create] Command failed:", {
    ...
    log.error("[purchase-requisition/create] Error:", error);
