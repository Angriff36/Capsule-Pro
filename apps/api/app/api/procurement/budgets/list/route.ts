// Auto-generated Next.js API route for ProcurementBudget
...
const procurementBudgets = await database.procurementBudget.findMany({
    ...
    return manifestSuccessResponse({ procurementBudgets });
  } catch (error) {
    ...
    console.error("Error fetching procurementBudgets:", error);
