...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[vendor-contract/recordSlaBreach] Executing command:", {
    ...
    if (!result.success) {
      log.error("[vendor-contract/recordSlaBreach] Command failed:", {
    ...
    log.error("[vendor-contract/recordSlaBreach] Error:", error);
