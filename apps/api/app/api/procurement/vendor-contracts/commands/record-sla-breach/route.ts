// Auto-generated Next.js command handler for VendorContract.recordSlaBreach
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[vendor-contract/recordSlaBreach] Executing command:", {
    ...
    const result = await runtime.runCommand("recordSlaBreach", body, {
      entityName: "VendorContract",
    });

    if (!result.success) {
      console.error("[vendor-contract/recordSlaBreach] Command failed:", {
    ...
    console.error("[vendor-contract/recordSlaBreach] Error:", error);
