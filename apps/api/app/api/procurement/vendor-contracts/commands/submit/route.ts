// Auto-generated Next.js command handler for VendorContract.submit
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[vendor-contract/submit] Executing command:", {
    ...
    if (!result.success) {
      console.error("[vendor-contract/submit] Command failed:", {
    ...
    console.error("[vendor-contract/submit] Error:", error);
