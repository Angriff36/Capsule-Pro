// Auto-generated Next.js command handler for VendorContract.update
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[vendor-contract/update] Executing command:", {
    ...
    if (!result.success) {
      console.error("[vendor-contract/update] Command failed:", {
    ...
    console.error("[vendor-contract/update] Error:", error);
