...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[vendor-contract/updateCompliance] Executing command:", {
    ...
    if (!result.success) {
      log.error("[vendor-contract/updateCompliance] Command failed:", {
    ...
    log.error("[vendor-contract/updateCompliance] Error:", error);
