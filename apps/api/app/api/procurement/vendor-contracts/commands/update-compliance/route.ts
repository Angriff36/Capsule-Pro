// Auto-generated Next.js command handler for VendorContract.updateCompliance
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[vendor-contract/updateCompliance] Executing command:", {
    ...
    const result = await runtime.runCommand("updateCompliance", body, {
      entityName: "VendorContract",
    });

    if (!result.success) {
      console.error("[vendor-contract/updateCompliance] Command failed:", {
    ...
    console.error("[vendor-contract/updateCompliance] Error:", error);
