// Auto-generated Next.js command handler for VendorContract.approve
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[vendor-contract/approve] Executing command:", {
    ...
    if (!result.success) {
      console.error("[vendor-contract/approve] Command failed:", {
    ...
    console.error("[vendor-contract/approve] Error:", error);
