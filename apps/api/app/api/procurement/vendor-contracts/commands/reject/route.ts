// Auto-generated Next.js command handler for VendorContract.reject
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[vendor-contract/reject] Executing command:", {
    ...
    if (!result.success) {
      console.error("[vendor-contract/reject] Command failed:", {
    ...
    console.error("[vendor-contract/reject] Error:", error);
