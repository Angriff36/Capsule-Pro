// Auto-generated Next.js command handler for VendorContract.renew
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[vendor-contract/renew] Executing command:", {
    ...
    const result = await runtime.runCommand("renew", body, {
      entityName: "VendorContract",
    });

    if (!result.success) {
      console.error("[vendor-contract/renew] Command failed:", {
    ...
    console.error("[vendor-contract/renew] Error:", error);
