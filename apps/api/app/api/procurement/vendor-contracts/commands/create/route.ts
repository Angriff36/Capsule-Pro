// Auto-generated Next.js command handler for VendorContract.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[vendor-contract/create] Executing command:", {
    ...
    if (!result.success) {
      console.error("[vendor-contract/create] Command failed:", {
    ...
    console.error("[vendor-contract/create] Error:", error);
