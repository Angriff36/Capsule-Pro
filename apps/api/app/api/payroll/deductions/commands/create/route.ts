// Auto-generated Next.js command handler for EmployeeDeduction.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[employee-deduction/create] Executing command:", {
    ...
    if (!result.success) {
      console.error("[employee-deduction/create] Command failed:", {
    ...
    console.error("[employee-deduction/create] Error:", error);
