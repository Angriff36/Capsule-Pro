// Auto-generated Next.js command handler for PayrollPeriod.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[payroll-period/create] Executing command:", {
    ...
    if (!result.success) {
      log.error("[payroll-period/create] Command failed:", {
    ...
    log.error("[payroll-period/create] Error:", error);
