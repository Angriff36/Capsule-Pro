// Auto-generated Next.js command handler for PayrollApprovalHistory.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[payroll-approval-history/create] Executing command:", {
    ...
    if (!result.success) {
      console.error("[payroll-approval-history/create] Command failed:", {
    ...
    console.error("[payroll-approval-history/create] Error:", error);
