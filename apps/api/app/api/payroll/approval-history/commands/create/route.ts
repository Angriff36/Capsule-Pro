...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[payroll-approval-history/create] Executing command:", {
    ...
    if (!result.success) {
      log.error("[payroll-approval-history/create] Command failed:", {
    ...
    log.error("[payroll-approval-history/create] Error:", error);
