// Auto-generated Next.js command handler for LaborBudget.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[labor-budget/create] Executing command:", {
    ...
    if (!result.success) {
      console.error("[labor-budget/create] Command failed:", {
    ...
    console.error("[labor-budget/create] Error:", error);
