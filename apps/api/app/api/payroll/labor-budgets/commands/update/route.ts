// Auto-generated Next.js command handler for LaborBudget.update
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[labor-budget/update] Executing command:", {
    ...
    if (!result.success) {
      console.error("[labor-budget/update] Command failed:", {
    ...
    console.error("[labor-budget/update] Error:", error);
