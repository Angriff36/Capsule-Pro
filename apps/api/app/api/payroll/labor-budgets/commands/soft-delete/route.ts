// Auto-generated Next.js command handler for LaborBudget.softDelete
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[labor-budget/softDelete] Executing command:", {
    ...
    if (!result.success) {
      console.error("[labor-budget/softDelete] Command failed:", {
    ...
    console.error("[labor-budget/softDelete] Error:", error);
