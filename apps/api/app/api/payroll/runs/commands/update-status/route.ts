// Auto-generated Next.js command handler for PayrollRun.updateStatus
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[payroll-run/updateStatus] Executing command:", {
    ...
    if (!result.success) {
      console.error("[payroll-run/updateStatus] Command failed:", {
    ...
    console.error("[payroll-run/updateStatus] Error:", error);
