// Auto-generated Next.js command handler for AiEventSetupSession.parse
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await runtime.runCommand("parse", body, {
    ...
    console.error("Error executing AiEventSetupSession.parse:", error);
