// Auto-generated Next.js command handler for AiEventSetupSession.updateConfidence
...
export async function POST(request: NextRequest) {
  ...
  if (!tenantId) {
    ...
    const result = await runtime.runCommand("updateConfidence", body, {
    ...
    console.error("Error executing AiEventSetupSession.updateConfidence:", error);
