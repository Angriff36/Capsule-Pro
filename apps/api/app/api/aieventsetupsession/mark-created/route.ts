// Auto-generated Next.js command handler for AiEventSetupSession.markCreated
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await runtime.runCommand("markCreated", body, {
    ...
    console.error("Error executing AiEventSetupSession.markCreated:", error);
