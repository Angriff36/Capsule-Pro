// Auto-generated Next.js command handler for EmployeeCertification.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[employee-certification/create] Executing command:", {
    ...
    if (!result.success) {
      console.error("[employee-certification/create] Command failed:", {
    ...
    console.error("[employee-certification/create] Error:", error);
