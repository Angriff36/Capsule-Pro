...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[employee-certification/create] Executing command:", {
    ...
    if (!result.success) {
      log.error("[employee-certification/create] Command failed:", {
    ...
    log.error("[employee-certification/create] Error:", error);
