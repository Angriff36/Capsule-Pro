...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[employee-certification/update] Executing command:", {
    ...
    if (!result.success) {
      log.error("[employee-certification/update] Command failed:", {
    ...
    log.error("[employee-certification/update] Error:", error);
