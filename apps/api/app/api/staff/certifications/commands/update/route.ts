// Auto-generated Next.js command handler for EmployeeCertification.update
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[employee-certification/update] Executing command:", {
    ...
    if (!result.success) {
      console.error("[employee-certification/update] Command failed:", {
    ...
    console.error("[employee-certification/update] Error:", error);
