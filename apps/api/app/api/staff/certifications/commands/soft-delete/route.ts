...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[employee-certification/softDelete] Executing command:", {
    ...
    if (!result.success) {
      log.error("[employee-certification/softDelete] Command failed:", {
    ...
    log.error("[employee-certification/softDelete] Error:", error);
