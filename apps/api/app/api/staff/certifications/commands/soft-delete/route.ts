// Auto-generated Next.js command handler for EmployeeCertification.softDelete
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[employee-certification/softDelete] Executing command:", {
    ...
    const result = await runtime.runCommand("softDelete", body, {
      entityName: "EmployeeCertification",
    });

    if (!result.success) {
      console.error("[employee-certification/softDelete] Command failed:", {
    ...
    console.error("[employee-certification/softDelete] Error:", error);
