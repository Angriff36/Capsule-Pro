// Auto-generated Next.js API route for PayrollLineItem
...
const payrollLineItems = await database.payrollLineItem.findMany({
    ...
    return manifestSuccessResponse({ payrollLineItems });
  } catch (error) {
    ...
    console.error("Error fetching payrollLineItems:", error);
