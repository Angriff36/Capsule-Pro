// Auto-generated Next.js API detail route for PayrollLineItem
...
export async function GET(
  ...
  if (!tenantId) {
    ...
    if (!payrollLineItem) {
      return manifestErrorResponse({ error: "PayrollLineItem not found", diagnostics: [] }, 404);
    }

    return manifestSuccessResponse({ payrollLineItem });
  } catch (error) {
    ...
    console.error("Error fetching payrollLineItem:", error);
