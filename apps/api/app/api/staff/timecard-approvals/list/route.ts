// Auto-generated Next.js API route for TimecardApproval
...
export async function GET(_request: NextRequest) {
  try {
    ...
    const timecardApprovals = await database.timecardApproval.findMany({
      where: {
        tenantId,
      },
      orderBy: {
    ...
    return manifestSuccessResponse({ timecardApprovals });
  } catch (error) {
    ...
    console.error("Error fetching timecardApprovals:", error);
    return manifestErrorResponse(
      {
