// Auto-generated Next.js API detail route for TimecardApproval
...
export async function GET(
  ...
  if (!tenantId) {
    ...
    if (!timecardApproval) {
      return manifestErrorResponse({ error: "TimecardApproval not found", diagnostics: [] }, 404);
    }

    return manifestSuccessResponse({ timecardApproval });
  } catch (error) {
    ...
    console.error("Error fetching timecardApproval:", error);
