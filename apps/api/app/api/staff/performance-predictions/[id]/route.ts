// Auto-generated Next.js API detail route for PerformancePrediction
...
export async function GET(
  ...
  if (!tenantId) {
    ...
    const performancePrediction = await database.performancePrediction.findFirst({
      where: {
        id,
        tenantId
      },
    ...
    if (!performancePrediction) {
      return manifestErrorResponse({ error: "PerformancePrediction not found", diagnostics: [] }, 404);
    }
