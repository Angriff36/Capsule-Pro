// Auto-generated Next.js API detail route for ActionMilestone
...
export async function GET(
  ...
  if (!tenantId) {
    ...
    if (!actionMilestone) {
      return manifestErrorResponse({ error: "ActionMilestone not found", diagnostics: [] }, 404);
    }

    return manifestSuccessResponse({ actionMilestone });
  } catch (error) {
    ...
    console.error("Error fetching actionMilestone:", error);
