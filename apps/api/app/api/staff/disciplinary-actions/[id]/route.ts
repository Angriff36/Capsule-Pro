// Auto-generated Next.js API detail route for DisciplinaryAction
...
export async function GET(
  ...
  if (!tenantId) {
    ...
    if (!disciplinaryAction) {
      return manifestErrorResponse({ error: "DisciplinaryAction not found", diagnostics: [] }, 404);
    }

    return manifestSuccessResponse({ disciplinaryAction });
  } catch (error) {
    ...
    console.error("Error fetching disciplinaryAction:", error);
