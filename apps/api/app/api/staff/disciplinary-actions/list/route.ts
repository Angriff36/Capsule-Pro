// Auto-generated Next.js API route for DisciplinaryAction
...
const disciplinaryActions = await database.disciplinaryAction.findMany({
    where: {
        tenant_id: tenantId
      },
    orderBy: {
    ...
    return manifestSuccessResponse({ disciplinaryActions });
  } catch (error) {
    ...
    console.error("Error fetching disciplinaryActions:", error);
