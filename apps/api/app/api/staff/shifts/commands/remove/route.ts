// Auto-generated Next.js command handler for ScheduleShift.remove
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[schedule-shift/remove] Executing command:", {
    ...
    if (!result.success) {
      console.error("[schedule-shift/remove] Command failed:", {
    ...
    console.error("[schedule-shift/remove] Error:", error);
