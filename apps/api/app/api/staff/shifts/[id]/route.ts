// Auto-generated Next.js API detail route for ScheduleShift
...
export async function GET(
  ...
  if (!tenantId) {
    ...
    if (!scheduleShift) {
      return manifestErrorResponse({ error: "ScheduleShift not found", diagnostics: [] }, 404);
    }

    return manifestSuccessResponse({ scheduleShift });
  } catch (error) {
    ...
    console.error("Error fetching scheduleShift:", error);
