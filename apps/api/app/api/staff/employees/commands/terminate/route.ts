// Auto-generated Next.js command handler for User.terminate
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[user/terminate] Executing command:", {
      entityName: "User",
      command: "terminate",
    ...
    if (!result.success) {
      console.error("[user/terminate] Command failed:", {
    ...
    console.error("[user/terminate] Error:", error);
