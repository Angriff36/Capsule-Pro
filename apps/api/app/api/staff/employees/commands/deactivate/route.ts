// Auto-generated Next.js command handler for User.deactivate
...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[user/deactivate] Executing command:", {
      entityName: "User",
      command: "deactivate",
    ...
    if (!result.success) {
      log.error("[user/deactivate] Command failed:", {
    ...
    log.error("[user/deactivate] Error:", error);
