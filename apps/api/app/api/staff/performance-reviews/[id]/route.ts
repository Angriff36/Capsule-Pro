// Auto-generated Next.js API detail route for PerformanceReview
...
export async function GET(
  ...
  if (!tenantId) {
    ...
    if (!performanceReview) {
      return manifestErrorResponse({ error: "PerformanceReview not found", diagnostics: [] }, 404);
    }

    return manifestSuccessResponse({ performanceReview });
  } catch (error) {
