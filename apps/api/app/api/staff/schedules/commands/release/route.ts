// Auto-generated Next.js command handler for Schedule.release
...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[schedule/release] Executing command:", {
      entityName: "Schedule",
      command: "release",
    ...
    if (!result.success) {
      log.error("[schedule/release] Command failed:", {
    ...
    log.error("[schedule/release] Error:", error);
