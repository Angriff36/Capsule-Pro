// Auto-generated Next.js command handler for Schedule.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[schedule/create] Executing command:", {
      entityName: "Schedule",
      command: "create",
    ...
    if (!result.success) {
      log.error("[schedule/create] Command failed:", {
    ...
    log.error("[schedule/create] Error:", error);
