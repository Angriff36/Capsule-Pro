// Auto-generated Next.js command handler for Schedule.update
...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[schedule/update] Executing command:", {
      entityName: "Schedule",
      command: "update",
    ...
    if (!result.success) {
      log.error("[schedule/update] Command failed:", {
    ...
    log.error("[schedule/update] Error:", error);
