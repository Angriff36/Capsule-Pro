...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[employee-availability/softDelete] Executing command:", {
    ...
    if (!result.success) {
      log.error("[employee-availability/softDelete] Command failed:", {
    ...
    log.error("[employee-availability/softDelete] Error:", error);
