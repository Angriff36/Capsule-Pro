// Auto-generated Next.js command handler for EmployeeAvailability.softDelete
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[employee-availability/softDelete] Executing command:", {
    ...
    if (!result.success) {
      console.error("[employee-availability/softDelete] Command failed:", {
    ...
    console.error("[employee-availability/softDelete] Error:", error);
