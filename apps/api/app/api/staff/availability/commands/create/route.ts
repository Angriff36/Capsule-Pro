// Auto-generated Next.js command handler for EmployeeAvailability.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[employee-availability/create] Executing command:", {
    ...
    if (!result.success) {
      console.error("[employee-availability/create] Command failed:", {
    ...
    console.error("[employee-availability/create] Error:", error);
