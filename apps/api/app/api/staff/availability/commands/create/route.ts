...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[employee-availability/create] Executing command:", {
    ...
    if (!result.success) {
      log.error("[employee-availability/create] Command failed:", {
    ...
    log.error("[employee-availability/create] Error:", error);
