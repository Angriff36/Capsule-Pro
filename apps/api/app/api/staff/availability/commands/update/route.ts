// Auto-generated Next.js command handler for EmployeeAvailability.update
...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[employee-availability/update] Executing command:", {
    ...
    if (!result.success) {
      log.error("[employee-availability/update] Command failed:", {
    ...
    log.error("[employee-availability/update] Error:", error);
