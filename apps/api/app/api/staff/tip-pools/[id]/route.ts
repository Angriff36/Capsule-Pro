// Auto-generated Next.js API detail route for TipPool
...
export async function GET(
  ...
  if (!tenantId) {
    ...
    if (!tipPool) {
      return manifestErrorResponse({ error: "TipPool not found", diagnostics: [] }, 404);
    }

    return manifestSuccessResponse({ tipPool });
  } catch (error) {
    ...
    console.error("Error fetching tipPool:", error);
