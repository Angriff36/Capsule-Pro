// Auto-generated Next.js API detail route for OnboardingCompletion
...
export async function GET(
  ...
  if (!tenantId) {
    ...
    if (!onboardingCompletion) {
      return manifestErrorResponse({ error: "OnboardingCompletion not found", diagnostics: [] }, 404);
    }

    return manifestSuccessResponse({ onboardingCompletion });
  } catch (error) {
    ...
    console.error("Error fetching onboardingCompletion:", error);
