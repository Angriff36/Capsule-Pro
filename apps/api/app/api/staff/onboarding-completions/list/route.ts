// Auto-generated Next.js API route for OnboardingCompletion
...
const onboardingCompletions = await database.onboardingCompletion.findMany({
    ...
    return manifestSuccessResponse({ onboardingCompletions });
  } catch (error) {
    ...
    console.error("Error fetching onboardingCompletions:", error);
