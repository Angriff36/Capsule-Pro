// Auto-generated Next.js API route for TrainingCompletion
...
export async function GET(_request: NextRequest) {
  try {
    ...
    const trainingCompletions = await database.trainingCompletion.findMany({
      where: {
        tenantId,
      },
      orderBy: {
    ...
    return manifestSuccessResponse({ trainingCompletions });
  } catch (error) {
    ...
    console.error("Error fetching trainingCompletions:", error);
    return manifestErrorResponse(
      {
