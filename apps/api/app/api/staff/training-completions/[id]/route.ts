// Auto-generated Next.js API detail route for TrainingCompletion
...
export async function GET(
  ...
  if (!tenantId) {
    ...
    if (!trainingCompletion) {
      return manifestErrorResponse({ error: "TrainingCompletion not found", diagnostics: [] }, 404);
    }

    return manifestSuccessResponse({ trainingCompletion });
  } catch (error) {
    ...
    console.error("Error fetching trainingCompletion:", error);
