// Auto-generated Next.js API detail route for WorkforceOptimization
...
export async function GET(
  ...
  try {
    ...
    const workforceOptimization =
      await database.workforceOptimization.findFirst({
        where: {
          id,
          tenantId,
        },
    ...
    if (!workforceOptimization) {
      return manifestErrorResponse(
        { error: "WorkforceOptimization not found", diagnostics: [] },
        404
      );
    }
