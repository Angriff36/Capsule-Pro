// Auto-generated Next.js API route for StaffMember
...
const staffMembers = await database.staffMember.findMany({
    where: {
        tenantId,
        deletedAt: null
      },
    ...
    return manifestSuccessResponse({ staffMembers });
  } catch (error) {
    ...
    console.error("Error fetching staffMembers:", error);
