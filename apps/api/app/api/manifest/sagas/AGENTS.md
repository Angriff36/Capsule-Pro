...
# Manifest reference for `apps/api/app/api/manifest/sagas`

**Why this file:** Saga transport route: wire the declared sagas into real handlers (or remove vestigial ones). Decide saga-vs-middleware deliberately.

**Relevant divergences:** U9 — see `manifest/MANIFEST-DIVERGENCES.md` for the full remediation detail.
