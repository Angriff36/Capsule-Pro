// Auto-generated Next.js command handler for Proposal.accept
...
export async function POST(request: NextRequest) {
  ...
  if (!tenantId) {
    ...
    const result = await runtime.runCommand("accept", body, {
      entityName: "Proposal",
    });
    ...
    console.error("Error executing Proposal.accept:", error);
