// Auto-generated Next.js command handler for ApiKey.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[api-key/create] Executing command:", {
      entityName: "ApiKey",
      command: "create",
    ...
    if (!result.success) {
      log.error("[api-key/create] Command failed:", {
    ...
    log.error("[api-key/create] Error:", error);
