// Auto-generated Next.js command handler for ApiKey.update
...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[api-key/update] Executing command:", {
      entityName: "ApiKey",
      command: "update",
    ...
    if (!result.success) {
      log.error("[api-key/update] Command failed:", {
    ...
    log.error("[api-key/update] Error:", error);
