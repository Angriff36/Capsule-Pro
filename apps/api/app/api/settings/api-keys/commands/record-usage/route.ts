// Auto-generated Next.js command handler for ApiKey.recordUsage
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[api-key/recordUsage] Executing command:", {
      entityName: "ApiKey",
      command: "recordUsage",
    ...
    const result = await runtime.runCommand("recordUsage", body, {
      entityName: "ApiKey",
    });

    if (!result.success) {
      console.error("[api-key/recordUsage] Command failed:", {
    ...
    console.error("[api-key/recordUsage] Error:", error);
