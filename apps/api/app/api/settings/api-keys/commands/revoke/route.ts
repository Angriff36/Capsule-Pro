// Auto-generated Next.js command handler for ApiKey.revoke
...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[api-key/revoke] Executing command:", {
      entityName: "ApiKey",
      command: "revoke",
    ...
    if (!result.success) {
      log.error("[api-key/revoke] Command failed:", {
    ...
    log.error("[api-key/revoke] Error:", error);
