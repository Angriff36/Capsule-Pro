// Auto-generated Next.js command handler for SampleData.seed
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[sample-data/seed] Executing command:", {
    ...
    const result = await runtime.runCommand("seed", body, {
      entityName: "SampleData",
    });

    if (!result.success) {
      console.error("[sample-data/seed] Command failed:", {
