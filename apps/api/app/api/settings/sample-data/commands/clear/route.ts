// Auto-generated Next.js command handler for SampleData.clear
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[sample-data/clear] Executing command:", {
    ...
    const result = await runtime.runCommand("clear", body, {
      entityName: "SampleData",
    });

    if (!result.success) {
      console.error("[sample-data/clear] Command failed:", {
