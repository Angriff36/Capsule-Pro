// Auto-generated Next.js command handler for SampleData.reseed
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[sample-data/reseed] Executing command:", {
    ...
    const result = await runtime.runCommand("reseed", body, {
      entityName: "SampleData",
    });

    if (!result.success) {
      console.error("[sample-data/reseed] Command failed:", {
    ...
    console.error("[sample-data/reseed] Error:", error);
