// Auto-generated Next.js command handler for RolePolicy.update
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[role-policy/update] Executing command:", {
    ...
    if (!result.success) {
      console.error("[role-policy/update] Command failed:", {
    ...
    console.error("[role-policy/update] Error:", error);
