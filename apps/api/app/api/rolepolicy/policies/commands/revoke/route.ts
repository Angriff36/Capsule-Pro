// Auto-generated Next.js command handler for RolePolicy.revoke
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[role-policy/revoke] Executing command:", {
    ...
    const result = await runtime.runCommand("revoke", body, {
      entityName: "RolePolicy",
    });

    if (!result.success) {
      console.error("[role-policy/revoke] Command failed:", {
    ...
    console.error("[role-policy/revoke] Error:", error);
