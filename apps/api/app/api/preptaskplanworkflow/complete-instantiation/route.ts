// Auto-generated Next.js command handler for PrepTaskPlanWorkflow.completeInstantiation
...
export async function POST(request: NextRequest) {
  ...
  if (!tenantId) {
    ...
    const result = await runtime.runCommand("completeInstantiation", body, {
    ...
    console.error("Error executing PrepTaskPlanWorkflow.completeInstantiation:", error);
