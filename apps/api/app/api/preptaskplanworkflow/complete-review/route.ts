// Auto-generated Next.js command handler for PrepTaskPlanWorkflow.completeReview
...
export async function POST(request: NextRequest) {
  ...
  if (!tenantId) {
    ...
    const result = await runtime.runCommand("completeReview", body, {
    ...
    console.error("Error executing PrepTaskPlanWorkflow.completeReview:", error);
