// Auto-generated Next.js API detail route for FacilityAsset
...
export async function GET(
  ...
  if (!tenantId) {
    ...
    if (!facilityAsset) {
      return manifestErrorResponse({ error: "FacilityAsset not found", diagnostics: [] }, 404);
    }

    return manifestSuccessResponse({ facilityAsset });
  } catch (error) {
    ...
    console.error("Error fetching facilityAsset:", error);
