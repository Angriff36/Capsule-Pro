// Auto-generated Next.js API route for MaintenanceWorkOrder
...
export async function GET(_request: NextRequest) {
  try {
    ...
    const maintenanceWorkOrders = await database.maintenanceWorkOrder.findMany({
      where: {
        tenantId,
      },
      orderBy: {
    ...
    return manifestSuccessResponse({ maintenanceWorkOrders });
  } catch (error) {
    ...
    console.error("Error fetching maintenanceWorkOrders:", error);
    return manifestErrorResponse(
      {
