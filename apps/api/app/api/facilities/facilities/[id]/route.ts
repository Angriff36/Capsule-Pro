// Auto-generated Next.js API detail route for Facility
...
export async function GET(
  ...
  if (!tenantId) {
    ...
    if (!facility) {
      return manifestErrorResponse({ error: "Facility not found", diagnostics: [] }, 404);
    }

    return manifestSuccessResponse({ facility });
  } catch (error) {
