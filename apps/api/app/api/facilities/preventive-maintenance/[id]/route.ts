// Auto-generated Next.js API detail route for PreventiveMaintenanceSchedule
...
export async function GET(
  ...
  if (!tenantId) {
    ...
    if (!preventiveMaintenanceSchedule) {
      return manifestErrorResponse({ error: "PreventiveMaintenanceSchedule not found", diagnostics: [] }, 404);
    }

    return manifestSuccessResponse({ preventiveMaintenanceSchedule });
  } catch (error) {
    ...
    console.error("Error fetching preventiveMaintenanceSchedule:", error);
