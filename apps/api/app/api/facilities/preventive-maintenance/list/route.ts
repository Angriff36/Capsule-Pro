// Auto-generated Next.js API route for PreventiveMaintenanceSchedule
...
const preventiveMaintenanceSchedules = await database.preventiveMaintenanceSchedule.findMany({
    where: {
        tenantId
      },
    orderBy: {
    ...
    return manifestSuccessResponse({ preventiveMaintenanceSchedules });
  } catch (error) {
    ...
    console.error("Error fetching preventiveMaintenanceSchedules:", error);
