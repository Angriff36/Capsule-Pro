// Auto-generated Next.js command handler for ShipmentItem.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[shipment-item/create] Executing command:", {
    ...
    if (!result.success) {
      console.error("[shipment-item/create] Command failed:", {
    ...
    console.error("[shipment-item/create] Error:", error);
