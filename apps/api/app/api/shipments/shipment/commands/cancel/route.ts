// Auto-generated Next.js command handler for Shipment.cancel
...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[shipment/cancel] Executing command:", {
      entityName: "Shipment",
      command: "cancel",
    ...
    if (!result.success) {
      log.error("[shipment/cancel] Command failed:", {
    ...
    log.error("[shipment/cancel] Error:", error);
