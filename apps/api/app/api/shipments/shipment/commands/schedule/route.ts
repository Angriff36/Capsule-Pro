// Auto-generated Next.js command handler for Shipment.schedule
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[shipment/schedule] Executing command:", {
      entityName: "Shipment",
      command: "schedule",
    ...
    const result = await runtime.runCommand("schedule", body, {
      entityName: "Shipment",
    });

    if (!result.success) {
      console.error("[shipment/schedule] Command failed:", {
    ...
    console.error("[shipment/schedule] Error:", error);
