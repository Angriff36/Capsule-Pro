// Auto-generated Next.js command handler for Shipment.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[shipment/create] Executing command:", {
      entityName: "Shipment",
      command: "create",
    ...
    if (!result.success) {
      log.error("[shipment/create] Command failed:", {
    ...
    log.error("[shipment/create] Error:", error);
