// Auto-generated Next.js command handler for Shipment.ship
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[shipment/ship] Executing command:", {
      entityName: "Shipment",
      command: "ship",
    ...
    const result = await runtime.runCommand("ship", body, {
      entityName: "Shipment",
    });

    if (!result.success) {
      console.error("[shipment/ship] Command failed:", {
    ...
    console.error("[shipment/ship] Error:", error);
