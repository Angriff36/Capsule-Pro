// Auto-generated Next.js command handler for Shipment.startPreparing
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[shipment/startPreparing] Executing command:", {
      entityName: "Shipment",
    ...
    const result = await runtime.runCommand("startPreparing", body, {
      entityName: "Shipment",
    });

    if (!result.success) {
      console.error("[shipment/startPreparing] Command failed:", {
    ...
    console.error("[shipment/startPreparing] Error:", error);
