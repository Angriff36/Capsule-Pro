// Auto-generated Next.js command handler for BulkOrderRule.update
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[bulk-order-rule/update] Executing command:", {
    ...
    if (!result.success) {
      console.error("[bulk-order-rule/update] Command failed:", {
    ...
    console.error("[bulk-order-rule/update] Error:", error);
