// Auto-generated Next.js command handler for BulkOrderRule.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[bulk-order-rule/create] Executing command:", {
    ...
    if (!result.success) {
      console.error("[bulk-order-rule/create] Command failed:", {
    ...
    console.error("[bulk-order-rule/create] Error:", error);
