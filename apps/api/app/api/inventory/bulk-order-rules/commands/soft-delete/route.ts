...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[bulk-order-rule/softDelete] Executing command:", {
    ...
    if (!result.success) {
      log.error("[bulk-order-rule/softDelete] Command failed:", {
    ...
    log.error("[bulk-order-rule/softDelete] Error:", error);
