// Auto-generated Next.js command handler for BulkOrderRule.softDelete
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[bulk-order-rule/softDelete] Executing command:", {
    ...
    if (!result.success) {
      console.error("[bulk-order-rule/softDelete] Command failed:", {
    ...
    console.error("[bulk-order-rule/softDelete] Error:", error);
