// Auto-generated Next.js API route for ReorderSuggestion
...
const reorderSuggestions = await database.reorderSuggestion.findMany({
    where: {
        tenantId
      },
    orderBy: {
    ...
    return manifestSuccessResponse({ reorderSuggestions });
  } catch (error) {
    ...
    console.error("Error fetching reorderSuggestions:", error);
