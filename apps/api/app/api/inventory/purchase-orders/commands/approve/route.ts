// Auto-generated Next.js command handler for PurchaseOrder.approve
...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[purchase-order/approve] Executing command:", {
    ...
    if (!result.success) {
      log.error("[purchase-order/approve] Command failed:", {
    ...
    log.error("[purchase-order/approve] Error:", error);
