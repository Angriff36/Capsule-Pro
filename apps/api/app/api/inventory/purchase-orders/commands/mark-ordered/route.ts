...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[purchase-order/markOrdered] Executing command:", {
    ...
    if (!result.success) {
      log.error("[purchase-order/markOrdered] Command failed:", {
    ...
    log.error("[purchase-order/markOrdered] Error:", error);
