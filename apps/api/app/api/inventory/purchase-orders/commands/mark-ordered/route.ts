// Auto-generated Next.js command handler for PurchaseOrder.markOrdered
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[purchase-order/markOrdered] Executing command:", {
    ...
    const result = await runtime.runCommand("markOrdered", body, {
      entityName: "PurchaseOrder",
    });

    if (!result.success) {
      console.error("[purchase-order/markOrdered] Command failed:", {
    ...
    console.error("[purchase-order/markOrdered] Error:", error);
