// Auto-generated Next.js command handler for PurchaseOrder.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[purchase-order/create] Executing command:", {
    ...
    if (!result.success) {
      log.error("[purchase-order/create] Command failed:", {
    ...
    log.error("[purchase-order/create] Error:", error);
