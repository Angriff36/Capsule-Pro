...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[purchase-order/markReceived] Executing command:", {
    ...
    if (!result.success) {
      log.error("[purchase-order/markReceived] Command failed:", {
    ...
    log.error("[purchase-order/markReceived] Error:", error);
