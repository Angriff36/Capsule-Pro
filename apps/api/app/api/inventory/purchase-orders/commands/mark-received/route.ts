// Auto-generated Next.js command handler for PurchaseOrder.markReceived
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[purchase-order/markReceived] Executing command:", {
    ...
    const result = await runtime.runCommand("markReceived", body, {
      entityName: "PurchaseOrder",
    });

    if (!result.success) {
      console.error("[purchase-order/markReceived] Command failed:", {
    ...
    console.error("[purchase-order/markReceived] Error:", error);
