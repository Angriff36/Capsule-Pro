// Auto-generated Next.js command handler for PurchaseOrder.reject
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[purchase-order/reject] Executing command:", {
    ...
    if (!result.success) {
      console.error("[purchase-order/reject] Command failed:", {
    ...
    console.error("[purchase-order/reject] Error:", error);
