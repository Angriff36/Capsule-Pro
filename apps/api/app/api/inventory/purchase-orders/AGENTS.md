...
# Manifest reference for `apps/api/app/api/inventory/purchase-orders`

**Why this file:** PO-complete should be a native saga composing PurchaseOrder.markReceived + InventoryItem.restock + InventoryTransaction.create with compensation, not a hand-coded $transaction.

**Relevant divergences:** D3, U9 — see `manifest/MANIFEST-DIVERGENCES.md` for the full remediation detail.
