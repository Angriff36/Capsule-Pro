// Auto-generated Next.js API route for InventoryForecast
...
const inventoryForecasts = await database.inventoryForecast.findMany({
    where: {
        tenantId,
        deletedAt: null
      },
    ...
    return manifestSuccessResponse({ inventoryForecasts });
  } catch (error) {
    ...
    console.error("Error fetching inventoryForecasts:", error);
