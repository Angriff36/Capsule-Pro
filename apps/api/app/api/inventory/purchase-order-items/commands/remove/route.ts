// Auto-generated Next.js command handler for PurchaseOrderItem.remove
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[purchase-order-item/remove] Executing command:", {
    ...
    if (!result.success) {
      console.error("[purchase-order-item/remove] Command failed:", {
    ...
    console.error("[purchase-order-item/remove] Error:", error);
