...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[purchase-order-item/remove] Executing command:", {
    ...
    if (!result.success) {
      log.error("[purchase-order-item/remove] Command failed:", {
    ...
    log.error("[purchase-order-item/remove] Error:", error);
