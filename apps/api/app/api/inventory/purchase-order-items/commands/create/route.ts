// Auto-generated Next.js command handler for PurchaseOrderItem.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[purchase-order-item/create] Executing command:", {
    ...
    if (!result.success) {
      console.error("[purchase-order-item/create] Command failed:", {
    ...
    console.error("[purchase-order-item/create] Error:", error);
