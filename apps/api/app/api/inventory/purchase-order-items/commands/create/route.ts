...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[purchase-order-item/create] Executing command:", {
    ...
    if (!result.success) {
      log.error("[purchase-order-item/create] Command failed:", {
    ...
    log.error("[purchase-order-item/create] Error:", error);
