// Auto-generated Next.js command handler for PurchaseOrderItem.update
...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[purchase-order-item/update] Executing command:", {
    ...
    if (!result.success) {
      log.error("[purchase-order-item/update] Command failed:", {
    ...
    log.error("[purchase-order-item/update] Error:", error);
