// Auto-generated Next.js API route for AuditSchedule
...
const auditSchedules = await database.auditSchedule.findMany({
    where: {
        tenantId,
        deletedAt: null
      },
    ...
    return manifestSuccessResponse({ auditSchedules });
  } catch (error) {
    ...
    console.error("Error fetching auditSchedules:", error);
