// Auto-generated Next.js command handler for CycleCountSession.complete
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[cycle-count-session/complete] Executing command:", {
    ...
    if (!result.success) {
      console.error("[cycle-count-session/complete] Command failed:", {
    ...
    console.error("[cycle-count-session/complete] Error:", error);
