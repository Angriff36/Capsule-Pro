...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[cycle-count-session/complete] Executing command:", {
    ...
    if (!result.success) {
      log.error("[cycle-count-session/complete] Command failed:", {
    ...
    log.error("[cycle-count-session/complete] Error:", error);
