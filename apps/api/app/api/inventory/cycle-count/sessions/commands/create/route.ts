// Auto-generated Next.js command handler for CycleCountSession.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[cycle-count-session/create] Executing command:", {
    ...
    if (!result.success) {
      console.error("[cycle-count-session/create] Command failed:", {
    ...
    console.error("[cycle-count-session/create] Error:", error);
