...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[cycle-count-session/create] Executing command:", {
    ...
    if (!result.success) {
      log.error("[cycle-count-session/create] Command failed:", {
    ...
    log.error("[cycle-count-session/create] Error:", error);
