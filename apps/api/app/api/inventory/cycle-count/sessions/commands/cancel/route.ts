...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[cycle-count-session/cancel] Executing command:", {
    ...
    if (!result.success) {
      log.error("[cycle-count-session/cancel] Command failed:", {
    ...
    log.error("[cycle-count-session/cancel] Error:", error);
