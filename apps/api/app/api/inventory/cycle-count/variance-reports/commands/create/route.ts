// Auto-generated Next.js command handler for VarianceReport.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[variance-report/create] Executing command:", {
    ...
    if (!result.success) {
      console.error("[variance-report/create] Command failed:", {
    ...
    console.error("[variance-report/create] Error:", error);
