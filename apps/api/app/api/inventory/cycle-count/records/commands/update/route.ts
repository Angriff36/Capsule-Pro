// Auto-generated Next.js command handler for CycleCountRecord.update
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[cycle-count-record/update] Executing command:", {
    ...
    if (!result.success) {
      console.error("[cycle-count-record/update] Command failed:", {
    ...
    console.error("[cycle-count-record/update] Error:", error);
