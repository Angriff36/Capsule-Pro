// Auto-generated Next.js command handler for CycleCountRecord.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[cycle-count-record/create] Executing command:", {
    ...
    if (!result.success) {
      console.error("[cycle-count-record/create] Command failed:", {
    ...
    console.error("[cycle-count-record/create] Error:", error);
