// Auto-generated Next.js command handler for CycleCountRecord.verify
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[cycle-count-record/verify] Executing command:", {
    ...
    const result = await runtime.runCommand("verify", body, {
      entityName: "CycleCountRecord",
    });

    if (!result.success) {
      console.error("[cycle-count-record/verify] Command failed:", {
    ...
    console.error("[cycle-count-record/verify] Error:", error);
