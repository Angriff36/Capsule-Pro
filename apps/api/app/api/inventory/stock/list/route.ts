// Auto-generated Next.js API route for InventoryStock
...
const inventoryStocks = await database.inventoryStock.findMany({
    where: {
        tenantId
      },
    orderBy: {
    ...
    return manifestSuccessResponse({ inventoryStocks });
  } catch (error) {
    ...
    console.error("Error fetching inventoryStocks:", error);
