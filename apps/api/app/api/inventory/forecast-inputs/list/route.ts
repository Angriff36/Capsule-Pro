// Auto-generated Next.js API route for ForecastInput
...
const forecastInputs = await database.forecastInput.findMany({
    where: {
        tenantId
      },
    orderBy: {
    ...
    console.error("Error fetching forecastInputs:", error);
