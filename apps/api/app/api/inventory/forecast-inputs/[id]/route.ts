// Auto-generated Next.js API detail route for ForecastInput
...
export async function GET(
  ...
  if (!tenantId) {
    ...
    if (!forecastInput) {
      return manifestErrorResponse({ error: "ForecastInput not found", diagnostics: [] }, 404);
    }

    return manifestSuccessResponse({ forecastInput });
  } catch (error) {
    ...
    console.error("Error fetching forecastInput:", error);
