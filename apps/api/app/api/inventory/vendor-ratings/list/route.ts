// Auto-generated Next.js API route for VendorRating
...
const vendorRatings = await database.vendorRating.findMany({
    where: {
        tenantId,
        deletedAt: null
      },
    ...
    return manifestSuccessResponse({ vendorRatings });
  } catch (error) {
    ...
    console.error("Error fetching vendorRatings:", error);
