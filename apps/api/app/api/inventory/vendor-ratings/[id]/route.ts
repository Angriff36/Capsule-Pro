// Auto-generated Next.js API detail route for VendorRating
...
export async function GET(
  ...
  if (!tenantId) {
    ...
    if (!vendorRating) {
      return manifestErrorResponse({ error: "VendorRating not found", diagnostics: [] }, 404);
    }

    return manifestSuccessResponse({ vendorRating });
  } catch (error) {
    ...
    console.error("Error fetching vendorRating:", error);
