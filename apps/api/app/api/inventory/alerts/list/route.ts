// Auto-generated Next.js API route for InventoryAlert
...
const inventoryAlerts = await database.inventoryAlert.findMany({
    where: {
        tenantId,
        deletedAt: null
      },
    ...
    return manifestSuccessResponse({ inventoryAlerts });
  } catch (error) {
    ...
    console.error("Error fetching inventoryAlerts:", error);
