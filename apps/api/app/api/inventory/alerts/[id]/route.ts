// Auto-generated Next.js API detail route for InventoryAlert
...
export async function GET(
  ...
  if (!tenantId) {
    ...
    if (!inventoryAlert) {
      return manifestErrorResponse({ error: "InventoryAlert not found", diagnostics: [] }, 404);
    }

    return manifestSuccessResponse({ inventoryAlert });
  } catch (error) {
    ...
    console.error("Error fetching inventoryAlert:", error);
