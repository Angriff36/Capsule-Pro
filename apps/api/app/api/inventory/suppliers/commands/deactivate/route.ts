...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[inventory-supplier/deactivate] Executing command:", {
    ...
    if (!result.success) {
      log.error("[inventory-supplier/deactivate] Command failed:", {
    ...
    log.error("[inventory-supplier/deactivate] Error:", error);
