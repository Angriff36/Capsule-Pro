// Auto-generated Next.js command handler for InventorySupplier.deactivate
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[inventory-supplier/deactivate] Executing command:", {
    ...
    if (!result.success) {
      console.error("[inventory-supplier/deactivate] Command failed:", {
    ...
    console.error("[inventory-supplier/deactivate] Error:", error);
