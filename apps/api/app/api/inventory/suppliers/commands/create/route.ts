// Auto-generated Next.js command handler for InventorySupplier.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[inventory-supplier/create] Executing command:", {
    ...
    if (!result.success) {
      console.error("[inventory-supplier/create] Command failed:", {
    ...
    console.error("[inventory-supplier/create] Error:", error);
