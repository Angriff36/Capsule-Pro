// Auto-generated Next.js command handler for InventorySupplier.update
...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[inventory-supplier/update] Executing command:", {
    ...
    if (!result.success) {
      log.error("[inventory-supplier/update] Command failed:", {
    ...
    log.error("[inventory-supplier/update] Error:", error);
