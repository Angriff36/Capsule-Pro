// List inventorySuppliers with pagination clamps to prevent unbounded reads.
...
export async function GET(request: NextRequest) {
  try {
    ...
    return manifestSuccessResponse({ inventorySuppliers, limit, offset });
  } catch (error) {
    log.error("Error fetching inventorySuppliers:", error);
