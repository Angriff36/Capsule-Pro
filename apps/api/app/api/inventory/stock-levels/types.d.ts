 ...
 */
export declare const TRANSACTION_TYPES: TransactionType[];
/**
 ...
 */
export declare const STOCK_REORDER_STATUSES: StockReorderStatus[];
/**
 * Valid adjustment statuses
 */
export declare const ADJUSTMENT_STATUSES: AdjustmentStatus[];
