// Auto-generated Next.js API route for InventoryTransferItem
...
const inventoryTransferItems = await database.inventoryTransferItem.findMany({
    where: {
        tenantId
      },
    orderBy: {
    ...
    return manifestSuccessResponse({ inventoryTransferItems });
  } catch (error) {
    ...
    console.error("Error fetching inventoryTransferItems:", error);
