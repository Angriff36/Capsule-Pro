// Auto-generated Next.js command handler for VendorCatalog.softDelete
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[vendor-catalog/softDelete] Executing command:", {
    ...
    if (!result.success) {
      console.error("[vendor-catalog/softDelete] Command failed:", {
    ...
    console.error("[vendor-catalog/softDelete] Error:", error);
