// Auto-generated Next.js command handler for VendorCatalog.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[vendor-catalog/create] Executing command:", {
    ...
    if (!result.success) {
      console.error("[vendor-catalog/create] Command failed:", {
    ...
    console.error("[vendor-catalog/create] Error:", error);
