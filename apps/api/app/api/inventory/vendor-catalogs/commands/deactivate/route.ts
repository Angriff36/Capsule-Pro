// Auto-generated Next.js command handler for VendorCatalog.deactivate
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[vendor-catalog/deactivate] Executing command:", {
    ...
    if (!result.success) {
      console.error("[vendor-catalog/deactivate] Command failed:", {
    ...
    console.error("[vendor-catalog/deactivate] Error:", error);
