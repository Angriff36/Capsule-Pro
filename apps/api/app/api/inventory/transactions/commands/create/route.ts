// Auto-generated Next.js command handler for InventoryTransaction.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[inventory-transaction/create] Executing command:", {
    ...
    if (!result.success) {
      log.error("[inventory-transaction/create] Command failed:", {
    ...
    log.error("[inventory-transaction/create] Error:", error);
