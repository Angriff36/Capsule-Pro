// Auto-generated Next.js command handler for PricingTier.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[pricing-tier/create] Executing command:", {
    ...
    if (!result.success) {
      console.error("[pricing-tier/create] Command failed:", {
