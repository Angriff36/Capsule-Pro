// Auto-generated Next.js command handler for PricingTier.update
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[pricing-tier/update] Executing command:", {
    ...
    if (!result.success) {
      console.error("[pricing-tier/update] Command failed:", {
