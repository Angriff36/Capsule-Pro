// Auto-generated Next.js command handler for PricingTier.deactivate
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[pricing-tier/deactivate] Executing command:", {
    ...
    if (!result.success) {
      console.error("[pricing-tier/deactivate] Command failed:", {
    ...
    console.error("[pricing-tier/deactivate] Error:", error);
