// Auto-generated Next.js command handler for PricingTier.softDelete
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[pricing-tier/softDelete] Executing command:", {
    ...
    if (!result.success) {
      console.error("[pricing-tier/softDelete] Command failed:", {
    ...
    console.error("[pricing-tier/softDelete] Error:", error);
