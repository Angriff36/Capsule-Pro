// Auto-generated Next.js API route for VendorContact
...
export async function GET(_request: NextRequest) {
  try {
    ...
    const vendorContacts = await database.vendorContact.findMany({
      where: {
        tenantId,
        deletedAt: null,
      },
    ...
    return manifestSuccessResponse({ vendorContacts });
  } catch (error) {
