// Auto-generated Next.js command handler for PrepListItem.updateStation
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await runtime.runCommand("updateStation", body, {
    ...
    log.error("Error executing PrepListItem.updateStation:", error);
