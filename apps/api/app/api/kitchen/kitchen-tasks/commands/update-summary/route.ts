// Auto-generated Next.js command handler for KitchenTask.updateSummary
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await runtime.runCommand("updateSummary", body, {
    ...
    console.error("Error executing KitchenTask.updateSummary:", error);
