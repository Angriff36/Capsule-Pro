// Auto-generated Next.js command handler for KitchenTask.updateTags
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await runtime.runCommand("updateTags", body, {
    ...
    console.error("Error executing KitchenTask.updateTags:", error);
