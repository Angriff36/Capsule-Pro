// Auto-generated Next.js command handler for KitchenTask.updateTitle
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await runtime.runCommand("updateTitle", body, {
    ...
    console.error("Error executing KitchenTask.updateTitle:", error);
