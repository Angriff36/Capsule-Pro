// Auto-generated Next.js command handler for KitchenTask.updateDueDate
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await runtime.runCommand("updateDueDate", body, {
    ...
    console.error("Error executing KitchenTask.updateDueDate:", error);
