// Auto-generated Next.js command handler for KitchenTask.addTag
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[kitchen-task/add-tag] Pre-command state:", {
      taskId: id,
    ...
    if (!result.success) {
      console.error("[kitchen-task/add-tag] Command failed:", {
    ...
    console.error("[kitchen-task/add-tag] Error:", error);
