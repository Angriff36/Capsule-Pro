// Auto-generated Next.js API route for QACheck
...
const qAChecks = await database.qACheck.findMany({
    where: {
        tenantId,
        deletedAt: null
      },
    ...
    return manifestSuccessResponse({ qAChecks });
  } catch (error) {
    ...
    console.error("Error fetching qAChecks:", error);
