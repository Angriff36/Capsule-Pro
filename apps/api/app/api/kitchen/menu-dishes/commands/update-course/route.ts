// Auto-generated Next.js command handler for MenuDish.updateCourse
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await runtime.runCommand("updateCourse", body, {
      entityName: "MenuDish",
    });
    ...
    console.error("Error executing MenuDish.updateCourse:", error);
