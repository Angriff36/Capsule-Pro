// Auto-generated Next.js command handler for PrepTaskPlanWorkflow.fail
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[prep-task-plan-workflow/fail] Executing command:", {
    ...
    const result = await runtime.runCommand("fail", body, {
      entityName: "PrepTaskPlanWorkflow",
    });

    if (!result.success) {
      console.error("[prep-task-plan-workflow/fail] Command failed:", {
    ...
    console.error("[prep-task-plan-workflow/fail] Error:", error);
