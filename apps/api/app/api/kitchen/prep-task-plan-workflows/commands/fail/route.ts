...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[prep-task-plan-workflow/fail] Executing command:", {
    ...
    if (!result.success) {
      log.error("[prep-task-plan-workflow/fail] Command failed:", {
    ...
    log.error("[prep-task-plan-workflow/fail] Error:", error);
