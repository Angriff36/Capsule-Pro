// Auto-generated Next.js command handler for PrepTaskPlanWorkflow.startApproving
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[prep-task-plan-workflow/startApproving] Executing command:", {
      entityName: "PrepTaskPlanWorkflow",
      command: "startApproving",
    ...
    const result = await runtime.runCommand("startApproving", body, {
      entityName: "PrepTaskPlanWorkflow",
    });

    if (!result.success) {
      console.error("[prep-task-plan-workflow/startApproving] Command failed:", {
    ...
    console.error("[prep-task-plan-workflow/startApproving] Error:", error);
