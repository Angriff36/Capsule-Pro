// Auto-generated Next.js command handler for PrepTaskPlanWorkflow.rejectPlan
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[prep-task-plan-workflow/rejectPlan] Executing command:", {
    ...
    const result = await runtime.runCommand("rejectPlan", body, {
      entityName: "PrepTaskPlanWorkflow",
    });

    if (!result.success) {
      console.error("[prep-task-plan-workflow/rejectPlan] Command failed:", {
    ...
    console.error("[prep-task-plan-workflow/rejectPlan] Error:", error);
