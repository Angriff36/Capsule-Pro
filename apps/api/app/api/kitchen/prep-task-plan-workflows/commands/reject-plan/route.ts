...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[prep-task-plan-workflow/rejectPlan] Executing command:", {
    ...
    if (!result.success) {
      log.error("[prep-task-plan-workflow/rejectPlan] Command failed:", {
    ...
    log.error("[prep-task-plan-workflow/rejectPlan] Error:", error);
