// Auto-generated Next.js command handler for PrepTaskPlanWorkflow.completeGeneration
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[prep-task-plan-workflow/completeGeneration] Executing command:", {
    ...
    const result = await runtime.runCommand("completeGeneration", body, {
      entityName: "PrepTaskPlanWorkflow",
    });

    if (!result.success) {
      console.error("[prep-task-plan-workflow/completeGeneration] Command failed:", {
    ...
    console.error("[prep-task-plan-workflow/completeGeneration] Error:", error);
