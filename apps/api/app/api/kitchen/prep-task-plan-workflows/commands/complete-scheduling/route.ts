// Auto-generated Next.js command handler for PrepTaskPlanWorkflow.completeScheduling
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[prep-task-plan-workflow/completeScheduling] Executing command:", {
      entityName: "PrepTaskPlanWorkflow",
      command: "completeScheduling",
    ...
    const result = await runtime.runCommand("completeScheduling", body, {
      entityName: "PrepTaskPlanWorkflow",
    });

    if (!result.success) {
      console.error("[prep-task-plan-workflow/completeScheduling] Command failed:", {
    ...
    console.error("[prep-task-plan-workflow/completeScheduling] Error:", error);
