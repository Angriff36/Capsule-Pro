// Auto-generated Next.js command handler for PrepTaskPlanWorkflow.startScheduling
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[prep-task-plan-workflow/startScheduling] Executing command:", {
    ...
    const result = await runtime.runCommand("startScheduling", body, {
      entityName: "PrepTaskPlanWorkflow",
    });

    if (!result.success) {
      console.error("[prep-task-plan-workflow/startScheduling] Command failed:", {
    ...
    console.error("[prep-task-plan-workflow/startScheduling] Error:", error);
