...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[prep-task-plan-workflow/startScheduling] Executing command:", {
    ...
    if (!result.success) {
      log.error("[prep-task-plan-workflow/startScheduling] Command failed:", {
    ...
    log.error("[prep-task-plan-workflow/startScheduling] Error:", error);
