...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[prep-task-plan-workflow/retry] Executing command:", {
    ...
    if (!result.success) {
      log.error("[prep-task-plan-workflow/retry] Command failed:", {
    ...
    log.error("[prep-task-plan-workflow/retry] Error:", error);
