// Auto-generated Next.js command handler for PrepTaskPlanWorkflow.retry
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[prep-task-plan-workflow/retry] Executing command:", {
    ...
    const result = await runtime.runCommand("retry", body, {
      entityName: "PrepTaskPlanWorkflow",
    });

    if (!result.success) {
      console.error("[prep-task-plan-workflow/retry] Command failed:", {
    ...
    console.error("[prep-task-plan-workflow/retry] Error:", error);
