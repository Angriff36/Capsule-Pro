// Auto-generated Next.js command handler for PrepTaskPlanWorkflow.startReviewing
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[prep-task-plan-workflow/startReviewing] Executing command:", {
      entityName: "PrepTaskPlanWorkflow",
      command: "startReviewing",
    ...
    const result = await runtime.runCommand("startReviewing", body, {
      entityName: "PrepTaskPlanWorkflow",
    });

    if (!result.success) {
      console.error("[prep-task-plan-workflow/startReviewing] Command failed:", {
    ...
    console.error("[prep-task-plan-workflow/startReviewing] Error:", error);
