...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[prep-task-plan-workflow/quickApprove] Executing command:", {
    ...
    if (!result.success) {
      log.error("[prep-task-plan-workflow/quickApprove] Command failed:", {
    ...
    log.error("[prep-task-plan-workflow/quickApprove] Error:", error);
