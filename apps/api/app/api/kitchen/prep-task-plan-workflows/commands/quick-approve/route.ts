// Auto-generated Next.js command handler for PrepTaskPlanWorkflow.quickApprove
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[prep-task-plan-workflow/quickApprove] Executing command:", {
      entityName: "PrepTaskPlanWorkflow",
      command: "quickApprove",
    ...
    const result = await runtime.runCommand("quickApprove", body, {
      entityName: "PrepTaskPlanWorkflow",
    });

    if (!result.success) {
      console.error("[prep-task-plan-workflow/quickApprove] Command failed:", {
    ...
    console.error("[prep-task-plan-workflow/quickApprove] Error:", error);
