// Auto-generated Next.js command handler for PrepTaskPlanWorkflow.startInstantiating
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[prep-task-plan-workflow/startInstantiating] Executing command:", {
    ...
    const result = await runtime.runCommand("startInstantiating", body, {
      entityName: "PrepTaskPlanWorkflow",
    });

    if (!result.success) {
      console.error("[prep-task-plan-workflow/startInstantiating] Command failed:", {
    ...
    console.error("[prep-task-plan-workflow/startInstantiating] Error:", error);
