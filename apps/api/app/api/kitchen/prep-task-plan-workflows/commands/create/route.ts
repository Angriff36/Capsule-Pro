...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[prep-task-plan-workflow/create] Executing command:", {
    ...
    if (!result.success) {
      log.error("[prep-task-plan-workflow/create] Command failed:", {
    ...
    log.error("[prep-task-plan-workflow/create] Error:", error);
