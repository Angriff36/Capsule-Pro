// Auto-generated Next.js command handler for PrepTaskPlanWorkflow.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[prep-task-plan-workflow/create] Executing command:", {
    ...
    if (!result.success) {
      console.error("[prep-task-plan-workflow/create] Command failed:", {
    ...
    console.error("[prep-task-plan-workflow/create] Error:", error);
