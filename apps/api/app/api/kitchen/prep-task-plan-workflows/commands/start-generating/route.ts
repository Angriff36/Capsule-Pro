// Auto-generated Next.js command handler for PrepTaskPlanWorkflow.startGenerating
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[prep-task-plan-workflow/startGenerating] Executing command:", {
    ...
    const result = await runtime.runCommand("startGenerating", body, {
      entityName: "PrepTaskPlanWorkflow",
    });

    if (!result.success) {
      console.error("[prep-task-plan-workflow/startGenerating] Command failed:", {
    ...
    console.error("[prep-task-plan-workflow/startGenerating] Error:", error);
