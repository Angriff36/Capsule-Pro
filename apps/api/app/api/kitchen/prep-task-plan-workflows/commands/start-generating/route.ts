...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[prep-task-plan-workflow/startGenerating] Executing command:", {
    ...
    if (!result.success) {
      log.error("[prep-task-plan-workflow/startGenerating] Command failed:", {
    ...
    log.error("[prep-task-plan-workflow/startGenerating] Error:", error);
