...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[prep-task-plan-workflow/approvePlan] Executing command:", {
    ...
    if (!result.success) {
      log.error("[prep-task-plan-workflow/approvePlan] Command failed:", {
    ...
    log.error("[prep-task-plan-workflow/approvePlan] Error:", error);
