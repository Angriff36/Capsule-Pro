// Auto-generated Next.js command handler for PrepTaskPlanWorkflow.approvePlan
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[prep-task-plan-workflow/approvePlan] Executing command:", {
    ...
    const result = await runtime.runCommand("approvePlan", body, {
      entityName: "PrepTaskPlanWorkflow",
    });

    if (!result.success) {
      console.error("[prep-task-plan-workflow/approvePlan] Command failed:", {
    ...
    console.error("[prep-task-plan-workflow/approvePlan] Error:", error);
