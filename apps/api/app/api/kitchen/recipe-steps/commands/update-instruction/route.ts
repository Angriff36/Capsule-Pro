...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[recipe-step/updateInstruction] Executing command:", {
    ...
    if (!result.success) {
      log.error("[recipe-step/updateInstruction] Command failed:", {
    ...
    log.error("[recipe-step/updateInstruction] Error:", error);
