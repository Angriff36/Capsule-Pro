// Auto-generated Next.js command handler for RecipeStep.updateInstruction
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[recipe-step/updateInstruction] Executing command:", {
    ...
    const result = await runtime.runCommand("updateInstruction", body, {
      entityName: "RecipeStep",
    });

    if (!result.success) {
      console.error("[recipe-step/updateInstruction] Command failed:", {
    ...
    console.error("[recipe-step/updateInstruction] Error:", error);
