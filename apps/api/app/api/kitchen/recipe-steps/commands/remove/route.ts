// Auto-generated Next.js command handler for RecipeStep.remove
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[recipe-step/remove] Executing command:", {
    ...
    if (!result.success) {
      console.error("[recipe-step/remove] Command failed:", {
    ...
    console.error("[recipe-step/remove] Error:", error);
