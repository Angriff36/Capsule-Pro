// Auto-generated Next.js command handler for RecipeStep.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[recipe-step/create] Executing command:", {
    ...
    if (!result.success) {
      console.error("[recipe-step/create] Command failed:", {
    ...
    console.error("[recipe-step/create] Error:", error);
