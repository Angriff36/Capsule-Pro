// Auto-generated Next.js command handler for WasteEntry.update
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[waste-entry/update] Executing command:", {
    ...
    if (!result.success) {
      console.error("[waste-entry/update] Command failed:", {
    ...
    console.error("[waste-entry/update] Error:", error);
