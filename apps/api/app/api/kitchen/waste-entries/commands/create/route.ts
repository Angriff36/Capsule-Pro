// Auto-generated Next.js command handler for WasteEntry.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[waste-entry/create] Executing command:", {
    ...
    if (!result.success) {
      console.error("[waste-entry/create] Command failed:", {
    ...
    console.error("[waste-entry/create] Error:", error);
