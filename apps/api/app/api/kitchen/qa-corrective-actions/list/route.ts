// Auto-generated Next.js API route for QACorrectiveAction
...
const qACorrectiveActions = await database.qACorrectiveAction.findMany({
    where: {
        tenantId
      },
    orderBy: {
    ...
    return manifestSuccessResponse({ qACorrectiveActions });
  } catch (error) {
    ...
    console.error("Error fetching qACorrectiveActions:", error);
