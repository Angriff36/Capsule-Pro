...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[allergen-warning/applyOverride] Executing command:", {
    ...
    if (!result.success) {
      log.error("[allergen-warning/applyOverride] Command failed:", {
    ...
    log.error("[allergen-warning/applyOverride] Error:", error);
