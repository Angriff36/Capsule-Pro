// Auto-generated Next.js command handler for AllergenWarning.applyOverride
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[allergen-warning/applyOverride] Executing command:", {
    ...
    const result = await runtime.runCommand("applyOverride", body, {
      entityName: "AllergenWarning",
    });

    if (!result.success) {
      console.error("[allergen-warning/applyOverride] Command failed:", {
    ...
    console.error("[allergen-warning/applyOverride] Error:", error);
