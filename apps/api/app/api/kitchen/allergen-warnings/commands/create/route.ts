// Auto-generated Next.js command handler for AllergenWarning.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[allergen-warning/create] Executing command:", {
    ...
    if (!result.success) {
      console.error("[allergen-warning/create] Command failed:", {
    ...
    console.error("[allergen-warning/create] Error:", error);
