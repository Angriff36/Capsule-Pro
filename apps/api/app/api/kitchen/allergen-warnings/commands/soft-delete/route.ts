...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[allergen-warning/softDelete] Executing command:", {
    ...
    if (!result.success) {
      log.error("[allergen-warning/softDelete] Command failed:", {
    ...
    log.error("[allergen-warning/softDelete] Error:", error);
