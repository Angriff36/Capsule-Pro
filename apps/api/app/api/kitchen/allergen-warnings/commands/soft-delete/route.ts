// Auto-generated Next.js command handler for AllergenWarning.softDelete
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[allergen-warning/softDelete] Executing command:", {
    ...
    if (!result.success) {
      console.error("[allergen-warning/softDelete] Command failed:", {
    ...
    console.error("[allergen-warning/softDelete] Error:", error);
