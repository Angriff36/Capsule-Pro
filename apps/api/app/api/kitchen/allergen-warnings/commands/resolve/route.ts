// Auto-generated Next.js command handler for AllergenWarning.resolve
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[allergen-warning/resolve] Executing command:", {
    ...
    if (!result.success) {
      console.error("[allergen-warning/resolve] Command failed:", {
    ...
    console.error("[allergen-warning/resolve] Error:", error);
