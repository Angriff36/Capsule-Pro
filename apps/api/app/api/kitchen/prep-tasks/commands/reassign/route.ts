// Auto-generated Next.js command handler for PrepTask.reassign
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await runtime.runCommand("reassign", body, {
      entityName: "PrepTask",
    });
    ...
    log.error("Error executing PrepTask.reassign:", error);
