// Auto-generated Next.js command handler for PrepTask.unclaim
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await runtime.runCommand("unclaim", body, {
      entityName: "PrepTask",
    });
    ...
    console.error("Error executing PrepTask.unclaim:", error);
