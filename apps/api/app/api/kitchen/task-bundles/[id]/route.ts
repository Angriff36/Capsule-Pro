// Auto-generated Next.js API detail route for TaskBundle
...
export async function GET(
  ...
  if (!tenantId) {
    ...
    if (!taskBundle) {
      return manifestErrorResponse({ error: "TaskBundle not found", diagnostics: [] }, 404);
    }

    return manifestSuccessResponse({ taskBundle });
  } catch (error) {
    ...
    console.error("Error fetching taskBundle:", error);
