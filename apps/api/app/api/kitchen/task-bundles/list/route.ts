// Auto-generated Next.js API route for TaskBundle
...
const taskBundles = await database.taskBundle.findMany({
    where: {
        tenantId,
        deletedAt: null
      },
    ...
    return manifestSuccessResponse({ taskBundles });
  } catch (error) {
    ...
    console.error("Error fetching taskBundles:", error);
