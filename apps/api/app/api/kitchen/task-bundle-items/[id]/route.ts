// Auto-generated Next.js API detail route for TaskBundleItem
...
export async function GET(
  ...
  if (!tenantId) {
    ...
    if (!taskBundleItem) {
      return manifestErrorResponse({ error: "TaskBundleItem not found", diagnostics: [] }, 404);
    }

    return manifestSuccessResponse({ taskBundleItem });
  } catch (error) {
    ...
    console.error("Error fetching taskBundleItem:", error);
