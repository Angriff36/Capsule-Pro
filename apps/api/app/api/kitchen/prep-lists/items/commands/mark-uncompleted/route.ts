// Auto-generated Next.js command handler for PrepListItem.markUncompleted
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await runtime.runCommand("markUncompleted", body, {
      entityName: "PrepListItem",
    });
    ...
    console.error("Error executing PrepListItem.markUncompleted:", error);
