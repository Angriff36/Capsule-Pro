// Auto-generated Next.js command handler for PrepList.createFromSeed
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await runtime.runCommand("createFromSeed", body, {
      entityName: "PrepList",
    });
    ...
    console.error("Error executing PrepList.createFromSeed:", error);
