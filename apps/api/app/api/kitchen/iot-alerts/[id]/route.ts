// Auto-generated Next.js API detail route for IoTAlert
...
export async function GET(
  ...
  if (!tenantId) {
    ...
    if (!ioTAlert) {
      return manifestErrorResponse({ error: "IoTAlert not found", diagnostics: [] }, 404);
    }

    return manifestSuccessResponse({ ioTAlert });
  } catch (error) {
    ...
    console.error("Error fetching ioTAlert:", error);
