// Auto-generated Next.js API route for QATemperatureLog
...
const qATemperatureLogs = await database.temperatureLog.findMany({
    ...
    return manifestSuccessResponse({ qATemperatureLogs });
  } catch (error) {
    ...
    console.error("Error fetching qATemperatureLogs:", error);
