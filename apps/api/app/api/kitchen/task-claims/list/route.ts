// Auto-generated Next.js API route for KitchenTaskClaim
...
const kitchenTaskClaims = await database.kitchenTaskClaim.findMany({
    where: {
        tenantId,
        deletedAt: null
      },
    ...
    return manifestSuccessResponse({ kitchenTaskClaims });
  } catch (error) {
    ...
    console.error("Error fetching kitchenTaskClaims:", error);
