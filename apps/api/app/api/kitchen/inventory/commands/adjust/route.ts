// Auto-generated Next.js command handler for InventoryItem.adjust
...
export async function POST(request: NextRequest) {
  ...
  if (!tenantId) {
    ...
    const result = await runtime.runCommand("adjust", body, {
    ...
    console.error("Error executing InventoryItem.adjust:", error);
