// Auto-generated Next.js command handler for InventoryItem.consume
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await runtime.runCommand("consume", body, {
    ...
    console.error("Error executing InventoryItem.consume:", error);
