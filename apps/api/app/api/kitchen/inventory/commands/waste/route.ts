// Auto-generated Next.js command handler for InventoryItem.waste
...
export async function POST(request: NextRequest) {
  ...
  if (!tenantId) {
    ...
    const result = await runtime.runCommand("waste", body, {
    ...
    console.error("Error executing InventoryItem.waste:", error);
