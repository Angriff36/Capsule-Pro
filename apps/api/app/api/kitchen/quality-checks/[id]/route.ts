// Auto-generated Next.js API detail route for QualityCheck
...
export async function GET(
  ...
  if (!tenantId) {
    ...
    if (!qualityCheck) {
      return manifestErrorResponse({ error: "QualityCheck not found", diagnostics: [] }, 404);
    }

    return manifestSuccessResponse({ qualityCheck });
  } catch (error) {
    ...
    console.error("Error fetching qualityCheck:", error);
