// Auto-generated Next.js API route for TemperatureReading
...
const temperatureReadings = await database.temperatureReading.findMany({
    where: {
        tenantId,
        deletedAt: null
      },
    ...
    return manifestSuccessResponse({ temperatureReadings });
  } catch (error) {
    ...
    console.error("Error fetching temperatureReadings:", error);
