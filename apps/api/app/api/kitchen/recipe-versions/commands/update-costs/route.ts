// Auto-generated Next.js command handler for RecipeVersion.updateCosts
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await runtime.runCommand("updateCosts", body, {
    ...
    console.error("Error executing RecipeVersion.updateCosts:", error);
