// Auto-generated Next.js command handler for RecipeVersion.restore
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await runtime.runCommand("restore", body, {
    ...
    console.error("Error executing RecipeVersion.restore:", error);
