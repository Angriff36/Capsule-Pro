// Auto-generated Next.js API route for IotAlertRule
...
const iotAlertRules = await database.iotAlertRule.findMany({
    where: {
        tenantId,
        deletedAt: null
      },
    ...
    return manifestSuccessResponse({ iotAlertRules });
  } catch (error) {
    ...
    console.error("Error fetching iotAlertRules:", error);
