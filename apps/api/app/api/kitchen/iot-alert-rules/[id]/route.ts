// Auto-generated Next.js API detail route for IotAlertRule
...
export async function GET(
  ...
  if (!tenantId) {
    ...
    if (!iotAlertRule) {
      return manifestErrorResponse({ error: "IotAlertRule not found", diagnostics: [] }, 404);
    }

    return manifestSuccessResponse({ iotAlertRule });
  } catch (error) {
    ...
    console.error("Error fetching iotAlertRule:", error);
