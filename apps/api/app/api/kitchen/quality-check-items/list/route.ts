// Auto-generated Next.js API route for QualityCheckItem
...
export async function GET(_request: NextRequest) {
  try {
    ...
    const qualityCheckItems = await database.qualityCheckItem.findMany({
      where: {
        tenantId,
      },
      orderBy: {
    ...
    return manifestSuccessResponse({ qualityCheckItems });
  } catch (error) {
    ...
    console.error("Error fetching qualityCheckItems:", error);
    return manifestErrorResponse(
      {
