// Auto-generated Next.js API route for BulkCombineRule
...
const bulkCombineRules = await database.bulkCombineRule.findMany({
    ...
    return manifestSuccessResponse({ bulkCombineRules });
  } catch (error) {
    ...
    console.error("Error fetching bulkCombineRules:", error);
