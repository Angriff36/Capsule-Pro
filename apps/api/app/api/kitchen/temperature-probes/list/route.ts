// Auto-generated Next.js API route for TemperatureProbe
...
const temperatureProbes = await database.temperatureProbe.findMany({
    where: {
        tenantId
      },
    orderBy: {
    ...
    return manifestSuccessResponse({ temperatureProbes });
  } catch (error) {
    ...
    console.error("Error fetching temperatureProbes:", error);
