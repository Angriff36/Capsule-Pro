// Auto-generated Next.js API detail route for TemperatureProbe
...
export async function GET(
  ...
  if (!tenantId) {
    ...
    if (!temperatureProbe) {
      return manifestErrorResponse({ error: "TemperatureProbe not found", diagnostics: [] }, 404);
    }

    return manifestSuccessResponse({ temperatureProbe });
  } catch (error) {
    ...
    console.error("Error fetching temperatureProbe:", error);
