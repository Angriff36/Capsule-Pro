// Auto-generated Next.js command handler for PrepMethod.update
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[prep-method/update] Executing command:", {
    ...
    if (!result.success) {
      console.error("[prep-method/update] Command failed:", {
    ...
    console.error("[prep-method/update] Error:", error);
