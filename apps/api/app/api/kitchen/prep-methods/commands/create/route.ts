// Auto-generated Next.js command handler for PrepMethod.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[prep-method/create] Executing command:", {
    ...
    if (!result.success) {
      console.error("[prep-method/create] Command failed:", {
    ...
    console.error("[prep-method/create] Error:", error);
