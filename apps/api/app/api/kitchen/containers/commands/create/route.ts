// Auto-generated Next.js command handler for Container.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[container/create] Executing command:", {
    ...
    if (!result.success) {
      log.error("[container/create] Command failed:", {
    ...
    log.error("[container/create] Error:", error);
