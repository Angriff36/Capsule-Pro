// Auto-generated Next.js command handler for Container.update
...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[container/update] Executing command:", {
    ...
    if (!result.success) {
      log.error("[container/update] Command failed:", {
    ...
    log.error("[container/update] Error:", error);
