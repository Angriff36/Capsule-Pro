// Auto-generated Next.js API route for CorrectiveAction
...
const correctiveActions = await database.correctiveAction.findMany({
    ...
    return manifestSuccessResponse({ correctiveActions });
  } catch (error) {
    ...
    console.error("Error fetching correctiveActions:", error);
