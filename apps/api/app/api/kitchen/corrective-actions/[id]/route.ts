// Auto-generated Next.js API detail route for CorrectiveAction
...
export async function GET(
  ...
  if (!tenantId) {
    ...
    if (!correctiveAction) {
      return manifestErrorResponse({ error: "CorrectiveAction not found", diagnostics: [] }, 404);
    }

    return manifestSuccessResponse({ correctiveAction });
  } catch (error) {
    ...
    console.error("Error fetching correctiveAction:", error);
