// Auto-generated Next.js command handler for AlertsConfig.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[alerts-config/create] Executing command:", {
    ...
    if (!result.success) {
      console.error("[alerts-config/create] Command failed:", {
    ...
    console.error("[alerts-config/create] Error:", error);
