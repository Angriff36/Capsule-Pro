// Auto-generated Next.js command handler for AlertsConfig.remove
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[alerts-config/remove] Executing command:", {
    ...
    if (!result.success) {
      console.error("[alerts-config/remove] Command failed:", {
    ...
    console.error("[alerts-config/remove] Error:", error);
