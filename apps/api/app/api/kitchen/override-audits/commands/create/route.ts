// Auto-generated Next.js command handler for OverrideAudit.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[override-audit/create] Executing command:", {
    ...
    if (!result.success) {
      console.error("[override-audit/create] Command failed:", {
    ...
    console.error("[override-audit/create] Error:", error);
