// Auto-generated Next.js command handler for OverrideAudit.authorize
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[override-audit/authorize] Executing command:", {
      entityName: "OverrideAudit",
      command: "authorize",
    ...
    const result = await runtime.runCommand("authorize", body, {
      entityName: "OverrideAudit",
    });

    if (!result.success) {
      console.error("[override-audit/authorize] Command failed:", {
    ...
    console.error("[override-audit/authorize] Error:", error);
