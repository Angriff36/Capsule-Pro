// Auto-generated Next.js command handler for PrepComment.resolve
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[prep-comment/resolve] Executing command:", {
    ...
    const result = await runtime.runCommand("resolve", body, {
      entityName: "PrepComment",
    });

    if (!result.success) {
      console.error("[prep-comment/resolve] Command failed:", {
    ...
    console.error("[prep-comment/resolve] Error:", error);
