// Auto-generated Next.js command handler for PrepComment.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[prep-comment/create] Executing command:", {
    ...
    if (!result.success) {
      console.error("[prep-comment/create] Command failed:", {
    ...
    console.error("[prep-comment/create] Error:", error);
