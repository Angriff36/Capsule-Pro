// Auto-generated Next.js command handler for PrepComment.softDelete
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[prep-comment/softDelete] Executing command:", {
      entityName: "PrepComment",
      command: "softDelete",
    ...
    if (!result.success) {
      console.error("[prep-comment/softDelete] Command failed:", {
    ...
    console.error("[prep-comment/softDelete] Error:", error);
