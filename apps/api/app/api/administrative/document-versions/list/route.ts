// Auto-generated Next.js API route for DocumentVersion
...
const documentVersions = await database.documentVersion.findMany({
    where: {
        tenantId
      },
    orderBy: {
    ...
    return manifestSuccessResponse({ documentVersions });
  } catch (error) {
