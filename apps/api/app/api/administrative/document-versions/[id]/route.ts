// Auto-generated Next.js API detail route for DocumentVersion
...
export async function GET(
  ...
  if (!tenantId) {
    ...
    if (!documentVersion) {
      return manifestErrorResponse({ error: "DocumentVersion not found", diagnostics: [] }, 404);
    }

    return manifestSuccessResponse({ documentVersion });
  } catch (error) {
    ...
    console.error("Error fetching documentVersion:", error);
