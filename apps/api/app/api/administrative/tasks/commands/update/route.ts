// Auto-generated Next.js command handler for AdminTask.update
...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[admin-task/update] Executing command:", {
    ...
    if (!result.success) {
      log.error("[admin-task/update] Command failed:", {
    ...
    log.error("[admin-task/update] Error:", error);
