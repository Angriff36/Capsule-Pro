// Auto-generated Next.js command handler for AdminTask.complete
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[admin-task/complete] Executing command:", {
    ...
    if (!result.success) {
      console.error("[admin-task/complete] Command failed:", {
    ...
    console.error("[admin-task/complete] Error:", error);
