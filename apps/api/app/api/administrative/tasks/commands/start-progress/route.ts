// Auto-generated Next.js command handler for AdminTask.startProgress
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[admin-task/startProgress] Executing command:", {
    ...
    const result = await runtime.runCommand("startProgress", body, {
      entityName: "AdminTask",
    });

    if (!result.success) {
      console.error("[admin-task/startProgress] Command failed:", {
    ...
    console.error("[admin-task/startProgress] Error:", error);
