// Auto-generated Next.js command handler for AdminTask.moveToTodo
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[admin-task/moveToTodo] Executing command:", {
    ...
    const result = await runtime.runCommand("moveToTodo", body, {
      entityName: "AdminTask",
    });

    if (!result.success) {
      console.error("[admin-task/moveToTodo] Command failed:", {
    ...
    console.error("[admin-task/moveToTodo] Error:", error);
