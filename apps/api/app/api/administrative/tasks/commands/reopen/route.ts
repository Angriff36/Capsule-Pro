// Auto-generated Next.js command handler for AdminTask.reopen
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[admin-task/reopen] Executing command:", {
    ...
    const result = await runtime.runCommand("reopen", body, {
      entityName: "AdminTask",
    });

    if (!result.success) {
      console.error("[admin-task/reopen] Command failed:", {
    ...
    console.error("[admin-task/reopen] Error:", error);
