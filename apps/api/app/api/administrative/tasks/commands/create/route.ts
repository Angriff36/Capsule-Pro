// Auto-generated Next.js command handler for AdminTask.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[admin-task/create] Executing command:", {
    ...
    if (!result.success) {
      log.error("[admin-task/create] Command failed:", {
    ...
    log.error("[admin-task/create] Error:", error);
