// Auto-generated Next.js API route for AdminChatThread
...
const adminChatThreads = await database.adminChatThread.findMany({
    ...
    return manifestSuccessResponse({ adminChatThreads });
  } catch (error) {
    ...
    console.error("Error fetching adminChatThreads:", error);
