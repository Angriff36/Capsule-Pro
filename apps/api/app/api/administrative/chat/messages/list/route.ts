// Auto-generated Next.js API route for AdminChatMessage
...
const adminChatMessages = await database.adminChatMessage.findMany({
    where: {
        tenantId,
        deletedAt: null
      },
    ...
    return manifestSuccessResponse({ adminChatMessages });
  } catch (error) {
    ...
    console.error("Error fetching adminChatMessages:", error);
