// Auto-generated Next.js command handler for AdminChatParticipant.unarchive
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[admin-chat-participant/unarchive] Executing command:", {
    ...
    const result = await runtime.runCommand("unarchive", body, {
      entityName: "AdminChatParticipant",
    });

    if (!result.success) {
      console.error("[admin-chat-participant/unarchive] Command failed:", {
    ...
    console.error("[admin-chat-participant/unarchive] Error:", error);
