...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[admin-chat-participant/unarchive] Executing command:", {
    ...
    if (!result.success) {
      log.error("[admin-chat-participant/unarchive] Command failed:", {
    ...
    log.error("[admin-chat-participant/unarchive] Error:", error);
