...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[admin-chat-participant/clearHistory] Executing command:", {
    ...
    if (!result.success) {
      log.error("[admin-chat-participant/clearHistory] Command failed:", {
    ...
    log.error("[admin-chat-participant/clearHistory] Error:", error);
