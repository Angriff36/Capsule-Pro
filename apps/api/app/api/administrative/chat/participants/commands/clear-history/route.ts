// Auto-generated Next.js command handler for AdminChatParticipant.clearHistory
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[admin-chat-participant/clearHistory] Executing command:", {
    ...
    const result = await runtime.runCommand("clearHistory", body, {
      entityName: "AdminChatParticipant",
    });

    if (!result.success) {
      console.error("[admin-chat-participant/clearHistory] Command failed:", {
    ...
    console.error("[admin-chat-participant/clearHistory] Error:", error);
