...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[admin-chat-participant/archive] Executing command:", {
    ...
    if (!result.success) {
      log.error("[admin-chat-participant/archive] Command failed:", {
    ...
    log.error("[admin-chat-participant/archive] Error:", error);
