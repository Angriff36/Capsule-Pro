// Auto-generated Next.js command handler for AdminChatParticipant.archive
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[admin-chat-participant/archive] Executing command:", {
    ...
    const result = await runtime.runCommand("archive", body, {
      entityName: "AdminChatParticipant",
    });

    if (!result.success) {
      console.error("[admin-chat-participant/archive] Command failed:", {
    ...
    console.error("[admin-chat-participant/archive] Error:", error);
