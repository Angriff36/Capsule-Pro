// Auto-generated Next.js API detail route for Document
...
export async function GET(
  ...
  if (!tenantId) {
    ...
    if (!document) {
      return manifestErrorResponse({ error: "Document not found", diagnostics: [] }, 404);
    }

    return manifestSuccessResponse({ document });
  } catch (error) {
