// Auto-generated Next.js API detail route for VersionApproval
...
export async function GET(
  ...
  if (!tenantId) {
    ...
    if (!versionApproval) {
      return manifestErrorResponse({ error: "VersionApproval not found", diagnostics: [] }, 404);
    }

    return manifestSuccessResponse({ versionApproval });
  } catch (error) {
    ...
    console.error("Error fetching versionApproval:", error);
