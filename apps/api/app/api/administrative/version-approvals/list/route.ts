// Auto-generated Next.js API route for VersionApproval
...
const versionApprovals = await database.versionApproval.findMany({
    where: {
        tenantId,
        deletedAt: null
      },
    ...
    return manifestSuccessResponse({ versionApprovals });
  } catch (error) {
    ...
    console.error("Error fetching versionApprovals:", error);
