// Auto-generated Next.js API route for KnowledgeBaseEntry
...
export async function GET(_request: NextRequest) {
  try {
    ...
    const knowledgeBaseEntrys = await database.knowledgeBaseEntry.findMany({
      where: {
        tenantId,
      },
      orderBy: {
    ...
    return manifestSuccessResponse({ knowledgeBaseEntrys });
  } catch (error) {
    ...
    console.error("Error fetching knowledgeBaseEntrys:", error);
    return manifestErrorResponse(
      {
