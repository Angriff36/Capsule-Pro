// Auto-generated Next.js API detail route for VersionedEntity
...
export async function GET(
  ...
  if (!tenantId) {
    ...
    if (!versionedEntity) {
      return manifestErrorResponse({ error: "VersionedEntity not found", diagnostics: [] }, 404);
    }

    return manifestSuccessResponse({ versionedEntity });
  } catch (error) {
    ...
    console.error("Error fetching versionedEntity:", error);
