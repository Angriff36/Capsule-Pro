// Auto-generated Next.js API route for VersionedEntity
...
export async function GET(_request: NextRequest) {
  try {
    ...
    const versionedEntitys = await database.versionedEntity.findMany({
      where: {
        tenantId,
      },
      orderBy: {
    ...
    return manifestSuccessResponse({ versionedEntitys });
  } catch (error) {
    ...
    console.error("Error fetching versionedEntitys:", error);
    return manifestErrorResponse(
      {
