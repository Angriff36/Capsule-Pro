...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[training-assignment/create] Executing command", {
      data: {
    ...
    if (!result.success) {
      log.error("[training-assignment/create] Command failed", {
    ...
    log.error("[training-assignment/create] Error", { error });
