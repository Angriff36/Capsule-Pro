// Auto-generated Next.js command handler for TrainingModule.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[training-module/create] Executing command:", {
    ...
    if (!result.success) {
      console.error("[training-module/create] Command failed:", {
