...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[training-module/softDelete] Executing command", {
      data: {
    ...
    if (!result.success) {
      log.error("[training-module/softDelete] Command failed", {
    ...
    log.error("[training-module/softDelete] Error", { error });
