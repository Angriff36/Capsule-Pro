// Auto-generated Next.js command handler for Notification.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[notification/create] Executing command:", {
    ...
    if (!result.success) {
      log.error("[notification/create] Command failed:", {
    ...
    log.error("[notification/create] Error:", error);
