// Auto-generated Next.js command handler for Workflow.activate
...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[workflow/activate] Executing command:", {
      entityName: "Workflow",
      command: "activate",
    ...
    if (!result.success) {
      log.error("[workflow/activate] Command failed:", {
    ...
    log.error("[workflow/activate] Error:", error);
