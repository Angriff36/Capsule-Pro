// Auto-generated Next.js command handler for Workflow.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[workflow/create] Executing command:", {
      entityName: "Workflow",
      command: "create",
    ...
    if (!result.success) {
      log.error("[workflow/create] Command failed:", {
    ...
    log.error("[workflow/create] Error:", error);
