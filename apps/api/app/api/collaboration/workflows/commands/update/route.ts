// Auto-generated Next.js command handler for Workflow.update
...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[workflow/update] Executing command:", {
      entityName: "Workflow",
      command: "update",
    ...
    if (!result.success) {
      log.error("[workflow/update] Command failed:", {
    ...
    log.error("[workflow/update] Error:", error);
