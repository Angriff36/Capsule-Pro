// Auto-generated Next.js command handler for Workflow.deactivate
...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[workflow/deactivate] Executing command:", {
      entityName: "Workflow",
      command: "deactivate",
    ...
    if (!result.success) {
      log.error("[workflow/deactivate] Command failed:", {
    ...
    log.error("[workflow/deactivate] Error:", error);
