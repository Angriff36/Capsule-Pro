// Auto-generated Next.js command handler for RecipeIngredient.updateWasteFactor
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await runtime.runCommand("updateWasteFactor", body, {
    ...
    console.error("Error executing RecipeIngredient.updateWasteFactor:", error);
