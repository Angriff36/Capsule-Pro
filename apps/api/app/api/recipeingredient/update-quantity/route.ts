// Auto-generated Next.js command handler for RecipeIngredient.updateQuantity
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await runtime.runCommand("updateQuantity", body, {
    ...
    console.error("Error executing RecipeIngredient.updateQuantity:", error);
