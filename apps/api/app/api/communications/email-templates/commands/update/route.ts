// Auto-generated Next.js command handler for EmailTemplate.update
...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[email-template/update] Executing command:", {
    ...
    if (!result.success) {
      log.error("[email-template/update] Command failed:", {
    ...
    log.error("[email-template/update] Error:", error);
