// Auto-generated Next.js command handler for EmailWorkflow.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[email-workflow/create] Executing command:", {
    ...
    if (!result.success) {
      console.error("[email-workflow/create] Command failed:", {
    ...
    console.error("[email-workflow/create] Error:", error);
