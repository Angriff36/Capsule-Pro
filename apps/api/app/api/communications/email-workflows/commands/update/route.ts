// Auto-generated Next.js command handler for EmailWorkflow.update
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[email-workflow/update] Executing command:", {
    ...
    if (!result.success) {
      console.error("[email-workflow/update] Command failed:", {
    ...
    console.error("[email-workflow/update] Error:", error);
