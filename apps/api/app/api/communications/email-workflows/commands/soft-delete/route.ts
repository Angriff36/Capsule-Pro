// Auto-generated Next.js command handler for EmailWorkflow.softDelete
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[email-workflow/softDelete] Executing command:", {
    ...
    if (!result.success) {
      console.error("[email-workflow/softDelete] Command failed:", {
    ...
    console.error("[email-workflow/softDelete] Error:", error);
