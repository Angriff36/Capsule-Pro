// Auto-generated Next.js command handler for PerformancePrediction.create
...
export async function POST(request: NextRequest) {
  ...
  if (!tenantId) {
    ...
    const result = await runtime.runCommand("create", body, {
      entityName: "PerformancePrediction",
    });
    ...
    console.error("Error executing PerformancePrediction.create:", error);
