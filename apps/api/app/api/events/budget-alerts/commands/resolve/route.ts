// Auto-generated Next.js command handler for BudgetAlert.resolve
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[budget-alert/resolve] Executing command:", {
    ...
    if (!result.success) {
      console.error("[budget-alert/resolve] Command failed:", {
    ...
    console.error("[budget-alert/resolve] Error:", error);
