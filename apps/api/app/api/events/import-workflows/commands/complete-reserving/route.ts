// Auto-generated Next.js command handler for EventImportWorkflow.completeReserving
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[event-import-workflow/completeReserving] Executing command:", {
    ...
    const result = await runtime.runCommand("completeReserving", body, {
      entityName: "EventImportWorkflow",
    });

    if (!result.success) {
      console.error("[event-import-workflow/completeReserving] Command failed:", {
    ...
    console.error("[event-import-workflow/completeReserving] Error:", error);
