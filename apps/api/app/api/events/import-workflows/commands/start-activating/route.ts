...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[event-import-workflow/startActivating] Executing command:", {
    ...
    if (!result.success) {
      log.error("[event-import-workflow/startActivating] Command failed:", {
    ...
    log.error("[event-import-workflow/startActivating] Error:", error);
