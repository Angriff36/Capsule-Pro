// Auto-generated Next.js command handler for EventImportWorkflow.startActivating
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[event-import-workflow/startActivating] Executing command:", {
    ...
    const result = await runtime.runCommand("startActivating", body, {
      entityName: "EventImportWorkflow",
    });

    if (!result.success) {
      console.error("[event-import-workflow/startActivating] Command failed:", {
    ...
    console.error("[event-import-workflow/startActivating] Error:", error);
