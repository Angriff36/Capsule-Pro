...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[event-import-workflow/completeValidation] Executing command:", {
    ...
    if (!result.success) {
      log.error("[event-import-workflow/completeValidation] Command failed:", {
    ...
    log.error("[event-import-workflow/completeValidation] Error:", error);
