// Auto-generated Next.js command handler for EventImportWorkflow.completeValidation
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[event-import-workflow/completeValidation] Executing command:", {
      entityName: "EventImportWorkflow",
      command: "completeValidation",
    ...
    const result = await runtime.runCommand("completeValidation", body, {
      entityName: "EventImportWorkflow",
    });

    if (!result.success) {
      console.error("[event-import-workflow/completeValidation] Command failed:", {
    ...
    console.error("[event-import-workflow/completeValidation] Error:", error);
