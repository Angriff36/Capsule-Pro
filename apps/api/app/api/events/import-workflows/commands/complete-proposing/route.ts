// Auto-generated Next.js command handler for EventImportWorkflow.completeProposing
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[event-import-workflow/completeProposing] Executing command:", {
      entityName: "EventImportWorkflow",
      command: "completeProposing",
    ...
    const result = await runtime.runCommand("completeProposing", body, {
      entityName: "EventImportWorkflow",
    });

    if (!result.success) {
      console.error("[event-import-workflow/completeProposing] Command failed:", {
    ...
    console.error("[event-import-workflow/completeProposing] Error:", error);
