...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[event-import-workflow/completeProposing] Executing command:", {
    ...
    if (!result.success) {
      log.error("[event-import-workflow/completeProposing] Command failed:", {
    ...
    log.error("[event-import-workflow/completeProposing] Error:", error);
