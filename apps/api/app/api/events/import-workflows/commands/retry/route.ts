// Auto-generated Next.js command handler for EventImportWorkflow.retry
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[event-import-workflow/retry] Executing command:", {
    ...
    if (!result.success) {
      console.error("[event-import-workflow/retry] Command failed:", {
    ...
    console.error("[event-import-workflow/retry] Error:", error);
