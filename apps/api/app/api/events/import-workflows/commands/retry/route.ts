...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[event-import-workflow/retry] Executing command:", {
    ...
    if (!result.success) {
      log.error("[event-import-workflow/retry] Command failed:", {
    ...
    log.error("[event-import-workflow/retry] Error:", error);
