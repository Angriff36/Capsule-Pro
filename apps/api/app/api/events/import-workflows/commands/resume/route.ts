...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[event-import-workflow/resume] Executing command:", {
    ...
    if (!result.success) {
      log.error("[event-import-workflow/resume] Command failed:", {
    ...
    log.error("[event-import-workflow/resume] Error:", error);
