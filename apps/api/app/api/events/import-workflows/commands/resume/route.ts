// Auto-generated Next.js command handler for EventImportWorkflow.resume
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[event-import-workflow/resume] Executing command:", {
    ...
    const result = await runtime.runCommand("resume", body, {
      entityName: "EventImportWorkflow",
    });

    if (!result.success) {
      console.error("[event-import-workflow/resume] Command failed:", {
    ...
    console.error("[event-import-workflow/resume] Error:", error);
