// Auto-generated Next.js command handler for EventImportWorkflow.fail
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[event-import-workflow/fail] Executing command:", {
    ...
    if (!result.success) {
      console.error("[event-import-workflow/fail] Command failed:", {
    ...
    console.error("[event-import-workflow/fail] Error:", error);
