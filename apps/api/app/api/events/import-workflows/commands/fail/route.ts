...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[event-import-workflow/fail] Executing command:", {
    ...
    if (!result.success) {
      log.error("[event-import-workflow/fail] Command failed:", {
    ...
    log.error("[event-import-workflow/fail] Error:", error);
