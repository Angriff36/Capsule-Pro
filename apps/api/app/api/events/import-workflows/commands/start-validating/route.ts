...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[event-import-workflow/startValidating] Executing command:", {
    ...
    if (!result.success) {
      log.error("[event-import-workflow/startValidating] Command failed:", {
    ...
    log.error("[event-import-workflow/startValidating] Error:", error);
