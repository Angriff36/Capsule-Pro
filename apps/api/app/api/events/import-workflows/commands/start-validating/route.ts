// Auto-generated Next.js command handler for EventImportWorkflow.startValidating
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[event-import-workflow/startValidating] Executing command:", {
    ...
    const result = await runtime.runCommand("startValidating", body, {
      entityName: "EventImportWorkflow",
    });

    if (!result.success) {
      console.error("[event-import-workflow/startValidating] Command failed:", {
    ...
    console.error("[event-import-workflow/startValidating] Error:", error);
