// Auto-generated Next.js command handler for EventImportWorkflow.startProposing
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[event-import-workflow/startProposing] Executing command:", {
    ...
    const result = await runtime.runCommand("startProposing", body, {
      entityName: "EventImportWorkflow",
    });

    if (!result.success) {
      console.error("[event-import-workflow/startProposing] Command failed:", {
    ...
    console.error("[event-import-workflow/startProposing] Error:", error);
