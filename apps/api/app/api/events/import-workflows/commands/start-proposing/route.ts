...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[event-import-workflow/startProposing] Executing command:", {
    ...
    if (!result.success) {
      log.error("[event-import-workflow/startProposing] Command failed:", {
    ...
    log.error("[event-import-workflow/startProposing] Error:", error);
