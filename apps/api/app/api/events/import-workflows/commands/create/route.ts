...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[event-import-workflow/create] Executing command:", {
    ...
    if (!result.success) {
      log.error("[event-import-workflow/create] Command failed:", {
    ...
    log.error("[event-import-workflow/create] Error:", error);
