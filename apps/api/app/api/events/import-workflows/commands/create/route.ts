// Auto-generated Next.js command handler for EventImportWorkflow.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[event-import-workflow/create] Executing command:", {
    ...
    if (!result.success) {
      console.error("[event-import-workflow/create] Command failed:", {
    ...
    console.error("[event-import-workflow/create] Error:", error);
