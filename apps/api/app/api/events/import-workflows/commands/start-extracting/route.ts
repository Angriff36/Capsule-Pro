...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[event-import-workflow/startExtracting] Executing command:", {
    ...
    if (!result.success) {
      log.error("[event-import-workflow/startExtracting] Command failed:", {
    ...
    log.error("[event-import-workflow/startExtracting] Error:", error);
