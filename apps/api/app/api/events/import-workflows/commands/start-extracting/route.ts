// Auto-generated Next.js command handler for EventImportWorkflow.startExtracting
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[event-import-workflow/startExtracting] Executing command:", {
    ...
    const result = await runtime.runCommand("startExtracting", body, {
      entityName: "EventImportWorkflow",
    });

    if (!result.success) {
      console.error("[event-import-workflow/startExtracting] Command failed:", {
    ...
    console.error("[event-import-workflow/startExtracting] Error:", error);
