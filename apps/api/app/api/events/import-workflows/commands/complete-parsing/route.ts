...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[event-import-workflow/completeParsing] Executing command:", {
    ...
    if (!result.success) {
      log.error("[event-import-workflow/completeParsing] Command failed:", {
    ...
    log.error("[event-import-workflow/completeParsing] Error:", error);
