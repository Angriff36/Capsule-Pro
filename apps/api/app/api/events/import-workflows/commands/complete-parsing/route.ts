// Auto-generated Next.js command handler for EventImportWorkflow.completeParsing
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[event-import-workflow/completeParsing] Executing command:", {
      entityName: "EventImportWorkflow",
      command: "completeParsing",
    ...
    const result = await runtime.runCommand("completeParsing", body, {
      entityName: "EventImportWorkflow",
    });

    if (!result.success) {
      console.error("[event-import-workflow/completeParsing] Command failed:", {
    ...
    console.error("[event-import-workflow/completeParsing] Error:", error);
