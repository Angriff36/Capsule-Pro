...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[event-import-workflow/startParsing] Executing command:", {
    ...
    if (!result.success) {
      log.error("[event-import-workflow/startParsing] Command failed:", {
    ...
    log.error("[event-import-workflow/startParsing] Error:", error);
