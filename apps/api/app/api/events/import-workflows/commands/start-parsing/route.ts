// Auto-generated Next.js command handler for EventImportWorkflow.startParsing
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[event-import-workflow/startParsing] Executing command:", {
    ...
    const result = await runtime.runCommand("startParsing", body, {
      entityName: "EventImportWorkflow",
    });

    if (!result.success) {
      console.error("[event-import-workflow/startParsing] Command failed:", {
    ...
    console.error("[event-import-workflow/startParsing] Error:", error);
