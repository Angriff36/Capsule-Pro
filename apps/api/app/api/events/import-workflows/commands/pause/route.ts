...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[event-import-workflow/pause] Executing command:", {
    ...
    if (!result.success) {
      log.error("[event-import-workflow/pause] Command failed:", {
    ...
    log.error("[event-import-workflow/pause] Error:", error);
