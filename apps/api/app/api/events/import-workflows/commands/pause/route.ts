// Auto-generated Next.js command handler for EventImportWorkflow.pause
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[event-import-workflow/pause] Executing command:", {
    ...
    const result = await runtime.runCommand("pause", body, {
      entityName: "EventImportWorkflow",
    });

    if (!result.success) {
      console.error("[event-import-workflow/pause] Command failed:", {
    ...
    console.error("[event-import-workflow/pause] Error:", error);
