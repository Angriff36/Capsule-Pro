// Auto-generated Next.js command handler for EventImportWorkflow.completeExtraction
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[event-import-workflow/completeExtraction] Executing command:", {
    ...
    const result = await runtime.runCommand("completeExtraction", body, {
      entityName: "EventImportWorkflow",
    });

    if (!result.success) {
      console.error("[event-import-workflow/completeExtraction] Command failed:", {
