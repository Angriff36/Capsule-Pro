// Auto-generated Next.js command handler for EventImportWorkflow.cancel
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[event-import-workflow/cancel] Executing command:", {
    ...
    if (!result.success) {
      console.error("[event-import-workflow/cancel] Command failed:", {
    ...
    console.error("[event-import-workflow/cancel] Error:", error);
