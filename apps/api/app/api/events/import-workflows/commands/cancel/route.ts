...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[event-import-workflow/cancel] Executing command:", {
    ...
    if (!result.success) {
      log.error("[event-import-workflow/cancel] Command failed:", {
    ...
    log.error("[event-import-workflow/cancel] Error:", error);
