// Auto-generated Next.js command handler for EventImportWorkflow.startReserving
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[event-import-workflow/startReserving] Executing command:", {
    ...
    const result = await runtime.runCommand("startReserving", body, {
      entityName: "EventImportWorkflow",
    });

    if (!result.success) {
      console.error("[event-import-workflow/startReserving] Command failed:", {
    ...
    console.error("[event-import-workflow/startReserving] Error:", error);
