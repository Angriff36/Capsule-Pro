...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[event-import-workflow/startReserving] Executing command:", {
    ...
    if (!result.success) {
      log.error("[event-import-workflow/startReserving] Command failed:", {
    ...
    log.error("[event-import-workflow/startReserving] Error:", error);
