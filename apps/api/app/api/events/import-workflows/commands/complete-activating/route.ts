// Auto-generated Next.js command handler for EventImportWorkflow.completeActivating
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[event-import-workflow/completeActivating] Executing command:", {
      entityName: "EventImportWorkflow",
      command: "completeActivating",
    ...
    const result = await runtime.runCommand("completeActivating", body, {
      entityName: "EventImportWorkflow",
    });

    if (!result.success) {
      console.error("[event-import-workflow/completeActivating] Command failed:", {
    ...
    console.error("[event-import-workflow/completeActivating] Error:", error);
