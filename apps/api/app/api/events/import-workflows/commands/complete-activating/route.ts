...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[event-import-workflow/completeActivating] Executing command:", {
    ...
    if (!result.success) {
      log.error("[event-import-workflow/completeActivating] Command failed:", {
    ...
    log.error("[event-import-workflow/completeActivating] Error:", error);
