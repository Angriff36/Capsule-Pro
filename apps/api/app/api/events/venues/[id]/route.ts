// Auto-generated Next.js API detail route for Venue
...
export async function GET(
  ...
  if (!tenantId) {
    ...
    if (!venue) {
      return manifestErrorResponse({ error: "Venue not found", diagnostics: [] }, 404);
    }

    return manifestSuccessResponse({ venue });
  } catch (error) {
