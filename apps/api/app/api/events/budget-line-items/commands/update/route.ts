// Auto-generated Next.js command handler for BudgetLineItem.update
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[budget-line-item/update] Executing command:", {
    ...
    if (!result.success) {
      console.error("[budget-line-item/update] Command failed:", {
    ...
    console.error("[budget-line-item/update] Error:", error);
