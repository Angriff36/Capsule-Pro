// Auto-generated Next.js command handler for BudgetLineItem.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[budget-line-item/create] Executing command:", {
    ...
    if (!result.success) {
      console.error("[budget-line-item/create] Command failed:", {
    ...
    console.error("[budget-line-item/create] Error:", error);
