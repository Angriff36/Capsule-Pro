// Auto-generated Next.js API route for TimelineTask
...
export async function GET(_request: NextRequest) {
  try {
    ...
    const timelineTasks = await database.timelineTask.findMany({
      where: {
        tenantId,
        deletedAt: null,
      },
    ...
    return manifestSuccessResponse({ timelineTasks });
  } catch (error) {
    ...
    console.error("Error fetching timelineTasks:", error);
    return manifestErrorResponse(
      {
