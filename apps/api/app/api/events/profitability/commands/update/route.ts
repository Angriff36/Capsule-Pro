...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[event-profitability/update] Executing command:", {
    ...
    if (!result.success) {
      log.error("[event-profitability/update] Command failed:", {
    ...
    log.error("[event-profitability/update] Error:", error);
