// Auto-generated Next.js command handler for EventProfitability.update
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[event-profitability/update] Executing command:", {
    ...
    if (!result.success) {
      console.error("[event-profitability/update] Command failed:", {
    ...
    console.error("[event-profitability/update] Error:", error);
