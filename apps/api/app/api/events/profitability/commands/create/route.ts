...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[event-profitability/create] Executing command:", {
    ...
    if (!result.success) {
      log.error("[event-profitability/create] Command failed:", {
    ...
    log.error("[event-profitability/create] Error:", error);
