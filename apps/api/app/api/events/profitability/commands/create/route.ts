// Auto-generated Next.js command handler for EventProfitability.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[event-profitability/create] Executing command:", {
    ...
    if (!result.success) {
      console.error("[event-profitability/create] Command failed:", {
    ...
    console.error("[event-profitability/create] Error:", error);
