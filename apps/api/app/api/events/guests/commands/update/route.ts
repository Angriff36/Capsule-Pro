// Auto-generated Next.js command handler for EventGuest.update
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[event-guest/update] Executing command:", {
    ...
    if (!result.success) {
      console.error("[event-guest/update] Command failed:", {
    ...
    console.error("[event-guest/update] Error:", error);
