// Auto-generated Next.js command handler for EventGuest.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[event-guest/create] Executing command:", {
    ...
    if (!result.success) {
      console.error("[event-guest/create] Command failed:", {
    ...
    console.error("[event-guest/create] Error:", error);
