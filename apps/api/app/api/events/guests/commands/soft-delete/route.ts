// Auto-generated Next.js command handler for EventGuest.softDelete
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[event-guest/softDelete] Executing command:", {
    ...
    if (!result.success) {
      console.error("[event-guest/softDelete] Command failed:", {
    ...
    console.error("[event-guest/softDelete] Error:", error);
