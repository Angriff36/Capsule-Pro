// Auto-generated Next.js command handler for BattleBoard.vote
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[battle-board/vote] Executing command:", {
    ...
    const result = await runtime.runCommand("vote", body, {
      entityName: "BattleBoard",
    });

    if (!result.success) {
      console.error("[battle-board/vote] Command failed:", {
    ...
    console.error("[battle-board/vote] Error:", error);
