// Auto-generated Next.js command handler for BattleBoard.open
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[battle-board/open] Executing command:", {
    ...
    const result = await runtime.runCommand("open", body, {
      entityName: "BattleBoard",
    });

    if (!result.success) {
      console.error("[battle-board/open] Command failed:", {
    ...
    console.error("[battle-board/open] Error:", error);
