// Auto-generated Next.js command handler for BattleBoard.addDish
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[battle-board/addDish] Executing command:", {
    ...
    const result = await runtime.runCommand("addDish", body, {
      entityName: "BattleBoard",
    });

    if (!result.success) {
      console.error("[battle-board/addDish] Command failed:", {
    ...
    console.error("[battle-board/addDish] Error:", error);
