// Auto-generated Next.js command handler for BattleBoard.removeDish
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[battle-board/removeDish] Executing command:", {
    ...
    const result = await runtime.runCommand("removeDish", body, {
      entityName: "BattleBoard",
    });

    if (!result.success) {
      console.error("[battle-board/removeDish] Command failed:", {
    ...
    console.error("[battle-board/removeDish] Error:", error);
