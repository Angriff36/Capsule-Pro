// Auto-generated Next.js command handler for BattleBoard.startVoting
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[battle-board/startVoting] Executing command:", {
    ...
    const result = await runtime.runCommand("startVoting", body, {
      entityName: "BattleBoard",
    });

    if (!result.success) {
      console.error("[battle-board/startVoting] Command failed:", {
    ...
    console.error("[battle-board/startVoting] Error:", error);
