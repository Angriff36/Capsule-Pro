// Auto-generated Next.js command handler for BattleBoard.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[battle-board/create] Executing command:", {
    ...
    if (!result.success) {
      console.error("[battle-board/create] Command failed:", {
    ...
    console.error("[battle-board/create] Error:", error);
