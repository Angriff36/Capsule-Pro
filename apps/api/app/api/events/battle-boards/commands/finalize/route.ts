// Auto-generated Next.js command handler for BattleBoard.finalize
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[battle-board/finalize] Executing command:", {
    ...
    if (!result.success) {
      console.error("[battle-board/finalize] Command failed:", {
    ...
    console.error("[battle-board/finalize] Error:", error);
