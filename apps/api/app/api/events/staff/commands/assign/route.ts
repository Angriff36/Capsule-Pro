// Auto-generated Next.js command handler for EventStaff.assign
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[event-staff/assign] Executing command:", {
    ...
    const result = await runtime.runCommand("assign", body, {
      entityName: "EventStaff",
    });

    if (!result.success) {
      console.error("[event-staff/assign] Command failed:", {
    ...
    console.error("[event-staff/assign] Error:", error);
