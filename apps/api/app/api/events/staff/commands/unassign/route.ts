// Auto-generated Next.js command handler for EventStaff.unassign
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[event-staff/unassign] Executing command:", {
    ...
    const result = await runtime.runCommand("unassign", body, {
      entityName: "EventStaff",
    });

    if (!result.success) {
      console.error("[event-staff/unassign] Command failed:", {
    ...
    console.error("[event-staff/unassign] Error:", error);
