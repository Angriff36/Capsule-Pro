// Auto-generated Next.js API route for AiEventSetupSession
...
const aiEventSetupSessions = await database.aiEventSetupSession.findMany({
    where: {
        tenantId
      },
    orderBy: {
    ...
    return manifestSuccessResponse({ aiEventSetupSessions });
  } catch (error) {
    ...
    console.error("Error fetching aiEventSetupSessions:", error);
