// Auto-generated Next.js API detail route for AutomatedFollowup
...
export async function GET(
  ...
  if (!tenantId) {
    ...
    if (!automatedFollowup) {
      return manifestErrorResponse({ error: "AutomatedFollowup not found", diagnostics: [] }, 404);
    }

    return manifestSuccessResponse({ automatedFollowup });
  } catch (error) {
    ...
    console.error("Error fetching automatedFollowup:", error);
