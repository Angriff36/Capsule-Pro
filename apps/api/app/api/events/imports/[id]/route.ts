// Auto-generated Next.js API detail route for EventImport
...
export async function GET(
  ...
  if (!tenantId) {
    ...
    if (!eventImport) {
      return manifestErrorResponse({ error: "EventImport not found", diagnostics: [] }, 404);
    }
    ...
    console.error("Error fetching eventImport:", error);
