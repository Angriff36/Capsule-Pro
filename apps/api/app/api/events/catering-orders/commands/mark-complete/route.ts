...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[catering-order/markComplete] Executing command:", {
    ...
    if (!result.success) {
      log.error("[catering-order/markComplete] Command failed:", {
    ...
    log.error("[catering-order/markComplete] Error:", error);
