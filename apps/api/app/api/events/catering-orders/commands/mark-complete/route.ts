// Auto-generated Next.js command handler for CateringOrder.markComplete
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[catering-order/markComplete] Executing command:", {
    ...
    const result = await runtime.runCommand("markComplete", body, {
      entityName: "CateringOrder",
    });

    if (!result.success) {
      console.error("[catering-order/markComplete] Command failed:", {
    ...
    console.error("[catering-order/markComplete] Error:", error);
