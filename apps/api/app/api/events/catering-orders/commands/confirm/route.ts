// Auto-generated Next.js command handler for CateringOrder.confirm
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[catering-order/confirm] Executing command:", {
    ...
    const result = await runtime.runCommand("confirm", body, {
      entityName: "CateringOrder",
    });

    if (!result.success) {
      console.error("[catering-order/confirm] Command failed:", {
    ...
    console.error("[catering-order/confirm] Error:", error);
