// Auto-generated Next.js command handler for CateringOrder.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[catering-order/create] Executing command:", {
    ...
    if (!result.success) {
      console.error("[catering-order/create] Command failed:", {
    ...
    console.error("[catering-order/create] Error:", error);
