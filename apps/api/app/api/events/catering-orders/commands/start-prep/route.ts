// Auto-generated Next.js command handler for CateringOrder.startPrep
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[catering-order/startPrep] Executing command:", {
    ...
    const result = await runtime.runCommand("startPrep", body, {
      entityName: "CateringOrder",
    });

    if (!result.success) {
      console.error("[catering-order/startPrep] Command failed:", {
    ...
    console.error("[catering-order/startPrep] Error:", error);
