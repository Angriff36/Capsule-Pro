// Auto-generated Next.js command handler for Event.finalize
...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[event/finalize] Executing command:", {
      entityName: "Event",
      command: "finalize",
    ...
    if (!result.success) {
      log.error("[event/finalize] Command failed:", {
    ...
    log.error("[event/finalize] Error:", error);
