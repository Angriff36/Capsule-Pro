// Auto-generated Next.js command handler for Event.updateGuestCount
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[event/updateGuestCount] Executing command:", {
      entityName: "Event",
    ...
    const result = await runtime.runCommand("updateGuestCount", body, {
      entityName: "Event",
    });

    if (!result.success) {
      console.error("[event/updateGuestCount] Command failed:", {
    ...
    console.error("[event/updateGuestCount] Error:", error);
