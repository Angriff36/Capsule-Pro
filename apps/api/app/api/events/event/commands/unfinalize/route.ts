// Auto-generated Next.js command handler for Event.unfinalize
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[event/unfinalize] Executing command:", {
      entityName: "Event",
      command: "unfinalize",
    ...
    const result = await runtime.runCommand("unfinalize", body, {
      entityName: "Event",
    });

    if (!result.success) {
      console.error("[event/unfinalize] Command failed:", {
    ...
    console.error("[event/unfinalize] Error:", error);
