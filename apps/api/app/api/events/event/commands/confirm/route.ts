// Auto-generated Next.js command handler for Event.confirm
...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[event/confirm] Executing command:", {
      entityName: "Event",
      command: "confirm",
    ...
    if (!result.success) {
      log.error("[event/confirm] Command failed:", {
    ...
    log.error("[event/confirm] Error:", error);
