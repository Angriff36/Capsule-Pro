// Auto-generated Next.js command handler for Event.updateDate
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[event/updateDate] Executing command:", {
      entityName: "Event",
      command: "updateDate",
    ...
    const result = await runtime.runCommand("updateDate", body, {
      entityName: "Event",
    });

    if (!result.success) {
      console.error("[event/updateDate] Command failed:", {
    ...
    console.error("[event/updateDate] Error:", error);
