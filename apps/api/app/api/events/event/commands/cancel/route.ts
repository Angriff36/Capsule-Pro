// Auto-generated Next.js command handler for Event.cancel
...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[event/cancel] Executing command:", {
      entityName: "Event",
      command: "cancel",
    ...
    if (!result.success) {
      log.error("[event/cancel] Command failed:", {
    ...
    log.error("[event/cancel] Error:", error);
