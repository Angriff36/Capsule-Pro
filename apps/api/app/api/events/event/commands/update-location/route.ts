// Auto-generated Next.js command handler for Event.updateLocation
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[event/updateLocation] Executing command:", {
      entityName: "Event",
    ...
    const result = await runtime.runCommand("updateLocation", body, {
      entityName: "Event",
    });

    if (!result.success) {
      console.error("[event/updateLocation] Command failed:", {
    ...
    console.error("[event/updateLocation] Error:", error);
