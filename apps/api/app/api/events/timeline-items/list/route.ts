// Auto-generated Next.js API route for EventTimelineItem
...
const eventTimelineItems = await database.eventTimelineItem.findMany({
    where: {
        tenantId
      },
    orderBy: {
    ...
    return manifestSuccessResponse({ eventTimelineItems });
  } catch (error) {
    ...
    console.error("Error fetching eventTimelineItems:", error);
