// Auto-generated Next.js command handler for ContractSignature.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[contract-signature/create] Executing command:", {
    ...
    if (!result.success) {
      console.error("[contract-signature/create] Command failed:", {
    ...
    console.error("[contract-signature/create] Error:", error);
