// Auto-generated Next.js command handler for ContractSignature.softDelete
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[contract-signature/softDelete] Executing command:", {
    ...
    if (!result.success) {
      console.error("[contract-signature/softDelete] Command failed:", {
    ...
    console.error("[contract-signature/softDelete] Error:", error);
