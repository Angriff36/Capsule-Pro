...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[contract-signature/softDelete] Executing command:", {
    ...
    if (!result.success) {
      log.error("[contract-signature/softDelete] Command failed:", {
    ...
    log.error("[contract-signature/softDelete] Error:", error);
