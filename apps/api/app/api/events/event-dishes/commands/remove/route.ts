// Auto-generated Next.js command handler for EventDish.remove
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[event-dish/remove] Executing command:", {
    ...
    if (!result.success) {
      console.error("[event-dish/remove] Command failed:", {
    ...
    console.error("[event-dish/remove] Error:", error);
