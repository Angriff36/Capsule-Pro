// Auto-generated Next.js command handler for EventDish.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[event-dish/create] Executing command:", {
    ...
    if (!result.success) {
      console.error("[event-dish/create] Command failed:", {
    ...
    console.error("[event-dish/create] Error:", error);
