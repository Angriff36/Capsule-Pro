// Auto-generated Next.js command handler for EventBudget.finalize
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[event-budget/finalize] Executing command:", {
    ...
    if (!result.success) {
      console.error("[event-budget/finalize] Command failed:", {
    ...
    console.error("[event-budget/finalize] Error:", error);
