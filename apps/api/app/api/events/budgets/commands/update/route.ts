// Auto-generated Next.js command handler for EventBudget.update
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[event-budget/update] Executing command:", {
    ...
    if (!result.success) {
      console.error("[event-budget/update] Command failed:", {
    ...
    console.error("[event-budget/update] Error:", error);
