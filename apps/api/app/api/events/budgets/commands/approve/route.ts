// Auto-generated Next.js command handler for EventBudget.approve
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[event-budget/approve] Executing command:", {
    ...
    if (!result.success) {
      console.error("[event-budget/approve] Command failed:", {
    ...
    console.error("[event-budget/approve] Error:", error);
