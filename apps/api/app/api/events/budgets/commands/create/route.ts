// Auto-generated Next.js command handler for EventBudget.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[event-budget/create] Executing command:", {
    ...
    if (!result.success) {
      console.error("[event-budget/create] Command failed:", {
    ...
    console.error("[event-budget/create] Error:", error);
