...
export const UpdateEventBudgetSchema = z.object({
  ...
  totalBudgetAmount: z.number().min(0, "Budget amount must be positive").optional(),
  notes: z.string().optional(),
...
export const UpdateBudgetLineItemSchema = z.object({
  ...
  description: z.string().optional(),
  budgetedAmount: z.number().min(0, "Budgeted amount must be positive").optional(),
...
export type EventBudgetListFilters = z.infer<typeof EventBudgetListFiltersSchema>;

/**
 * Parse and validate create event budget request
 */
export function validateCreateEventBudget(data: unknown): CreateEventBudgetInput {
 ...
 */
export function validateUpdateEventBudget(data: unknown): UpdateEventBudgetInput {
 ...
 */
export function validateCreateBudgetLineItem(data: unknown): CreateBudgetLineItemInput {
 ...
 */
export function validateUpdateBudgetLineItem(data: unknown): UpdateBudgetLineItemInput {
 ...
 */
export function parseEventBudgetListFilters(searchParams: URLSearchParams): EventBudgetListFilters {
