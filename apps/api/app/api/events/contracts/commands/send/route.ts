// Auto-generated Next.js command handler for EventContract.send
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[event-contract/send] Executing command:", {
    ...
    const result = await runtime.runCommand("send", body, {
      entityName: "EventContract",
    });

    if (!result.success) {
      console.error("[event-contract/send] Command failed:", {
    ...
    console.error("[event-contract/send] Error:", error);
