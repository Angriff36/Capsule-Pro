// Auto-generated Next.js command handler for EventContract.expire
...
export async function POST(request: NextRequest) {
  try {
    ...
    // Validate status transition: * -> expired
    ...
    log.info("[event-contract/expire] Executing command:", {
    ...
    const result = await runtime.runCommand("expire", body, {
      entityName: "EventContract",
    });

    if (!result.success) {
      log.error("[event-contract/expire] Command failed:", {
    ...
    log.error("[event-contract/expire] Error:", error);
