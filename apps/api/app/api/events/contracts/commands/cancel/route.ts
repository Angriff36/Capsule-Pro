// Auto-generated Next.js command handler for EventContract.cancel
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[event-contract/cancel] Executing command:", {
    ...
    if (!result.success) {
      console.error("[event-contract/cancel] Command failed:", {
    ...
    console.error("[event-contract/cancel] Error:", error);
