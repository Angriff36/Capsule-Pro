// Auto-generated Next.js command handler for EventContract.softDelete
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[event-contract/softDelete] Executing command:", {
    ...
    if (!result.success) {
      console.error("[event-contract/softDelete] Command failed:", {
    ...
    console.error("[event-contract/softDelete] Error:", error);
