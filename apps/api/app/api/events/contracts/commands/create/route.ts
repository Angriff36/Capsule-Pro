// Auto-generated Next.js command handler for EventContract.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[event-contract/create] Executing command:", {
    ...
    if (!result.success) {
      console.error("[event-contract/create] Command failed:", {
    ...
    console.error("[event-contract/create] Error:", error);
