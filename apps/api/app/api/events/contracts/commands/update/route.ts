// Auto-generated Next.js command handler for EventContract.update
...
import { validateUpdateContractRequest } from "../../validation";
...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[event-contract/update] Executing command:", {
    ...
    if (!result.success) {
      log.error("[event-contract/update] Command failed:", {
    ...
    log.error("[event-contract/update] Error:", error);
