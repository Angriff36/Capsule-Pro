// Auto-generated Next.js command handler for EventReport.complete
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[event-report/complete] Executing command:", {
    ...
    if (!result.success) {
      console.error("[event-report/complete] Command failed:", {
    ...
    console.error("[event-report/complete] Error:", error);
