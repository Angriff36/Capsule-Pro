// Auto-generated Next.js command handler for EventReport.submit
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[event-report/submit] Executing command:", {
    ...
    if (!result.success) {
      console.error("[event-report/submit] Command failed:", {
    ...
    console.error("[event-report/submit] Error:", error);
