// Auto-generated Next.js command handler for EventReport.approve
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[event-report/approve] Executing command:", {
    ...
    if (!result.success) {
      console.error("[event-report/approve] Command failed:", {
    ...
    console.error("[event-report/approve] Error:", error);
