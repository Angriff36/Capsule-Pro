// Auto-generated Next.js command handler for EventReport.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[event-report/create] Executing command:", {
    ...
    if (!result.success) {
      log.error("[event-report/create] Command failed:", {
    ...
    log.error("[event-report/create] Error:", error);
