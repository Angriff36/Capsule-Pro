// Auto-generated Next.js command handler for EventSummary.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[event-summary/create] Executing command:", {
    ...
    if (!result.success) {
      console.error("[event-summary/create] Command failed:", {
    ...
    console.error("[event-summary/create] Error:", error);
