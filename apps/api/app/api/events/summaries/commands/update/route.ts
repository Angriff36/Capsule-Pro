// Auto-generated Next.js command handler for EventSummary.update
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[event-summary/update] Executing command:", {
    ...
    if (!result.success) {
      console.error("[event-summary/update] Command failed:", {
    ...
    console.error("[event-summary/update] Error:", error);
