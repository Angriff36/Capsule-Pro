// Auto-generated Next.js command handler for EventSummary.refresh
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[event-summary/refresh] Executing command:", {
    ...
    const result = await runtime.runCommand("refresh", body, {
      entityName: "EventSummary",
    });

    if (!result.success) {
      console.error("[event-summary/refresh] Command failed:", {
    ...
    console.error("[event-summary/refresh] Error:", error);
