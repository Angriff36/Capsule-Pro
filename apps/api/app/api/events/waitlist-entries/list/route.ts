// Auto-generated Next.js API route for EventWaitlistEntry
...
export async function GET(_request: NextRequest) {
  try {
    ...
    const eventWaitlistEntrys = await database.eventWaitlistEntry.findMany({
      where: {
        tenantId,
      },
      orderBy: {
    ...
    return manifestSuccessResponse({ eventWaitlistEntrys });
  } catch (error) {
    ...
    console.error("Error fetching eventWaitlistEntrys:", error);
    return manifestErrorResponse(
      {
