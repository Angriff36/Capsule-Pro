// Auto-generated Next.js API detail route for EventWaitlistEntry
...
export async function GET(
  ...
  if (!tenantId) {
    ...
    if (!eventWaitlistEntry) {
      return manifestErrorResponse({ error: "EventWaitlistEntry not found", diagnostics: [] }, 404);
    }

    return manifestSuccessResponse({ eventWaitlistEntry });
  } catch (error) {
    ...
    console.error("Error fetching eventWaitlistEntry:", error);
