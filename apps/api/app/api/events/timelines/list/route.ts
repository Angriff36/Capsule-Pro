// Auto-generated Next.js API route for EventTimeline
...
export async function GET(_request: NextRequest) {
  try {
    ...
    const eventTimelines = await database.eventTimeline.findMany({
      where: {
        tenantId,
        deletedAt: null,
      },
    ...
    return manifestSuccessResponse({ eventTimelines });
  } catch (error) {
    ...
    console.error("Error fetching eventTimelines:", error);
    return manifestErrorResponse(
      {
