// Auto-generated Next.js command handler for CommandBoardLayout.remove
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[command-board-layout/remove] Executing command:", {
    ...
    if (!result.success) {
      console.error("[command-board-layout/remove] Command failed:", {
    ...
    console.error("[command-board-layout/remove] Error:", error);
