...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[command-board-layout/remove] Executing command:", {
    ...
    if (!result.success) {
      log.error("[command-board-layout/remove] Command failed:", {
    ...
    log.error("[command-board-layout/remove] Error:", error);
