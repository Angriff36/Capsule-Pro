// Auto-generated Next.js command handler for CommandBoardLayout.update
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[command-board-layout/update] Executing command:", {
    ...
    if (!result.success) {
      console.error("[command-board-layout/update] Command failed:", {
    ...
    console.error("[command-board-layout/update] Error:", error);
