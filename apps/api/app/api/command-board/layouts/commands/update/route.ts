...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[command-board-layout/update] Executing command:", {
    ...
    if (!result.success) {
      log.error("[command-board-layout/update] Command failed:", {
    ...
    log.error("[command-board-layout/update] Error:", error);
