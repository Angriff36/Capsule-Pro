...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[command-board-layout/create] Executing command:", {
    ...
    if (!result.success) {
      log.error("[command-board-layout/create] Command failed:", {
    ...
    log.error("[command-board-layout/create] Error:", error);
