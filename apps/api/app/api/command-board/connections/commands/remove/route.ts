...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[command-board-connection/remove] Executing command:", {
    ...
    if (!result.success) {
      log.error("[command-board-connection/remove] Command failed:", {
    ...
    log.error("[command-board-connection/remove] Error:", error);
