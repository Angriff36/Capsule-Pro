// Auto-generated Next.js command handler for CommandBoardConnection.remove
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[command-board-connection/remove] Executing command:", {
      entityName: "CommandBoardConnection",
      command: "remove",
    ...
    if (!result.success) {
      console.error("[command-board-connection/remove] Command failed:", {
    ...
    console.error("[command-board-connection/remove] Error:", error);
