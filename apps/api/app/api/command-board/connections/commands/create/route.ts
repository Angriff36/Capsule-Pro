...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[command-board-connection/create] Executing command:", {
    ...
    if (!result.success) {
      log.error("[command-board-connection/create] Command failed:", {
    ...
    log.error("[command-board-connection/create] Error:", error);
