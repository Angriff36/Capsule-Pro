// Auto-generated Next.js command handler for CommandBoard.deactivate
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[command-board/deactivate] Executing command:", {
    ...
    if (!result.success) {
      console.error("[command-board/deactivate] Command failed:", {
    ...
    console.error("[command-board/deactivate] Error:", error);
