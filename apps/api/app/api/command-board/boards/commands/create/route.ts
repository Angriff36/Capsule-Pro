// Auto-generated Next.js command handler for CommandBoard.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[command-board/create] Executing command:", {
    ...
    if (!result.success) {
      console.error("[command-board/create] Command failed:", {
    ...
    console.error("[command-board/create] Error:", error);
