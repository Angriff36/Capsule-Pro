// Auto-generated Next.js command handler for CommandBoard.activate
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[command-board/activate] Executing command:", {
    ...
    if (!result.success) {
      console.error("[command-board/activate] Command failed:", {
    ...
    console.error("[command-board/activate] Error:", error);
