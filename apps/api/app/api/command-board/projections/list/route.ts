// Auto-generated Next.js API route for BoardProjection
...
export async function GET(_request: NextRequest) {
  try {
    ...
    const boardProjections = await database.boardProjection.findMany({
      where: {
        tenantId,
        deletedAt: null,
      },
    ...
    return manifestSuccessResponse({ boardProjections });
  } catch (error) {
    ...
    console.error("Error fetching boardProjections:", error);
    return manifestErrorResponse(
      {
