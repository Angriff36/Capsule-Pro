// Auto-generated Next.js command handler for CommandBoardCard.resize
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[command-board-card/resize] Executing command:", {
    ...
    const result = await runtime.runCommand("resize", body, {
      entityName: "CommandBoardCard",
    });

    if (!result.success) {
      console.error("[command-board-card/resize] Command failed:", {
    ...
    console.error("[command-board-card/resize] Error:", error);
