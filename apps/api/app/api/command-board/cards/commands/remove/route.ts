// Auto-generated Next.js command handler for CommandBoardCard.remove
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[command-board-card/remove] Executing command:", {
    ...
    if (!result.success) {
      console.error("[command-board-card/remove] Command failed:", {
    ...
    console.error("[command-board-card/remove] Error:", error);
