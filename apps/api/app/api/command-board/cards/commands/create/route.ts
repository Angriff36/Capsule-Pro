// Auto-generated Next.js command handler for CommandBoardCard.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[command-board-card/create] Executing command:", {
    ...
    if (!result.success) {
      console.error("[command-board-card/create] Command failed:", {
    ...
    console.error("[command-board-card/create] Error:", error);
