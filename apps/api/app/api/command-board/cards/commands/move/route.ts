// Auto-generated Next.js command handler for CommandBoardCard.move
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[command-board-card/move] Executing command:", {
    ...
    const result = await runtime.runCommand("move", body, {
      entityName: "CommandBoardCard",
    });

    if (!result.success) {
      console.error("[command-board-card/move] Command failed:", {
    ...
    console.error("[command-board-card/move] Error:", error);
