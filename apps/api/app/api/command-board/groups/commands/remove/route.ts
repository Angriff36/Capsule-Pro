// Auto-generated Next.js command handler for CommandBoardGroup.remove
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[command-board-group/remove] Executing command:", {
    ...
    if (!result.success) {
      console.error("[command-board-group/remove] Command failed:", {
    ...
    console.error("[command-board-group/remove] Error:", error);
