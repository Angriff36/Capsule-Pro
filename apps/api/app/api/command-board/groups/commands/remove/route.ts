...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[command-board-group/remove] Executing command:", {
    ...
    if (!result.success) {
      log.error("[command-board-group/remove] Command failed:", {
    ...
    log.error("[command-board-group/remove] Error:", error);
