...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[command-board-group/create] Executing command:", {
    ...
    if (!result.success) {
      log.error("[command-board-group/create] Command failed:", {
    ...
    log.error("[command-board-group/create] Error:", error);
