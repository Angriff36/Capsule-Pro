// Auto-generated Next.js command handler for CommandBoardGroup.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[command-board-group/create] Executing command:", {
      entityName: "CommandBoardGroup",
      command: "create",
    ...
    if (!result.success) {
      console.error("[command-board-group/create] Command failed:", {
    ...
    console.error("[command-board-group/create] Error:", error);
