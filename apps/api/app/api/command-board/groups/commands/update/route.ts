// Auto-generated Next.js command handler for CommandBoardGroup.update
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[command-board-group/update] Executing command:", {
    ...
    if (!result.success) {
      console.error("[command-board-group/update] Command failed:", {
    ...
    console.error("[command-board-group/update] Error:", error);
