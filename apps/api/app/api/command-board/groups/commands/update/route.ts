...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[command-board-group/update] Executing command:", {
    ...
    if (!result.success) {
      log.error("[command-board-group/update] Command failed:", {
    ...
    log.error("[command-board-group/update] Error:", error);
