// Auto-generated Next.js API route for BoardAnnotation
...
const boardAnnotations = await database.boardAnnotation.findMany({
    where: {
        tenantId,
        deletedAt: null
      },
    ...
    return manifestSuccessResponse({ boardAnnotations });
  } catch (error) {
    ...
    console.error("Error fetching boardAnnotations:", error);
