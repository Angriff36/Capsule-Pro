...
export async function GET(
  ...
  try {
    ...
    const taskMetrics = await database.$queryRaw<
      Array<{
        total_tasks: string;
    ...
    const timeEntryMetrics = await database.$queryRaw<
      Array<{
        total_shifts: string;
    ...
    const clientInteractionCount = await database.$queryRaw<
    ...
    const eventParticipationCount = await database.$queryRaw<
    ...
    const taskProgress = await database.$queryRaw<
      Array<{
