// Auto-generated Next.js command handler for TimeEntry.softDelete
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[time-entry/softDelete] Executing command:", {
    ...
    if (!result.success) {
      console.error("[time-entry/softDelete] Command failed:", {
    ...
    console.error("[time-entry/softDelete] Error:", error);
