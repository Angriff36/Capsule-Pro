// Auto-generated Next.js command handler for TimeEntry.clockOut
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[time-entry/clockOut] Executing command:", {
    ...
    const result = await runtime.runCommand("clockOut", body, {
      entityName: "TimeEntry",
    });

    if (!result.success) {
      console.error("[time-entry/clockOut] Command failed:", {
    ...
    console.error("[time-entry/clockOut] Error:", error);
