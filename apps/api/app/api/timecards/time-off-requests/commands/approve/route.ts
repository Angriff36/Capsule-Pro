// Auto-generated Next.js command handler for TimeOffRequest.approve
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[time-off-request/approve] Executing command:", {
    ...
    if (!result.success) {
      console.error("[time-off-request/approve] Command failed:", {
    ...
    console.error("[time-off-request/approve] Error:", error);
