// Auto-generated Next.js command handler for TimeOffRequest.softDelete
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[time-off-request/softDelete] Executing command:", {
    ...
    if (!result.success) {
      console.error("[time-off-request/softDelete] Command failed:", {
    ...
    console.error("[time-off-request/softDelete] Error:", error);
