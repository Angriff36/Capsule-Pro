...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[time-off-request/softDelete] Executing command", {
      data: {
    ...
    if (!result.success) {
      log.error("[time-off-request/softDelete] Command failed", {
    ...
    log.error("[time-off-request/softDelete] Error", { error });
