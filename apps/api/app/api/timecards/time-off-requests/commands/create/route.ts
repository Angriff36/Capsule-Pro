// Auto-generated Next.js command handler for TimeOffRequest.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[time-off-request/create] Executing command:", {
    ...
    if (!result.success) {
      console.error("[time-off-request/create] Command failed:", {
    ...
    console.error("[time-off-request/create] Error:", error);
