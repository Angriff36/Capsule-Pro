// Auto-generated Next.js command handler for TimeOffRequest.cancel
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[time-off-request/cancel] Executing command:", {
    ...
    if (!result.success) {
      console.error("[time-off-request/cancel] Command failed:", {
    ...
    console.error("[time-off-request/cancel] Error:", error);
