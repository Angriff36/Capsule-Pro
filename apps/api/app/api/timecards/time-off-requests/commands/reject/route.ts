// Auto-generated Next.js command handler for TimeOffRequest.reject
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[time-off-request/reject] Executing command:", {
    ...
    if (!result.success) {
      console.error("[time-off-request/reject] Command failed:", {
    ...
    console.error("[time-off-request/reject] Error:", error);
