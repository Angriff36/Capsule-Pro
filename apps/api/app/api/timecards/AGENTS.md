...
# Manifest reference for `apps/api/app/api/timecards`

**Why this file:** Bulk timecard approve is a real governance gap — add a governed bulk command or approve per entry through the command layer.
