// Auto-generated Next.js command handler for TimecardEditRequest.reject
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[timecard-edit-request/reject] Executing command:", {
    ...
    const result = await runtime.runCommand("reject", body, {
      entityName: "TimecardEditRequest",
    });

    if (!result.success) {
      console.error("[timecard-edit-request/reject] Command failed:", {
    ...
    console.error("[timecard-edit-request/reject] Error:", error);
