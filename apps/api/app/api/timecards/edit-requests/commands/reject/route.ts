...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[timecard-edit-request/reject] Executing command", {
      data: {
    ...
    if (!result.success) {
      log.error("[timecard-edit-request/reject] Command failed", {
    ...
    log.error("[timecard-edit-request/reject] Error", { error });
