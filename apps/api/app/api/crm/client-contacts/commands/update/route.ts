// Auto-generated Next.js command handler for ClientContact.update
...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[client-contact/update] Executing command:", {
    ...
    if (!result.success) {
      log.error("[client-contact/update] Command failed:", {
    ...
    log.error("[client-contact/update] Error:", error);
