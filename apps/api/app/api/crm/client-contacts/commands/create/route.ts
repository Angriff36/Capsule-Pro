// Auto-generated Next.js command handler for ClientContact.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[client-contact/create] Executing command:", {
    ...
    if (!result.success) {
      log.error("[client-contact/create] Command failed:", {
    ...
    log.error("[client-contact/create] Error:", error);
