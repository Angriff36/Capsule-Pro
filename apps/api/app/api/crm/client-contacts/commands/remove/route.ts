// Auto-generated Next.js command handler for ClientContact.remove
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[client-contact/remove] Executing command:", {
    ...
    if (!result.success) {
      console.error("[client-contact/remove] Command failed:", {
    ...
    console.error("[client-contact/remove] Error:", error);
