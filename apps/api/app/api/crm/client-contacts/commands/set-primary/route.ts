// Auto-generated Next.js command handler for ClientContact.setPrimary
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[client-contact/setPrimary] Executing command:", {
    ...
    const result = await runtime.runCommand("setPrimary", body, {
      entityName: "ClientContact",
    });

    if (!result.success) {
      console.error("[client-contact/setPrimary] Command failed:", {
    ...
    console.error("[client-contact/setPrimary] Error:", error);
