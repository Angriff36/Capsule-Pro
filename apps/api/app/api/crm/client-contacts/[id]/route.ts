// Auto-generated Next.js API detail route for ClientContact
...
export async function GET(
  ...
  if (!tenantId) {
    ...
    const clientContact = await database.clientContact.findFirst({
      where: {
        id,
        tenantId,
        deletedAt: null
    ...
    if (!clientContact) {
      return manifestErrorResponse({ error: "ClientContact not found", diagnostics: [] }, 404);
    }
