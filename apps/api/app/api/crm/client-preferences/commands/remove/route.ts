// Auto-generated Next.js command handler for ClientPreference.remove
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[client-preference/remove] Executing command:", {
    ...
    if (!result.success) {
      console.error("[client-preference/remove] Command failed:", {
    ...
    console.error("[client-preference/remove] Error:", error);
