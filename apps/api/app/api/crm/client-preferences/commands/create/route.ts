// Auto-generated Next.js command handler for ClientPreference.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[client-preference/create] Executing command:", {
    ...
    if (!result.success) {
      console.error("[client-preference/create] Command failed:", {
    ...
    console.error("[client-preference/create] Error:", error);
