// Auto-generated Next.js command handler for ClientPreference.update
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[client-preference/update] Executing command:", {
    ...
    if (!result.success) {
      console.error("[client-preference/update] Command failed:", {
    ...
    console.error("[client-preference/update] Error:", error);
