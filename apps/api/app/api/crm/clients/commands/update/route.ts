// Auto-generated Next.js command handler for Client.update
...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[client/update] Executing command:", {
      entityName: "Client",
      command: "update",
    ...
    if (!result.success) {
      log.error("[client/update] Command failed:", {
    ...
    log.error("[client/update] Error:", error);
