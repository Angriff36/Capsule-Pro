// Auto-generated Next.js command handler for Client.reactivate
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[client/reactivate] Executing command:", {
      entityName: "Client",
      command: "reactivate",
    ...
    const result = await runtime.runCommand("reactivate", body, {
      entityName: "Client",
    });

    if (!result.success) {
      console.error("[client/reactivate] Command failed:", {
    ...
    console.error("[client/reactivate] Error:", error);
