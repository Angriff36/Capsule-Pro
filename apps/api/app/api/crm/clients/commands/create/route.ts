// Auto-generated Next.js command handler for Client.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[client/create] Executing command:", {
      entityName: "Client",
      command: "create",
    ...
    if (!result.success) {
      log.error("[client/create] Command failed:", {
    ...
    log.error("[client/create] Error:", error);
