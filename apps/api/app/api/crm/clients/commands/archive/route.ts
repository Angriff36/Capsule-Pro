// Auto-generated Next.js command handler for Client.archive
...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[client/archive] Executing command:", {
      entityName: "Client",
      command: "archive",
    ...
    if (!result.success) {
      log.error("[client/archive] Command failed:", {
    ...
    log.error("[client/archive] Error:", error);
