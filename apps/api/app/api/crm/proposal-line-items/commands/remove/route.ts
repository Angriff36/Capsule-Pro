// Auto-generated Next.js command handler for ProposalLineItem.remove
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[proposal-line-item/remove] Executing command:", {
    ...
    if (!result.success) {
      console.error("[proposal-line-item/remove] Command failed:", {
    ...
    console.error("[proposal-line-item/remove] Error:", error);
