// Auto-generated Next.js command handler for ProposalLineItem.update
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[proposal-line-item/update] Executing command:", {
    ...
    if (!result.success) {
      console.error("[proposal-line-item/update] Command failed:", {
    ...
    console.error("[proposal-line-item/update] Error:", error);
