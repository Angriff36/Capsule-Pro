// Auto-generated Next.js command handler for ProposalLineItem.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[proposal-line-item/create] Executing command:", {
    ...
    if (!result.success) {
      console.error("[proposal-line-item/create] Command failed:", {
    ...
    console.error("[proposal-line-item/create] Error:", error);
