// Auto-generated Next.js API route for ProposalTemplate
...
const proposalTemplates = await database.proposalTemplate.findMany({
    where: {
        tenantId,
        deletedAt: null
      },
    ...
    return manifestSuccessResponse({ proposalTemplates });
  } catch (error) {
    ...
    console.error("Error fetching proposalTemplates:", error);
