// Auto-generated Next.js command handler for ClientInteraction.complete
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[client-interaction/complete] Executing command:", {
    ...
    if (!result.success) {
      console.error("[client-interaction/complete] Command failed:", {
    ...
    console.error("[client-interaction/complete] Error:", error);
