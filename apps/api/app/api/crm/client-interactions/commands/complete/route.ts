...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[client-interaction/complete] Executing command:", {
    ...
    if (!result.success) {
      log.error("[client-interaction/complete] Command failed:", {
    ...
    log.error("[client-interaction/complete] Error:", error);
