// Auto-generated Next.js command handler for ClientInteraction.update
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[client-interaction/update] Executing command:", {
    ...
    if (!result.success) {
      console.error("[client-interaction/update] Command failed:", {
    ...
    console.error("[client-interaction/update] Error:", error);
