// Auto-generated Next.js command handler for ClientInteraction.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[client-interaction/create] Executing command:", {
    ...
    if (!result.success) {
      console.error("[client-interaction/create] Command failed:", {
    ...
    console.error("[client-interaction/create] Error:", error);
