// Auto-generated Next.js command handler for Lead.disqualify
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[lead/disqualify] Executing command:", {
      entityName: "Lead",
      command: "disqualify",
    ...
    const result = await runtime.runCommand("disqualify", body, {
      entityName: "Lead",
    });

    if (!result.success) {
      console.error("[lead/disqualify] Command failed:", {
    ...
    console.error("[lead/disqualify] Error:", error);
