// Auto-generated Next.js command handler for Lead.convertToClient
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[lead/convertToClient] Executing command:", {
      entityName: "Lead",
    ...
    const result = await runtime.runCommand("convertToClient", body, {
      entityName: "Lead",
    });

    if (!result.success) {
      console.error("[lead/convertToClient] Command failed:", {
    ...
    console.error("[lead/convertToClient] Error:", error);
