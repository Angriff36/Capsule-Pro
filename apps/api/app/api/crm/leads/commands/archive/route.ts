// Auto-generated Next.js command handler for Lead.archive
...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[lead/archive] Executing command:", {
      entityName: "Lead",
      command: "archive",
    ...
    if (!result.success) {
      log.error("[lead/archive] Command failed:", {
    ...
    log.error("[lead/archive] Error:", error);
