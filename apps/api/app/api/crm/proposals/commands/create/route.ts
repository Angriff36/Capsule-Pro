// Auto-generated Next.js command handler for Proposal.create
...
export async function POST(request: NextRequest) {
  try {
    ...
    log.info("[proposal/create] Executing command:", {
      entityName: "Proposal",
      command: "create",
    ...
    if (!result.success) {
      log.error("[proposal/create] Command failed:", {
    ...
    log.error("[proposal/create] Error:", error);
