// Auto-generated Next.js command handler for Proposal.convertToInvoice
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[proposal/convertToInvoice] Executing command:", {
      entityName: "Proposal",
      command: "convertToInvoice",
    ...
    const result = await runtime.runCommand("convertToInvoice", body, {
      entityName: "Proposal",
    });

    if (!result.success) {
      console.error("[proposal/convertToInvoice] Command failed:", {
    ...
    console.error("[proposal/convertToInvoice] Error:", error);
