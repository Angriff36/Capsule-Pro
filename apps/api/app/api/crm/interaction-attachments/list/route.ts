// Auto-generated Next.js API route for InteractionAttachment
...
const interactionAttachments = await database.interactionAttachment.findMany({
    where: {
        tenantId,
        deletedAt: null
      },
    ...
    return manifestSuccessResponse({ interactionAttachments });
  } catch (error) {
    ...
    console.error("Error fetching interactionAttachments:", error);
