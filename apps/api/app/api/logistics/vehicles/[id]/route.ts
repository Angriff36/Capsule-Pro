// Auto-generated Next.js API detail route for Vehicle
...
export async function GET(
  ...
  if (!tenantId) {
    ...
    if (!vehicle) {
      return manifestErrorResponse({ error: "Vehicle not found", diagnostics: [] }, 404);
    }

    return manifestSuccessResponse({ vehicle });
  } catch (error) {
