// Auto-generated Next.js API route for DeliveryRoute
...
const deliveryRoutes = await database.deliveryRoute.findMany({
    where: {
        tenantId,
        deletedAt: null
      },
    ...
    return manifestSuccessResponse({ deliveryRoutes });
  } catch (error) {
    ...
    console.error("Error fetching deliveryRoutes:", error);
