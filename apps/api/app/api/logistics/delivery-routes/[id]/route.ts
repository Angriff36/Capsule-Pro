// Auto-generated Next.js API detail route for DeliveryRoute
...
export async function GET(
  ...
  if (!tenantId) {
    ...
    if (!deliveryRoute) {
      return manifestErrorResponse({ error: "DeliveryRoute not found", diagnostics: [] }, 404);
    }

    return manifestSuccessResponse({ deliveryRoute });
  } catch (error) {
    ...
    console.error("Error fetching deliveryRoute:", error);
