// Auto-generated Next.js API route for LogisticsDispatch
...
const logisticsDispatchs = await database.logisticsDispatch.findMany({
    where: {
        tenantId,
        deletedAt: null
      },
    ...
    return manifestSuccessResponse({ logisticsDispatchs });
  } catch (error) {
    ...
    console.error("Error fetching logisticsDispatchs:", error);
