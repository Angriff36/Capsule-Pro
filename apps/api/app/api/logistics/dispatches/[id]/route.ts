// Auto-generated Next.js API detail route for LogisticsDispatch
...
export async function GET(
  ...
  if (!tenantId) {
    ...
    if (!logisticsDispatch) {
      return manifestErrorResponse({ error: "LogisticsDispatch not found", diagnostics: [] }, 404);
    }

    return manifestSuccessResponse({ logisticsDispatch });
  } catch (error) {
    ...
    console.error("Error fetching logisticsDispatch:", error);
