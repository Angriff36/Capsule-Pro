// Auto-generated Next.js command handler for PrepListItem.markCompleted
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await runtime.runCommand("markCompleted", body, {
    ...
    console.error("Error executing PrepListItem.markCompleted:", error);
