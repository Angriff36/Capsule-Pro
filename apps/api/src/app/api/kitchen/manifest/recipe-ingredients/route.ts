...
//
// Provenance:
//   Generated At: 2026-02-09T17:30:29.005Z
...
/**
 * Generated route handler for RecipeIngredient
 *
...
export async function GET(_request: Request) {
  ...
  // 3. Execute operation
  try {
    // Query RecipeIngredient using Prisma (runtime is for commands, not queries)
