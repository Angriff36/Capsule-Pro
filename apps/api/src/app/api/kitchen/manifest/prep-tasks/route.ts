...
// Source manifest: C:\projects\capsule-pro\packages\kitchen-ops\manifests\prep-task-rules.manifest
...
//
// Provenance:
//   Generated At: 2026-02-09T17:30:03.784Z
...
/**
 * Generated route handler for PrepTask
 *
 * Generated from: C:\projects\capsule-pro\packages\kitchen-ops\manifests\prep-task-rules.manifest
 *
...
export async function GET(request: Request) {
  ...
  // 3. Execute operation
  try {
    // Query PrepTask using Prisma (runtime is for commands, not queries)
