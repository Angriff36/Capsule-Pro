// Auto-generated Next.js command handler for Station.removeTask
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await runtime.runCommand("removeTask", body, {
      entityName: "Station",
    });
    ...
    console.error("Error executing Station.removeTask:", error);
