// Auto-generated Next.js command handler for Station.assignTask
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await runtime.runCommand("assignTask", body, {
      entityName: "Station",
    });
    ...
    console.error("Error executing Station.assignTask:", error);
