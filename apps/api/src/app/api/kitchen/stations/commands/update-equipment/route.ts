// Auto-generated Next.js command handler for Station.updateEquipment
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await runtime.runCommand("updateEquipment", body, {
      entityName: "Station",
    });
    ...
    console.error("Error executing Station.updateEquipment:", error);
