// Auto-generated Next.js command handler for Station.updateCapacity
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await runtime.runCommand("updateCapacity", body, {
      entityName: "Station",
    });
    ...
    console.error("Error executing Station.updateCapacity:", error);
