// Auto-generated Next.js command handler for Ingredient.updateAllergens
...
export async function POST(request: NextRequest) {
  ...
  const userId = "anonymous";
    ...
    const result = await runtime.runCommand("updateAllergens", body, {
    ...
    console.error("Error executing Ingredient.updateAllergens:", error);
