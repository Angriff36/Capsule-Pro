// Auto-generated Next.js command handler for InventoryItem.releaseReservation
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await runtime.runCommand("releaseReservation", body, {
    ...
    console.error("Error executing InventoryItem.releaseReservation:", error);
