// Auto-generated Next.js command handler for Dish.updateLeadTime
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await runtime.runCommand("updateLeadTime", body, {
      entityName: "Dish",
    });
    ...
    console.error("Error executing Dish.updateLeadTime:", error);
