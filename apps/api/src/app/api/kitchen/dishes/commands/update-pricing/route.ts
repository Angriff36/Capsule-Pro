// Auto-generated Next.js command handler for Dish.updatePricing
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await runtime.runCommand("updatePricing", body, {
      entityName: "Dish",
    });
    ...
    console.error("Error executing Dish.updatePricing:", error);
