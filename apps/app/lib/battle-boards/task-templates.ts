...
export const TASK_TEMPLATES: TaskTemplate[] = [
  ...
  {
    group: "PREP / SETUP",
    label: "Unload & Stage (ER)",
    defaultTeam: "Everyone",
    defaultLocation: "Scullery",
    defaultStyle: "NA",
    notes: "Unload vehicles; stage ER by area; set bleach & handwash.",
  },
  {
    group: "PREP / SETUP",
  ...
  },
  {
    ...
    defaultStyle: "Dessert",
    notes: "S'mores/cake space; sternos if needed.",
  },
  {
    group: "PREP / SETUP",
    label: "Stage Place Settings",
    defaultTeam: "FOH",
    defaultLocation: "Dining",
    defaultStyle: "NA",
    notes: "Unwrap & stage stacks by table.",
  },
  {
    group: "PREP / SETUP",
    label: "Set Place Settings",
    defaultTeam: "FOH",
    defaultLocation: "Dining",
    defaultStyle: "NA",
    notes: "Napkin fold, utensils, goblets; follow book.",
  },
  {
    group: "PREP / SETUP",
    label: "Prepare Trays & Jacks",
    defaultTeam: "FOH",
    defaultLocation: "Staging",
    defaultStyle: "NA",
    notes: "Clean/sanitize trays; drape linens.",
  },
  {
    group: "PREP / SETUP",
  ...
  },
  {
    ...
    defaultStyle: "Passed",
    notes: "2 laps pass, 1 lap buss; repeat.",
  },
  {
    group: "SERVICE",
    label: "Stationary Apps Monitor/Refill",
    defaultTeam: "FOH",
    defaultLocation: "Apps",
    defaultStyle: "NA",
    notes: "Keep refreshed/clean; run to kitchen.",
  },
  {
    group: "SERVICE",
  ...
  {
    group: "SERVICE",
    label: "Stock Buffet / Set Food",
    defaultTeam: "FOH/BOH",
    defaultLocation: "Buffet",
    defaultStyle: "Buffet",
    notes: "Land food; check water; refill.",
  },
  {
    group: "SERVICE",
  ...
  },
  {
    ...
    defaultTeam: "FOH",
    defaultLocation: "Buffet/Dessert",
    defaultStyle: "Dessert",
  ...
  // BREAKDOWN / CLOSEOUT
  {
    ...
    label: "Break Down Buffet",
    defaultTeam: "FOH",
    defaultLocation: "Buffet",
    defaultStyle: "NA",
    notes: "Clean/dry chafers; box decor; return to truck.",
  },
  {
    group: "BREAKDOWN / CLOSEOUT",
    label: "Decor Packing",
    ...
    defaultLocation: "Buffet/Dessert",
    defaultStyle: "NA",
    notes: "Pack per checklist; protect fragile items.",
  },
  {
    group: "BREAKDOWN / CLOSEOUT",
    label: "Final Bussing & Walkthrough",
    defaultTeam: "FOH",
    defaultLocation: "Everywhere",
    defaultStyle: "NA",
    notes: "Return ER; trash; final check & sign-off.",
  },
  {
    group: "BREAKDOWN / CLOSEOUT",
    label: "Strike & Load Out",
    defaultTeam: "FOH",
    defaultLocation: "Buffet/Truck",
    defaultStyle: "NA",
    notes: "Strike tables; load DS; wipe down.",
  },
  // BAR
  {
    group: "BAR",
...
export const TASK_TEMPLATE_GROUPS = [
  ...new Set(TASK_TEMPLATES.map((t) => t.group)),
];
