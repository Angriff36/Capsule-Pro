...
// ---------------------------------------------------------------------------
// Extracted tabs component to keep main file under 500 lines
// ---------------------------------------------------------------------------

import type { SalesMetrics } from "./lib/sales-analytics";

function SalesMetricsTabs({
  metrics,
  salesData,
  validation,
  flatData,
  ...
  salesData: SalesData;
  validation: ReturnType<typeof validateFunnel>;
