...
const use_kitchen_analytics_1 = require("./lib/use-kitchen-analytics");
const AnalyticsKitchenPage = () => {
  const { data, isLoading, error } = (0,
  use_kitchen_analytics_1.useKitchenAnalytics)("30d");
  if (isLoading) {
    return (
      <div className="space-y-6">
        ...
        <div className="grid gap-4 lg:grid-cols-2">
          <card_1.Card className="space-y-3">
            <card_1.CardHeader>
              <card_1.CardTitle>Station Throughput</card_1.CardTitle>
            </card_1.CardHeader>
          ...
          <card_1.Card>
            <card_1.CardHeader>
              <card_1.CardTitle>Kitchen Health</card_1.CardTitle>
            </card_1.CardHeader>
            <card_1.CardContent className="space-y-3">
              {[1, 2, 3, 4].map((i) => (
                <skeleton_1.Skeleton className="h-8 w-full" key={i} />
              ))}
            </card_1.CardContent>
          </card_1.Card>
        </div>
    ...
    return (
      <div className="space-y-6">
        ...
        <card_1.Card className="border-red-200 bg-red-50">
          <card_1.CardContent className="flex items-center gap-2 p-6">
        ...
        <card_1.Card className="space-y-3">
          <card_1.CardHeader>
            <div className="flex items-center justify-between">
              <card_1.CardTitle>Station Throughput</card_1.CardTitle>
              <badge_1.Badge className="gap-1" variant="outline">
              ...
              stationThroughput.map((station) => (
                <div className="space-y-2" key={station.stationId}>
                  ...
                  <div className="space-y-1 text-xs text-muted-foreground">
                    ...
                    <div className="h-2 rounded-full bg-slate-100">
                      <div
                        className={`h-2 rounded-full ${(0, use_kitchen_analytics_1.getCompletionColor)(station.completed)}`}
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between text-sm">
                <div className="flex items-center gap-2">
                  <lucide_react_1.CheckCircle2 className="h-4 w-4 text-emerald-500" />
...
exports.default = AnalyticsKitchenPage;
