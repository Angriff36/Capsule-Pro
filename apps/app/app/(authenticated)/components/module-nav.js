...
exports.getModuleKeyFromPathname = exports.modules = void 0;
exports.modules = [
  {
    key: "events",
    label: "Events",
...
const getModuleKeyFromPathname = (pathname) => {
  const match = exports.modules.find(
    (module) =>
      pathname === module.href || pathname.startsWith(`${module.href}/`)
  );
  return match?.key ?? "events";
};
exports.getModuleKeyFromPathname = getModuleKeyFromPathname;
