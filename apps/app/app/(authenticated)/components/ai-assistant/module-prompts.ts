...
const MODULE_PROMPTS: Partial<Record<ModuleKey, QuickPrompt[]>> = {
  calendar: [
    { label: "What's coming up?", prompt: "What events are scheduled this week?" },
    { label: "Find conflicts", prompt: "Are there any scheduling conflicts?" },
  ],
  events: [
    { label: "Create event", prompt: "Help me create a new event" },
    { label: "Event summary", prompt: "Summarize upcoming events and their status" },
  ],
  kitchen: [
  ...
  staffing: [
    { label: "Coverage gaps", prompt: "Are there any staffing coverage gaps this week?" },
    { label: "Availability", prompt: "Show me staff availability for this week" },
  ],
  logistics: [
    { label: "Deliveries today", prompt: "What deliveries are scheduled today?" },
  ...
  analytics: [
    { label: "This week", prompt: "Give me a summary of this week's key metrics" },
...
const DEFAULT_PROMPTS: QuickPrompt[] = [
  ...
  { label: "Suggest actions", prompt: "What actions should I take based on current state?" },
  { label: "Find conflicts", prompt: "Are there any conflicts or issues I should know about?" },
];
