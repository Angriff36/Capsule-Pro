    ...
    <PageCanvas>
      <CommandBand>
        <CommandBandHeader>
          <div className="space-y-4">
            ...
            <CommandBandLede>
              Review, approve, or reject payroll runs before payout.
            </CommandBandLede>
          </div>
        </CommandBandHeader>
        <CommandBandBody>
          <MetricBand cols={4}>
            ...
            <MetricCell>
              ...
              <MetricValue>
                {formatCurrency(
                  approvals.reduce((s, a) => s + a.totalGross, 0)
                )}
              </MetricValue>
            </MetricCell>
            <MetricCell>
      ...
      <OperationalColumn>
        ...
        <div className="flex gap-1">
          <button
            className={`inline-flex items-center rounded-full px-4 py-1.5 font-medium text-sm transition-colors ${
              activeTab === "queue"
                ? "bg-ink text-white"
              ...
              {selectedIds.size > 0 && (
                <div className="flex items-center gap-2">
                  ...
                  <Button
                    disabled={actionLoading !== null}
                    onClick={() =>
                      setRejectDialog({ id: "bulk", type: "bulk" })
                    }
                    size="sm"
                    variant="destructive"
                  >
                  ...
                  {historyPagination.totalPages > 1 && (
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex gap-2">
                        <Button
                          disabled={
                            historyPagination.page <= 1 || historyLoading
                          }
                          onClick={() =>
          ...
          <DialogContent className="max-w-2xl">
            ...
            {detailRun && (
              <div className="space-y-6">
                ...
                <div>
                  <h4 className="mb-3 font-medium text-sm">Approval History</h4>
                      ...
                      {detailHistory.map((entry, index) => (
                        <div className="flex items-start gap-3" key={entry.id}>
                          ...
                          {index < detailHistory.length - 1 && (
                            <div className="absolute mt-8 ml-[7px] border-muted border-l-2 border-dashed" />
                          )}
                        </div>
                      ))}
                    </div>
