  ...
  const checkTypes = [
    {
      type: "receiving",
      label: "Receiving",
      description: "Inspect incoming deliveries",
    },
    {
      type: "storage",
      label: "Storage",
    ...
    { type: "prep", label: "Prep", description: "Monitor food preparation" },
    {
      type: "cooking",
      label: "Cooking",
      description: "Verify cooking temperatures",
    },
    {
      type: "cooling",
      label: "Cooling",
      description: "Track cooling times and temps",
    },
    {
      type: "holding",
      label: "Holding",
      description: "Monitor hot/cold holding",
    },
    {
      type: "transport",
      label: "Transport",
      description: "Verify transport conditions",
    },
  ];
            ...
            {recentLogs.map((log) => (
              ...
              >
                <div className="flex items-center gap-3">
                  <Thermometer
                    className={`h-4 w-4 ${log.status === "warning" ? "text-yellow-500" : "text-green-500"}`}
                  />
