...
const CleanupImportsPage = async () => {
  ...
  return (
    <>
      <header_1.Header
        page="Cleanup Imports"
        pages={["Kitchen Ops", "Recipes"]}
      >
      ...
      <div className="flex flex-1 flex-col gap-6 p-4 pt-0">
        <card_1.Card>
          <card_1.CardHeader>
            <card_1.CardTitle>Imported item cleanup</card_1.CardTitle>
          ...
          <card_1.CardContent className="space-y-4">
            {rows.length === 0 ? (
              ...
              <form
                action={server_actions_1.cleanupImportedItems}
                className="space-y-4"
              >
                ...
                <div className="flex items-center gap-2">
                  <button_1.Button type="submit">Run cleanup</button_1.Button>
...
exports.default = CleanupImportsPage;
