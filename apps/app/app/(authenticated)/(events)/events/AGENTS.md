...
divergences: D1, D2
pages: language/stores, language/commands, language/workflows
note: >-
...
# Manifest reference for `apps/app/app/(authenticated)/events`

**Why this file:** Event setup/import server actions write governed entities via Prisma and raw $executeRaw — route through the command layer / a native event-import saga backed by GenericPrismaStore.

**Relevant divergences:** D1, D2 — see `manifest/MANIFEST-DIVERGENCES.md` for the full remediation detail.
