...
exports.default = CycleCountingPage;
const navigation_1 = require("next/navigation");
const sessions_1 = require("./actions/sessions");
async function CycleCountingPage() {
  const sessions = await (0, sessions_1.listCycleCountSessions)();
  return (
    <div className="p-6">
      <div className="mb-6">
      ...
      <form
        action={async (formData) => {
          "use server";
          const result = await (0, sessions_1.createCycleCountSession)({
          ...
          if (result.success) {
            (0, navigation_1.redirect)(
              `/cycle-counting/${result.session?.sessionId}`
            );
          }
        }}
        className="mb-6"
