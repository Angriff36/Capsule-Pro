...
export const RecipeImagePlaceholder = ({
  ...
  return (
    <>
      <div className="flex h-full w-full flex-col gap-3 bg-linear-to-br from-muted/80 via-muted/40 to-background p-3 text-muted-foreground">
        <button
        ...
        <ClipboardImageButton
          className="inline-flex w-full items-center justify-center gap-2 rounded-md border-2 border-muted-foreground/30 border-dashed bg-background/80 px-3 py-3 font-medium text-foreground text-xs transition-colors hover:border-muted-foreground/50 hover:bg-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/40"
          disabled={isPending}
