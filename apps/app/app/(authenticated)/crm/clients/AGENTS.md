...
# Manifest reference for `apps/app/app/(authenticated)/crm/clients`

**Why this file:** CRM client actions: keep mutations going through runManifestCommand (the correct pattern already used here) for all governed writes.
