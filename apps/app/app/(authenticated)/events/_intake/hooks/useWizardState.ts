...
export const WIZARD_STEPS: WizardStep[] = [
  ...
  },
  {
    id: "details",
    title: "Event Details",
    subtitle: "Type, format & guest count",
    icon: "Users",
  },
  {
    id: "service",
  ...
  },
  {
    id: "menu",
    title: "Menu & Dietary",
    subtitle: "Cuisine & dietary needs",
    icon: "ChefHat",
  },
  {
    id: "staffing",
    title: "Staffing",
    subtitle: "Your service team",
    icon: "UserCheck",
  },
  {
    id: "extras",
    title: "Extras & Bar",
    subtitle: "Rentals, bar & add-ons",
    icon: "Wine",
  },
  {
    id: "logistics",
    title: "Logistics",
    subtitle: "Date, venue & location",
    icon: "MapPin",
  },
  {
    id: "contact",
    title: "Final Details",
    subtitle: "Notes & contact info",
    icon: "Send",
  },
  {
    id: "review",
    title: "Review",
    subtitle: "Your estimate & summary",
    icon: "ClipboardCheck",
  },
];
...
export function useWizardState(pricingRules: PricingRules) {
  ...
  const toggleArrayItem = useCallback(
    (field: keyof WizardFormData, item: string) => {
      setFormData((prev) => {
