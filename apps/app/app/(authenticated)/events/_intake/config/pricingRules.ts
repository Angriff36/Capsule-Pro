...
export const defaultPricingRules: PricingRules = {
  ...
  staffingModifiers: {
    minimal: {
      label: "Minimal (drop-off only)",
      perPersonAddonLow: 0,
      perPersonAddonHigh: 0,
    },
    standard: {
      label: "Standard Service",
      perPersonAddonLow: 8,
      perPersonAddonHigh: 15,
    },
    elevated: {
      label: "Elevated (dedicated servers)",
      perPersonAddonLow: 15,
      perPersonAddonHigh: 28,
    },
    "white-glove": {
      label: "White Glove (full team)",
      perPersonAddonLow: 25,
      perPersonAddonHigh: 45,
    },
  },
  ...
  barModifiers: {
    ...
    "premium-bar": {
      label: "Premium / Craft Bar",
      perPersonLow: 42,
      perPersonHigh: 65,
    },
    "byob-service": {
      label: "BYOB (bartender only)",
      perPersonLow: 8,
      perPersonHigh: 15,
    },
  },
  ...
  addOnItems: {
    "late-night-snack": {
      label: "Late Night Snack Station",
      perPersonLow: 8,
      perPersonHigh: 18,
    },
    "dessert-table": {
    ...
    "grazing-display": {
      label: "Grazing / Charcuterie Display",
      perPersonLow: 10,
      perPersonHigh: 22,
    },
    "raw-bar": {
      label: "Raw Bar / Oyster Station",
      perPersonLow: 14,
      perPersonHigh: 28,
    },
    "espresso-cart": {
    ...
    "action-station": {
      label: "Live Action Station (chef)",
      perPersonLow: 12,
      perPersonHigh: 25,
    },
  },
