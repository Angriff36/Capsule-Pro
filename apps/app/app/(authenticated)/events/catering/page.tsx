			...
			<CommandBand>
				<CommandBandHeader>
					<div className="space-y-4">
						...
						<CommandBandLede>
							Manage catering orders from draft through delivery. Track financials,
							venue details, guest counts, and staff assignments.
						</CommandBandLede>
					</div>
					<CommandBandActions>
						<Button
				...
				<CommandBandBody>
					<MetricBand cols={4}>
						...
						<MetricCell>
							...
							<MetricValue>
								${Number(totalRevenue._sum.totalAmount ?? 0).toLocaleString("en-US", { minimumFractionDigits: 2 })}
							</MetricValue>
							<p className="text-sm text-white/70">
