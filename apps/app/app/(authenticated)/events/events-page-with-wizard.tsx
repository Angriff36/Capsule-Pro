...
import {
  EventsWizardProvider,
  useEventsWizard,
} from "./components/events-wizard-context";
...
function EventsWizardDialog() {
  const { isOpen, closeWizard } = useEventsWizard();
...
export function EventsPageWithWizard({
  children,
}: {
