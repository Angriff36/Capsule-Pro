...
# Manifest reference for `apps/app/app/(authenticated)/crm/proposals/templates`

**Why this file:** Proposal-template actions write governed entities directly — route through runManifestCommand.
