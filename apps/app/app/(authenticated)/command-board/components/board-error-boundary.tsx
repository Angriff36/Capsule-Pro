 ...
 */
export function EntityDetailPanelErrorBoundary({ children }: { children: ReactNode }) {
  return (
    <ErrorBoundary componentName="EntityDetailPanel" compact>
      {children}
    </ErrorBoundary>
  );
}
 ...
 */
export function BoardFilterPanelErrorBoundary({ children }: { children: ReactNode }) {
  return (
    <ErrorBoundary componentName="BoardFilterPanel" compact>
      {children}
    </ErrorBoundary>
  );
}
