...
import { z } from "zod";
import { trainingModuleUpdate } from "@/app/lib/manifest-client.generated";
...
export function EditTrainingModuleDialog({
  ...
  const form = useForm<FormValues>({
    ...
    defaultValues: {
      ...
      contentType: defaultValues.contentType as FormValues["contentType"],
              ...
              render={({ field }) => (
                <FormItem className="flex items-center justify-between rounded-lg border p-3">
                  <div className="space-y-0.5">
                    ...
                    <FormDescription>
                      Active modules are available for assignment
                    </FormDescription>
                  </div>
                  <FormControl>
                    <Switch
