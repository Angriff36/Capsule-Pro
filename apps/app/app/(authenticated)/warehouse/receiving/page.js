...
function ReceivingPage() {
  const [searchPO, setSearchPO] = (0, react_1.useState)("");
  ...
  const handlePOSearch = () => {
    if (!searchPO.trim()) {
      sonner_1.toast.error("Please enter a PO number");
      return;
    }
    setScanning(true);
    setTimeout(() => {
      ...
      setScanning(false);
      sonner_1.toast.success(`PO ${searchPO} loaded successfully`);
    }, 1000);
  };
  const handleScan = () => {
    setScanning(true);
    setTimeout(() => {
      setScanning(false);
      sonner_1.toast.success("Item scanned: PROD-001 - Organic Tomatoes");
    }, 1500);
  };
  const updateItemQuality = (itemId, status) => {
    if (!selectedPO) {
      return;
    }
  ...
  const completeReceiving = () => {
    ...
    sonner_1.toast.success("Receiving completed. Stock levels updated.");
    setSelectedPO(null);
    setSearchPO("");
  };
    ...
    <div className="container mx-auto p-4 space-y-6">
      ...
      {selectedPO && (
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          <card_1.Card className="md:col-span-2 lg:col-span-2">
            <card_1.CardHeader>
              <card_1.CardTitle>PO Items</card_1.CardTitle>
              <card_1.CardDescription>
            ...
            <card_1.CardContent>
                    ...
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <div className="text-right">
                        ...
                        {item.discrepancy_type && (
                          <badge_1.Badge className="mt-1" variant="destructive">
                            {item.discrepancy_type}
                          </badge_1.Badge>
                        )}
                      </div>
                    ...
                    <div className="grid gap-3 sm:grid-cols-2">
                      ...
                      <div>
                        ...
                        <select
                          ...
                          id={`quality-${item.id}`}
                          onChange={(e) =>
                            updateItemQuality(item.id, e.target.value)
                          }
              ...
              <div className="mt-6 flex justify-end gap-2">
                ...
                <button_1.Button className="gap-2" onClick={completeReceiving}>
          ...
          <card_1.Card>
            <card_1.CardHeader>
              <card_1.CardTitle>PO Summary</card_1.CardTitle>
            </card_1.CardHeader>
            <card_1.CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <badge_1.Badge className="capitalize" variant="secondary">
                    {selectedPO.status}
                  </badge_1.Badge>
                </div>
              </div>
