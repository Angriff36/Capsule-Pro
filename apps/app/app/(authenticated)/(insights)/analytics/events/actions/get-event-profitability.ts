...
export async function getEventProfitabilityList(
  ...
  >(
    ...
    SELECT
      ...
      (CASE WHEN COALESCE(ep.budgeted_revenue, 0) <> 0 THEN ep.budgeted_gross_margin / ep.budgeted_revenue * 100 ELSE 0 END)::numeric as budgeted_gross_margin_pct,
      ...
      (CASE WHEN COALESCE(ep.actual_revenue, 0) <> 0 THEN ep.actual_gross_margin / ep.actual_revenue * 100 ELSE 0 END)::numeric as actual_gross_margin_pct,
