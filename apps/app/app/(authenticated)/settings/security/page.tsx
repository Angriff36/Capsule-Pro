 ...
 * @intent Manage API keys, review role policies, and control access settings
 * @responsibility Client component that fetches and displays API keys and role
 *   policies with full CRUD actions (view details, revoke keys).
