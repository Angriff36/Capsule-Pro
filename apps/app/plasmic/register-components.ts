...
export const registerPlasmicComponents = (
  ...
  registerFrom(
    registerFn,
    Accordion,
    "@repo/design-system/components/ui/accordion",
  ...
  registerFrom(
    registerFn,
    AlertDialog,
    "@repo/design-system/components/ui/alert-dialog",
    [
      "AlertDialog",
      "AlertDialogPortal",
      "AlertDialogOverlay",
  ...
  registerFrom(
    registerFn,
    Avatar,
    "@repo/design-system/components/ui/avatar",
  ...
  registerFrom(
    registerFn,
    Badge,
    "@repo/design-system/components/ui/badge",
    ["Badge"],
    {
      Badge: {
        props: {
  ...
  registerFrom(
    registerFn,
    Breadcrumb,
    "@repo/design-system/components/ui/breadcrumb",
    [
      "Breadcrumb",
      "BreadcrumbList",
      "BreadcrumbItem",
  ...
  registerFrom(
    registerFn,
    Button,
    "@repo/design-system/components/ui/button",
    ["Button"],
    {
      Button: {
        props: {
  ...
  registerFrom(
    registerFn,
    Calendar,
    "@repo/design-system/components/ui/calendar",
  ...
  registerFrom(
    registerFn,
    Carousel,
    "@repo/design-system/components/ui/carousel",
    [
      "Carousel",
      "CarouselContent",
      "CarouselItem",
  ...
  registerFrom(
    registerFn,
    Chart,
    "@repo/design-system/components/ui/chart",
    [
      "ChartContainer",
      "ChartTooltip",
      "ChartTooltipContent",
  ...
  registerFrom(
    registerFn,
    Checkbox,
    "@repo/design-system/components/ui/checkbox",
    ["Checkbox"],
    {
      Checkbox: {
        withChildren: false,
  ...
  registerFrom(
    registerFn,
    Collapsible,
    "@repo/design-system/components/ui/collapsible",
  ...
  registerFrom(
    registerFn,
    Command,
    "@repo/design-system/components/ui/command",
    [
      "Command",
      "CommandDialog",
      "CommandInput",
  ...
  registerFrom(
    registerFn,
    ContextMenu,
    "@repo/design-system/components/ui/context-menu",
    [
      "ContextMenu",
      "ContextMenuTrigger",
      "ContextMenuContent",
  ...
  registerFrom(
    registerFn,
    DropdownMenu,
    "@repo/design-system/components/ui/dropdown-menu",
    [
      "DropdownMenu",
      "DropdownMenuPortal",
      "DropdownMenuTrigger",
  ...
  registerFrom(
    registerFn,
    HoverCard,
    "@repo/design-system/components/ui/hover-card",
  ...
  registerFrom(
    registerFn,
    InputGroup,
    "@repo/design-system/components/ui/input-group",
    [
      "InputGroup",
      "InputGroupAddon",
      "InputGroupButton",
  ...
  registerFrom(
    registerFn,
    InputOTP,
    "@repo/design-system/components/ui/input-otp",
  ...
  registerFrom(
    registerFn,
    Input,
    "@repo/design-system/components/ui/input",
    ["Input"],
    {
      Input: {
        withChildren: false,
  ...
  registerFrom(registerFn, Label, "@repo/design-system/components/ui/label", [
    "Label",
  ]);
  ...
  registerFrom(
    registerFn,
    Menubar,
    "@repo/design-system/components/ui/menubar",
    [
      "Menubar",
      "MenubarPortal",
      "MenubarMenu",
  ...
  registerFrom(
    registerFn,
    Pagination,
    "@repo/design-system/components/ui/pagination",
    [
      "Pagination",
      "PaginationContent",
      "PaginationLink",
  ...
  registerFrom(
    registerFn,
    Popover,
    "@repo/design-system/components/ui/popover",
  ...
  registerFrom(
    registerFn,
    Progress,
    "@repo/design-system/components/ui/progress",
    ["Progress"],
    {
  ...
  registerFrom(
    registerFn,
    RadioGroup,
    "@repo/design-system/components/ui/radio-group",
  ...
  registerFrom(
    registerFn,
    Resizable,
    "@repo/design-system/components/ui/resizable",
  ...
  registerFrom(
    registerFn,
    ScrollArea,
    "@repo/design-system/components/ui/scroll-area",
  ...
  registerFrom(
    registerFn,
    Select,
    "@repo/design-system/components/ui/select",
    [
      "Select",
      "SelectContent",
      "SelectGroup",
  ...
  registerFrom(
    registerFn,
    Separator,
    "@repo/design-system/components/ui/separator",
    ["Separator"],
    {
      Separator: {
        withChildren: false,
  ...
  registerFrom(
    registerFn,
    Skeleton,
    "@repo/design-system/components/ui/skeleton",
    ["Skeleton"]
  );
  ...
  registerFrom(
    registerFn,
    Slider,
    "@repo/design-system/components/ui/slider",
    ["Slider"],
    {
      Slider: {
        withChildren: false,
  ...
  registerFrom(
    registerFn,
    Sonner,
    "@repo/design-system/components/ui/sonner",
    ["Toaster"],
    {
  ...
  registerFrom(
    registerFn,
    Spinner,
    "@repo/design-system/components/ui/spinner",
    ["Spinner"],
    {
  ...
  registerFrom(
    registerFn,
    Switch,
    "@repo/design-system/components/ui/switch",
    ["Switch"],
    {
      Switch: {
        withChildren: false,
  ...
  registerFrom(
    registerFn,
    Textarea,
    "@repo/design-system/components/ui/textarea",
    ["Textarea"],
    {
      Textarea: {
        withChildren: false,
  ...
  registerFrom(
    registerFn,
    ToggleGroup,
    "@repo/design-system/components/ui/toggle-group",
  ...
  registerFrom(
    registerFn,
    Toggle,
    "@repo/design-system/components/ui/toggle",
    ["Toggle"],
    {
      Toggle: {
        props: {
