 ...
 */
export default function AllergenWarningBannerExamples() {
  ...
  return (
    <div className="container mx-auto max-w-5xl space-y-8 p-6">
      ...
      <section className="space-y-4">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Pending Critical Warning</CardTitle>
          </CardHeader>
          <CardContent>
            <AllergenWarningBanner
        ...
        <Card>
          <CardHeader>
            <CardTitle>Resolved Critical Warning</CardTitle>
          </CardHeader>
          <CardContent>
            <AllergenWarningBanner
              onAcknowledge={handleAcknowledge}
      ...
      <section className="space-y-4">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Pending Warning</CardTitle>
          </CardHeader>
          <CardContent>
            <AllergenWarningBanner
              onAcknowledge={handleAcknowledge}
        ...
        <Card>
          <CardHeader>
            <CardTitle>Acknowledged Warning with Override Reason</CardTitle>
          </CardHeader>
          <CardContent>
            <AllergenWarningBanner
              onAcknowledge={handleAcknowledge}
      ...
      <section className="space-y-4">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Info Warning with Dismiss Option</CardTitle>
          </CardHeader>
          <CardContent>
            <AllergenWarningBanner
              onAcknowledge={handleAcknowledge}
      ...
      <section className="space-y-4">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Compact Banners</CardTitle>
          </CardHeader>
      ...
      <section className="space-y-4">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Inline Badges</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      <section className="space-y-4">
        ...
        <Card>
          <CardHeader>
            <CardTitle>All Severity Levels</CardTitle>
          </CardHeader>
          <CardContent>
