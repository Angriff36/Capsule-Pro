          ...
          <div className="flex flex-col gap-6">
            ...
            {dictionary.web.contact.hero.benefits.map((benefit, index) => (
              <div
                ...
                key={index}
              >
                <lucide_react_1.Check className="mt-2 h-4 w-4 text-primary" />
          ...
          <div className="flex items-center justify-center">
            <div className="flex max-w-sm flex-col gap-4 rounded-md border p-8">
              ...
              <div className="grid w-full max-w-sm items-center gap-1">
                ...
                <input_1.Input id="firstname" type="text" />
              </div>
              <div className="grid w-full max-w-sm items-center gap-1">
                <label_1.Label htmlFor="lastname">
                  {dictionary.web.contact.hero.form.lastName}
                </label_1.Label>
                <input_1.Input id="lastname" type="text" />
              </div>
              <div className="grid w-full max-w-sm items-center gap-1">
                <label_1.Label htmlFor="picture">
              ...
              <button_1.Button className="w-full gap-4">
