      ...
      <div className="flex flex-col items-center justify-center gap-4 text-center">
        ...
        <div className="grid w-full grid-cols-3 divide-x pt-20 text-left lg:grid-cols-4">
          ...
          <div className="flex flex-col gap-2 px-3 py-1 md:px-6 md:py-4">
            ...
            <button_1.Button asChild className="mt-8 gap-4" variant="outline">
              <link_1.default href={env_1.env.NEXT_PUBLIC_APP_URL}>
                Try it <lucide_react_1.MoveRight className="h-4 w-4" />
              </link_1.default>
            </button_1.Button>
          </div>
          <div className="flex flex-col gap-2 px-3 py-1 md:px-6 md:py-4">
            ...
            <button_1.Button asChild className="mt-8 gap-4">
              <link_1.default href={env_1.env.NEXT_PUBLIC_APP_URL}>
                Try it <lucide_react_1.MoveRight className="h-4 w-4" />
              </link_1.default>
            </button_1.Button>
          ...
          <div className="flex flex-col gap-2 px-3 py-1 md:px-6 md:py-4">
            ...
            <button_1.Button asChild className="mt-8 gap-4" variant="outline">
              <link_1.default href="/contact">
                Contact us <lucide_react_1.PhoneCall className="h-4 w-4" />
              </link_1.default>
            </button_1.Button>
          </div>
          ...
          <div className="flex justify-center px-3 py-1 md:px-6 md:py-4">
            <lucide_react_1.Check className="h-4 w-4 text-primary" />
          </div>
          <div className="flex justify-center px-3 py-1 md:px-6 md:py-4">
            <lucide_react_1.Check className="h-4 w-4 text-primary" />
          </div>
          ...
          <div className="flex justify-center px-3 py-1 md:px-6 md:py-4">
            <lucide_react_1.Minus className="h-4 w-4 text-muted-foreground" />
          </div>
          <div className="flex justify-center px-3 py-1 md:px-6 md:py-4">
            <lucide_react_1.Check className="h-4 w-4 text-primary" />
          </div>
