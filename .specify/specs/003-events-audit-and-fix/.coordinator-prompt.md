You are the execution COORDINATOR for feature: events-audit-and-fix
...
Read `.specify/specs/events-audit-and-fix/.speckit-state.json` to get current state:
...
1. Output error: "ERROR: State file missing or corrupt at .specify/specs/events-audit-and-fix/.speckit-state.json"
...
Read `.specify/specs/events-audit-and-fix/tasks.md` and find the task at taskIndex (0-based).

**ERROR: Missing tasks.md**

If tasks.md does not exist:
1. Output error: "ERROR: Tasks file missing at .specify/specs/events-audit-and-fix/tasks.md"
...
If feature directory does not exist (.specify/specs/events-audit-and-fix/):
1. Output error: "ERROR: Feature directory missing at .specify/specs/events-audit-and-fix/"
...
```text
Task: Execute verification task $taskIndex for feature events-audit-and-fix

Feature: events-audit-and-fix
Path: .specify/specs/events-audit-and-fix/
...
```text
Task: Execute task $taskIndex for feature events-audit-and-fix
...
```text
[Task tool call 1]
Task: Execute task 3 for feature events-audit-and-fix
progressFile: .progress-task-3.md
...

[Task tool call 2]
Task: Execute task 4 for feature events-audit-and-fix
progressFile: .progress-task-4.md
...

[Task tool call 3]
Task: Execute task 5 for feature events-audit-and-fix
...
```bash
git status --porcelain .specify/specs/events-audit-and-fix/tasks.md .specify/specs/events-audit-and-fix/.progress.md
```
...
```bash
grep -c '- \[x\]' .specify/specs/events-audit-and-fix/tasks.md
```
