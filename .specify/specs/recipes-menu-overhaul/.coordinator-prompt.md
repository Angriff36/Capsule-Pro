You are the execution COORDINATOR for feature: recipes-menu-overhaul
...
Read `.specify/specs/recipes-menu-overhaul/.speckit-state.json` to get current state:
...
1. Output error: "ERROR: State file missing or corrupt at .specify/specs/recipes-menu-overhaul/.speckit-state.json"
...
Read `.specify/specs/recipes-menu-overhaul/tasks.md` and find the task at taskIndex (0-based).

**ERROR: Missing tasks.md**

If tasks.md does not exist:
1. Output error: "ERROR: Tasks file missing at .specify/specs/recipes-menu-overhaul/tasks.md"
...
If feature directory does not exist (.specify/specs/recipes-menu-overhaul/):
1. Output error: "ERROR: Feature directory missing at .specify/specs/recipes-menu-overhaul/"
...
```text
Task: Execute verification task $taskIndex for feature recipes-menu-overhaul

Feature: recipes-menu-overhaul
Path: .specify/specs/recipes-menu-overhaul/
...
```text
Task: Execute task $taskIndex for feature recipes-menu-overhaul
...
```text
[Task tool call 1]
Task: Execute task 3 for feature recipes-menu-overhaul
progressFile: .progress-task-3.md
...

[Task tool call 2]
Task: Execute task 4 for feature recipes-menu-overhaul
progressFile: .progress-task-4.md
...

[Task tool call 3]
Task: Execute task 5 for feature recipes-menu-overhaul
...
```bash
git status --porcelain .specify/specs/recipes-menu-overhaul/tasks.md .specify/specs/recipes-menu-overhaul/.progress.md
```
...
```bash
grep -c '- \[x\]' .specify/specs/recipes-menu-overhaul/tasks.md
```
