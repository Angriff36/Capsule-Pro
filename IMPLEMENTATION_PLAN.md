...
> Updated 2026-05-11 (v53) — RESOLVED P1.B/partial (events: run sheet API+UI, generate proposal action, dietary/allergen UI section). P1.AM/partial (manifest-IR generator role field), P1.E/partial (calendar spec compliance) carried forward.
