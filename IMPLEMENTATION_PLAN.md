...
## Validation Baseline (2026-06-06, comprehensive audit -- 20th revision, updated batch 10)
...
- **Source to change:** `apps/api/app/api/` hand-written route files.
  ...
  - **Total migrated across all batches:** 58 mutate handlers in 44 route files. Remaining: ~133 violations across ~38 files.
