...
| **49 entities with transition declarations (141 total rules)** | ~16 entities with status properties still lack transitions (down from 65). Top gaps: cycle-count, event-automation, inventory-transfer-received. | IR analysis |
...
- **Only 8 entities have relationships** (12 declarations total). **152 entities with FK properties but NO relationship blocks**. **49 entities with transition declarations (141 total rules)**. ~16 entities with status properties still lack transitions (down from 65). Top gaps remain in: cycle-count, event-automation, inventory-transfer-received.
