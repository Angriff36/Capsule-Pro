# GoodShuffle Event Sync

## Outcome
The system maintains bi-directional sync with GoodShuffle Pro for event data. Changes in either system are reflected in the other, reducing double-entry and keeping systems aligned.
...
- Sync must never send data from one tenant to another tenant's GoodShuffle account
