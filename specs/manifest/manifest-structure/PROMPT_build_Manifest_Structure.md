...
0c. For reference, the relevant code for this project lives in `apps/api/app/api/*` and `apps/api/lib/*` and the Manifest-related packages under `packages/manifest-*`.
