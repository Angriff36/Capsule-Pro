...
0c. For reference, the relevant code for this project lives in `packages/manifest/src`, `packages/manifest/`, `apps/api/app/api`, and `packages/kitchen-ops` (manifests are in `packages/kitchen-ops/manifests`).
