// Auto-generated Next.js command handler for TestEntity.updateName
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await runtime.runCommand("updateName", body, {
    ...
    console.error("Error executing TestEntity.updateName:", error);
