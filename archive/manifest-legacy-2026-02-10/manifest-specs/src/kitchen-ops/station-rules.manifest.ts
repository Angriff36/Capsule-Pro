 ...
 * Kitchen ops manifest spec for station operations
 */

export const stationRulesManifest = `
...
export const STATION_RULES_IR_VERSION = "1.0";
export const STATION_RULES_SCHEMA_HASH = "sha256-station-rules";
