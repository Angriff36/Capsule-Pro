...
| ------ | ---------------------------------------- | ------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------- | ------- |
| AC-001 | specs/manifest-native/native-rewrite.md | WS0: zero `uuid … = ""` defaults remain in `manifest/source` (188 plan-time → **164 / 57 files** on 2026-07-11 after the administrative WS0 batch; the prior "187/69" figure was stale — live recount was 177/64 pre-batch) | `rg 'uuid.*= ""' manifest/source -g '*.manifest'` → 0 matches | PENDING |
