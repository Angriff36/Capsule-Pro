...
async function main() {
  ...
  await page.goto(`${BASE}/events/${EVENT_ID}/battle-board`, {
    waitUntil: "domcontentloaded",
    timeout: 20_000,
  });
  await page.waitForTimeout(3000);
  const boardH1 = await page
    .locator("h1")
    .textContent()
    .catch(() => "none");
  ...
  const hasBoard =
    boardContent.includes("board") || boardContent.includes("Board");
