-- MIGRATION: 20251225000119_fix_auth_hook_claims_parse.sql
-- Parse claims from event payload and merge with custom claims
...
BEGIN
  ...
  RETURN jsonb_build_object('claims', coalesce(v_existing_claims, '{}'::jsonb));
END;
$$;
