...
ULTIMATE GOAL: We want to achieve full functionality and implementation of all missing or unimplemented features, especially missing ui implementation or buttons. Consider missing elements and plan accordingly. If an element is missing, search first to confirm it doesn't exist, then if needed author the specification at specs/FILENAME.md. If you create a new element then document the plan to implement it in @IMPLEMENTATION_PLAN.md using a subagent.
