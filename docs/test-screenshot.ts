...
(async () => {
  ...
  await page.goto(
    "http://localhost:2221/sign-in?redirect_url=http%3A%2F%2Flocalhost%3A2221%2Fcommand-board%2Fdefault"
  );
  ...
  await page
    .getByRole("textbox", { name: "Username or email address" })
    .fill("unashamed366@gmail.com");
  await page.getByRole("textbox", { name: "Password" }).click();
  await page
    .getByRole("textbox", { name: "Username or email address" })
    .fill("unashamed366@gmail.comrWon22Jo5HvYCa");
  await page
