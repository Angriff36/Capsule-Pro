...
## [3. Update the existing storage files](#3-update-the-existing-storage-files)
...
## [4. Create new SSR file](#4-create-new-ssr-file)
...
## [5. Create a file router in your app](#5-create-a-file-router-in-your-app)

Create a new file in your app's `lib` directory to define the file router. This file will be used to define the file routes for your app, using your [Auth](/en/packages/authentication) package to get the current user.
...
## [6. Create a route handler](#6-create-a-route-handler)
...
## [7. Update your root layout](#7-update-your-root-layout)
...
apps/app/app/layout.tsx {4,5,7,16}
...
## [8. Update your Tailwind CSS](#8-update-your-tailwind-css)
...
## [9. Create your upload button](#9-create-your-upload-button)
...
[1. Swap out the required dependencies](#1-swap-out-the-required-dependencies)[2. Update the environment variables](#2-update-the-environment-variables)[3. Update the existing storage files](#3-update-the-existing-storage-files)[Storage](#storage)[Client](#client)[4. Create new SSR file](#4-create-new-ssr-file)[5. Create a file router in your app](#5-create-a-file-router-in-your-app)[6. Create a route handler](#6-create-a-route-handler)[7. Update your root layout](#7-update-your-root-layout)[8. Update your Tailwind CSS](#8-update-your-tailwind-css)[9. Create your upload button](#9-create-your-upload-button)[10. Advanced configuration](#10-advanced-configuration)

[GitHubEdit this page on GitHub](https://github.com/vercel/next-forge/edit/main/docs/content/docs/migrations/storage/upload-thing.mdx)Scroll to topGive feedbackCopy pageAsk AI about this pageOpen in chat
