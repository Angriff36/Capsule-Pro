...
## [3. Update the payments client](#3-update-the-payments-client)
...
## [4. Update the payments webhook handler](#4-update-the-payments-webhook-handler)
...
## [5. Use Lemon Squeezy in your app](#5-use-lemon-squeezy-in-your-app)
...
[1. Swap out the required dependencies](#1-swap-out-the-required-dependencies)[2. Update the environment variables](#2-update-the-environment-variables)[3. Update the payments client](#3-update-the-payments-client)[4. Update the payments webhook handler](#4-update-the-payments-webhook-handler)[5. Use Lemon Squeezy in your app](#5-use-lemon-squeezy-in-your-app)

[GitHubEdit this page on GitHub](https://github.com/vercel/next-forge/edit/main/docs/content/docs/migrations/payments/lemon-squeezy.mdx)Scroll to topGive feedbackCopy pageAsk AI about this pageOpen in chat
