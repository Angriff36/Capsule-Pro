...
## [1. Swap out the `auth` package dependencies](#1-swap-out-the-auth-package-dependencies)
...
## [3. Setup the server and client auth](#3-setup-the-server-and-client-auth)
...
## [4. Update the auth components](#4-update-the-auth-components)
...
## [5. Generate Prisma Models](#5-generate-prisma-models)
...
## [7. Change Middleware](#7-change-middleware)
...
## [8. Define and add Next.js Handlers to your app](#8-define-and-add-nextjs-handlers-to-your-app)
...
apps/app/app/api/auth/[...all.ts]

```
export { POST, GET } from '@repo/auth/handlers'
```

## [9. Update your apps](#9-update-your-apps)
...
[1. Swap out the `auth` package dependencies](#1-swap-out-the-auth-package-dependencies)[2. Update your environment variables](#2-update-your-environment-variables)[3. Setup the server and client auth](#3-setup-the-server-and-client-auth)[Server](#server)[Client](#client)[4. Update the auth components](#4-update-the-auth-components)[Sign In](#sign-in)[Sign Up](#sign-up)[5. Generate Prisma Models](#5-generate-prisma-models)[6. Update the Provider file](#6-update-the-provider-file)[7. Change Middleware](#7-change-middleware)[8. Define and add Next.js Handlers to your app](#8-define-and-add-nextjs-handlers-to-your-app)[9. Update your apps](#9-update-your-apps)

[GitHubEdit this page on GitHub](https://github.com/vercel/next-forge/edit/main/docs/content/docs/migrations/authentication/better-auth.mdx)Scroll to topGive feedbackCopy pageAsk AI about this pageOpen in chat
