...
This guide assumes you've already [migrated to Supabase](/en/migrations/database/supabase) for your database. If you haven't done so yet, complete that migration first.

## [1. Replace the `auth` package dependencies](#1-replace-the-auth-package-dependencies)
...
## [3. Set up the database schema for organizations](#3-set-up-the-database-schema-for-organizations)
...
## [4. Create Supabase client utilities](#4-create-supabase-client-utilities)
...
## [5. Update the middleware](#5-update-the-middleware)
...
## [6. Update the auth components](#6-update-the-auth-components)
...
## [7. Update the Provider file](#7-update-the-provider-file)
...
## [8. Implement organization management](#8-implement-organization-management)
...
## [9. Set up auth callback route](#9-set-up-auth-callback-route)
...
## [10. Update your apps](#10-update-your-apps)
...
To secure your database tables with Row Level Security (RLS) policies, see the [Supabase database migration guide](/en/migrations/database/supabase) for detailed setup instructions.

For more information, see the [Supabase Auth documentation](https://supabase.com/docs/guides/auth).

### On this page

[1. Replace the `auth` package dependencies](#1-replace-the-auth-package-dependencies)[2. Update environment variables](#2-update-environment-variables)[3. Set up the database schema for organizations](#3-set-up-the-database-schema-for-organizations)[4. Create Supabase client utilities](#4-create-supabase-client-utilities)[Server Client](#server-client)[Client Component Client](#client-component-client)[5. Update the middleware](#5-update-the-middleware)[6. Update the auth components](#6-update-the-auth-components)[Sign In](#sign-in)[Sign Up](#sign-up)[7. Update the Provider file](#7-update-the-provider-file)[8. Implement organization management](#8-implement-organization-management)[9. Set up auth callback route](#9-set-up-auth-callback-route)[10. Update your apps](#10-update-your-apps)[Server Components](#server-components)[Client Components](#client-components)[Sign Out](#sign-out)[Additional features](#additional-features)[Social Authentication](#social-authentication)[Magic Link Authentication](#magic-link-authentication)

[GitHubEdit this page on GitHub](https://github.com/vercel/next-forge/edit/main/docs/content/docs/migrations/authentication/supabase.mdx)Scroll to topGive feedbackCopy pageAsk AI about this pageOpen in chat
