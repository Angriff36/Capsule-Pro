...
## [1. Create a new database on PlanetScale](#1-create-a-new-database-on-planetscale)
...
packages/database/index.ts {3-4, 17-18}
...
## [5. Update your Prisma schema](#5-update-your-prisma-schema)

Update your Prisma schema to use the new database provider:

packages/database/prisma/schema.prisma {10}
...
## [6. Add a `dev` script](#6-add-a-dev-script)
...
[1. Create a new database on PlanetScale](#1-create-a-new-database-on-planetscale)[2. Update your environment variables](#2-update-your-environment-variables)[3. Swap out the required dependencies in `@repo/database`](#3-swap-out-the-required-dependencies-in-repodatabase)[4. Update the database connection code](#4-update-the-database-connection-code)[5. Update your Prisma schema](#5-update-your-prisma-schema)[6. Add a `dev` script](#6-add-a-dev-script)

[GitHubEdit this page on GitHub](https://github.com/vercel/next-forge/edit/main/docs/content/docs/migrations/database/planetscale.mdx)Scroll to topGive feedbackCopy pageAsk AI about this pageOpen in chat
