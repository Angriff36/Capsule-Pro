...
## [1. Create a new Prisma Postgres instance](#1-create-a-new-prisma-postgres-instance)
...
## [3. Swap out the required dependencies in `@repo/database`](#3-swap-out-the-required-dependencies-in-repodatabase)
...
## [5. Explore caching and real-time database events](#5-explore-caching-and-real-time-database-events)
...
### [Real-time database events](#real-time-database-events)
...
[1. Create a new Prisma Postgres instance](#1-create-a-new-prisma-postgres-instance)[2. Update your environment variables](#2-update-your-environment-variables)[3. Swap out the required dependencies in `@repo/database`](#3-swap-out-the-required-dependencies-in-repodatabase)[4. Update the database connection code](#4-update-the-database-connection-code)[5. Explore caching and real-time database events](#5-explore-caching-and-real-time-database-events)[Caching](#caching)[Real-time database events](#real-time-database-events)

[GitHubEdit this page on GitHub](https://github.com/vercel/next-forge/edit/main/docs/content/docs/migrations/database/prisma-postgres.mdx)Scroll to topGive feedbackCopy pageAsk AI about this pageOpen in chat
