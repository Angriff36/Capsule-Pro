...
Security is automatically enabled by the existence of the `ARCJET_KEY` environment variable.
...
## [Scaling up your security](#scaling-up-your-security)
...
### [What about DDoS attacks?](#what-about-ddos-attacks)
...
[Philosophy](#philosophy)[Configuration](#configuration)[Web](#web)[App](#app)[Scaling up your security](#scaling-up-your-security)[What about DDoS attacks?](#what-about-ddos-attacks)

[GitHubEdit this page on GitHub](https://github.com/vercel/next-forge/edit/main/docs/content/docs/packages/security/application.mdx)Scroll to topGive feedbackCopy pageAsk AI about this pageOpen in chat
