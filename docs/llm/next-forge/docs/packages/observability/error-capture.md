...
[Configuration](#configuration)[Manual Usage](#manual-usage)[Tunneling](#tunneling)

[GitHubEdit this page on GitHub](https://github.com/vercel/next-forge/edit/main/docs/content/docs/packages/observability/error-capture.mdx)Scroll to topGive feedbackCopy pageAsk AI about this pageOpen in chat
