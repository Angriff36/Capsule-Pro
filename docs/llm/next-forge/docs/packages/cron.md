...
## [How Vercel triggers cron jobs](#how-vercel-triggers-cron-jobs)
...
## [Triggering functions manually](#triggering-functions-manually)
...
[Writing functions](#writing-functions)[Scheduling functions](#scheduling-functions)[How Vercel triggers cron jobs](#how-vercel-triggers-cron-jobs)[Triggering functions manually](#triggering-functions-manually)

[GitHubEdit this page on GitHub](https://github.com/vercel/next-forge/edit/main/docs/content/docs/packages/cron.mdx)Scroll to topGive feedbackCopy pageAsk AI about this pageOpen in chat
