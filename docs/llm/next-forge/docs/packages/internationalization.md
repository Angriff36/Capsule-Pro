...
[How it works](#how-it-works)[Setup](#setup)[Configuration](#configuration)[Dictionary Structure](#dictionary-structure)[Usage](#usage)[Translating](#translating)[Frontend](#frontend)[Middleware](#middleware)

[GitHubEdit this page on GitHub](https://github.com/vercel/next-forge/edit/main/docs/content/docs/packages/internationalization.mdx)Scroll to topGive feedbackCopy pageAsk AI about this pageOpen in chat
