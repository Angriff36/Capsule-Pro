...
1. **Create `codex-plans/task_plan.md`** - Use [templates/task_plan.md](templates/task_plan.md) as reference
2. **Create `codex-plans/findings.md`** - Use [templates/findings.md](templates/findings.md) as reference
3. **Create `codex-plans/progress.md`** - Use [templates/progress.md](templates/progress.md) as reference
...
- [templates/fixes.md](templates/fixes.md) - Resolved issues log
