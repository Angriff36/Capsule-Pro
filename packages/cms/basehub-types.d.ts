...
export interface LegalPageItemComponent {
    _analyticsKey: Scalars['String']
    _dashboardUrl: Scalars['String']
    ...
    __typename: 'LegalPageItemComponent'
}
...
export interface legalPageItemComponent_AsList {
    _analyticsKey: Scalars['String']
    _dashboardUrl: Scalars['String']
    _id: Scalars['String']
    _idPath: Scalars['String']
    ...
    item: (LegalPageItemComponent | null)
...
export interface LegalGenqlSelection{
    _analyticsKey?: { __args: {
    /**
     * The scope of the analytics key. Use `send` for just ingesting data. Use `query` if you need to show an analytics data in your website.
     * 
...
export interface LegalPageItemComponentGenqlSelection{
    _analyticsKey?: { __args: {
    /**
     * The scope of the analytics key. Use `send` for just ingesting data. Use `query` if you need to show an analytics data in your website.
     * 
    ...
    title?: boolean | number
    __typename?: boolean | number
    __fragmentOn?: "LegalPageItemComponent"
}

export interface LegalPageItemComponentFilterInput {AND?: (LegalPageItemComponentFilterInput | null),OR?: (LegalPageItemComponentFilterInput | null),_id?: (StringFilter | null),_slug?: (StringFilter | null),_sys_apiNamePath?: (StringFilter | null),_sys_createdAt?: (DateFilter | null),_sys_hash?: (StringFilter | null),_sys_id?: (StringFilter | null),_sys_idPath?: (StringFilter | null),_sys_lastModifiedAt?: (DateFilter | null),_sys_slug?: (StringFilter | null),_sys_slugPath?: (StringFilter | null),_sys_title?: (StringFilter | null),_title?: (StringFilter | null),slug?: (StringFilter | null),title?: (StringFilter | null)}

export interface LegalPageItemComponentSearchInput {
...
export interface _componentsGenqlSelection{
    legalPageItem?: (legalPageItemComponent_AsListGenqlSelection & { __args?: {
    /** Filter by a field. */
    filter?: (LegalPageItemComponentFilterInput | null), 
    /** Limit the number of items returned. Defaults to 500. */
    first?: (Scalars['Int'] | null), 
    /** Order by a field. */
    orderBy?: (LegalPageItemComponentOrderByEnum | null), 
...
export interface legalPageItemComponent_AsListGenqlSelection{
    _analyticsKey?: { __args: {
    /**
     * The scope of the analytics key. Use `send` for just ingesting data. Use `query` if you need to show an analytics data in your website.
     * 
    ...
    _title?: boolean | number
    /** Returns the first item in the list, or null if the list is empty. Useful when you expect only one result. */
    item?: LegalPageItemComponentGenqlSelection
    /** Returns the list of items after filtering and paginating according to the arguments sent by the client. */
