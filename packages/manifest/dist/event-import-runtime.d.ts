 ...
 */
export declare function createEventImportRuntime(
  tenantId: string,
  userId: string
 ...
 */
export declare function processDocumentImport(
  ...
  confidence: number,
  errors?: string[]
): Promise<import("./index").CommandResult>;
/**
 * Create or update an event from parsed data
 */
export declare function createOrUpdateEvent(
  engine: RuntimeEngine,
  eventId: string | undefined,
  tenantId: string,
  parsedEvent: any
): Promise<
  | import("./index").CommandResult
  | {
      eventId: string | undefined;
      success: boolean;
      result?: unknown;
 ...
 */
export declare function generateBattleBoard(
  engine: RuntimeEngine,
 ...
 */
export declare function generateChecklist(
  engine: RuntimeEngine,
  reportId: string,
  _tenantId: string,
  _eventId: string,
