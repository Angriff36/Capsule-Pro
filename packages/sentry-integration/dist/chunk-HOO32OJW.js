...
var keys = () => createEnv({
  ...
  server: {
    ...
    SENTRY_FIXER_ENABLED: z.string().default("false").transform((val) => val === "true"),
    SENTRY_FIXER_MAX_RETRIES: z.string().default("3").transform((val) => Number.parseInt(val, 10)),
    SENTRY_FIXER_RATE_LIMIT_MINUTES: z.string().default("60").transform((val) => Number.parseInt(val, 10)),
    SENTRY_FIXER_DEDUP_MINUTES: z.string().default("30").transform((val) => Number.parseInt(val, 10)),
    ...
    SENTRY_FIXER_MAX_EXECUTION_MS: z.string().default("240000").transform((val) => Number.parseInt(val, 10)),
  ...
  runtimeEnv: {
    ...
    SENTRY_FIXER_RATE_LIMIT_MINUTES: process.env.SENTRY_FIXER_RATE_LIMIT_MINUTES,
...
//# sourceMappingURL=chunk-HOO32OJW.js.map