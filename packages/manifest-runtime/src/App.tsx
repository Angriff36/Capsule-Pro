  ...
  if (Array.isArray(value)) {
    ...
    return (
      <div>
        ...
        {open &&
          value.map((item, i) => (
            <TreeNode depth={depth + 1} key={i} label={`[${i}]`} value={item} />
          ))}
      </div>
    );
  }
  if (typeof value === "object") {
    ...
    return (
      <div>
        ...
        {open &&
          entries.map(([k, v]) => (
            <TreeNode depth={depth + 1} key={k} label={k} value={v} />
          ))}
      </div>
    );
  }
...
function Docs() {
      ...
      <div className="max-w-3xl mx-auto space-y-8">
        <section>
          ...
          <p className="text-gray-300 leading-relaxed">
            A declarative language for AI to describe software systems. Now with
            commands, computed properties, relationships, policies, stores,
            modules, and realtime events.
          </p>
  ...
  emit taskClaimed
            ...
            <div className="p-4 bg-gray-800/50 rounded-lg border border-gray-700">
              <h4 className="font-mono text-sky-400 mb-2">
                computed / derived
              </h4>
              <p className="text-sm text-gray-300 mb-2">
...
ref product: Product`}</pre>
            ...
            <div className="p-4 bg-gray-800/50 rounded-lg border border-gray-700">
              ...
              <p className="text-sm text-gray-300 mb-2">
                Auth rules - like RLS but in your spec.
              </p>
...
store Settings in localStorage { key: "app_settings" }`}</pre>
  ...
  list, get, create, update, delete
            ...
            <div className="p-4 bg-gray-800/50 rounded-lg border border-gray-700">
              ...
              <p className="text-sm text-gray-300 mb-2">
                Group related entities and commands.
              </p>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-white tracking-tight">
                Manifest{" "}
                <span className="text-sky-400 text-sm font-normal">v2.0</span>
              </h1>
      ...
      <main className="flex-1 flex overflow-hidden">
        ...
        >
          <div className="flex-shrink-0 px-4 py-2 border-b border-gray-800 bg-gray-900/50 flex items-center gap-2">
            <FileCode className="text-sky-400" size={14} />
          ...
          {errors.length > 0 && (
            <div className="flex-shrink-0 max-h-32 overflow-auto bg-rose-950/30 border-t border-rose-900/50">
              {errors.map((err, i) => (
                <div
                  className="px-4 py-2 text-sm text-rose-300 flex items-start gap-2"
                  key={i}
                >
