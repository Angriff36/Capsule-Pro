...
// Import from the main Manifest package using relative path for tsx compatibility
async function loadDependencies() {
  // Use relative import to ensure it works with tsx
  // Path from packages/cli/src/commands to packages/manifest-runtime/dist
  const projectionModule = await import(
    "../../../../dist/manifest/projections/nextjs/generator.js"
  );
