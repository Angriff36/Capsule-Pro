  ...
  async create(data) {
    const task = await this.prisma.prepTask.create({
      data: {
        ...
        startByDate: data.startByDate ? new Date(data.startByDate) : new Date(),
        dueByDate: data.dueByDate ? new Date(data.dueByDate) : new Date(),
    ...
    if (newClaimedBy && !activeClaim) {
      ...
      await this.prisma.kitchenTaskClaim.create({
        data: {
          ...
          claimedAt: data.claimedAt ? new Date(data.claimedAt) : new Date(),
        },
      });
