 ...
 */
export declare class RecipeIngredientPrismaStore
 ...
 */
export declare function createPrismaStoreProvider(
  prisma: PrismaClient,
  tenantId: string
 ...
 */
export declare function loadPrepTaskFromPrisma(
  prisma: PrismaClient,
  tenantId: string,
  taskId: string
): Promise<EntityInstance | undefined>;
 ...
 */
export declare function syncPrepTaskToPrisma(
  prisma: PrismaClient,
  tenantId: string,
 ...
 * This ensures the Manifest runtime has the current state before executing commands.
 */
export declare function loadRecipeFromPrisma(
  prisma: PrismaClient,
  tenantId: string,
  recipeId: string
): Promise<EntityInstance | undefined>;
 ...
 * Called after Manifest commands execute to persist the updated state.
 */
export declare function syncRecipeToPrisma(
  prisma: PrismaClient,
  tenantId: string,
  entity: EntityInstance
): Promise<void>;
 ...
 * This ensures the Manifest runtime has the current state before executing commands.
 */
export declare function loadDishFromPrisma(
  prisma: PrismaClient,
  tenantId: string,
  dishId: string
): Promise<EntityInstance | undefined>;
 ...
 * Called after Manifest commands execute to persist the updated state.
 */
export declare function syncDishToPrisma(
  prisma: PrismaClient,
  tenantId: string,
  entity: EntityInstance
): Promise<void>;
 ...
 * This ensures the Manifest runtime has the current state before executing commands.
 */
export declare function loadMenuFromPrisma(
  prisma: PrismaClient,
  tenantId: string,
  menuId: string
): Promise<EntityInstance | undefined>;
 ...
 * Called after Manifest commands execute to persist the updated state.
 */
export declare function syncMenuToPrisma(
  prisma: PrismaClient,
  tenantId: string,
  entity: EntityInstance
): Promise<void>;
 ...
 * This ensures the Manifest runtime has the current state before executing commands.
 */
export declare function loadMenuDishFromPrisma(
  prisma: PrismaClient,
  tenantId: string,
  menuDishId: string
): Promise<EntityInstance | undefined>;
 ...
 * Called after Manifest commands execute to persist the updated state.
 */
export declare function syncMenuDishToPrisma(
  prisma: PrismaClient,
  tenantId: string,
  entity: EntityInstance
): Promise<void>;
 ...
 * This ensures the Manifest runtime has the current state before executing commands.
 */
export declare function loadPrepListFromPrisma(
  prisma: PrismaClient,
  tenantId: string,
  prepListId: string
): Promise<EntityInstance | undefined>;
 ...
 * Called after Manifest commands execute to persist the updated state.
 */
export declare function syncPrepListToPrisma(
  prisma: PrismaClient,
  tenantId: string,
  entity: EntityInstance
): Promise<void>;
 ...
 * This ensures the Manifest runtime has the current state before executing commands.
 */
export declare function loadPrepListItemFromPrisma(
  prisma: PrismaClient,
  tenantId: string,
  itemId: string
): Promise<EntityInstance | undefined>;
 ...
 * Called after Manifest commands execute to persist the updated state.
 */
export declare function syncPrepListItemToPrisma(
  prisma: PrismaClient,
  tenantId: string,
  entity: EntityInstance
): Promise<void>;
