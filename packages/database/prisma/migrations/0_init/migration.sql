...
-- CreateTable
CREATE TABLE "public"."AiEventSetupSession" (
...
-- CreateTable
CREATE TABLE "public"."AutomatedFollowup" (
    "tenantId" TEXT NOT NULL,
    "id" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE "public"."EventWaitlistEntry" (
    "tenantId" TEXT NOT NULL,
    "id" TEXT NOT NULL,
    "eventId" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE "public"."FacilitySchedule" (
    "tenantId" TEXT NOT NULL,
    "id" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE "public"."FacilityWorkOrder" (
    "tenantId" TEXT NOT NULL,
    "id" TEXT NOT NULL,
    "facilityId" TEXT DEFAULT '',
    "areaId" TEXT DEFAULT '',
...
-- CreateTable
CREATE TABLE "public"."LogisticsDispatch" (
    "tenantId" TEXT NOT NULL,
    "id" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE "public"."PerformancePrediction" (
    "tenantId" TEXT NOT NULL,
    "id" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE "public"."VersionApproval" (
    "tenantId" TEXT NOT NULL,
    "id" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE "public"."VersionedEntity" (
    "tenantId" TEXT NOT NULL,
    "id" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE "public"."WorkforceOptimization" (
    "tenantId" TEXT NOT NULL,
    "id" TEXT NOT NULL,
...
-- CreateIndex
CREATE INDEX "api_keys_tenant_id_created_by_user_id_idx" ON "platform"."api_keys"("tenant_id" ASC, "created_by_user_id" ASC);
-- CreateIndex
CREATE INDEX "api_keys_tenant_id_expires_at_idx" ON "platform"."api_keys"("tenant_id" ASC, "expires_at" ASC);
-- CreateIndex
CREATE INDEX "api_keys_tenant_id_key_prefix_idx" ON "platform"."api_keys"("tenant_id" ASC, "key_prefix" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "api_keys_tenant_id_name_key" ON "platform"."api_keys"("tenant_id" ASC, "name" ASC);
-- CreateIndex
...
-- CreateIndex
CREATE INDEX "sentry_fix_jobs_sentry_issue_id_created_at_idx" ON "platform"."sentry_fix_jobs"("sentry_issue_id" ASC, "created_at" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "sentry_fix_jobs_sentry_issue_id_key" ON "platform"."sentry_fix_jobs"("sentry_issue_id" ASC);
-- CreateIndex
CREATE INDEX "sentry_fix_jobs_status_created_at_idx" ON "platform"."sentry_fix_jobs"("status" ASC, "created_at" ASC);
-- CreateIndex
CREATE INDEX "OutboxEvent_aggregate_type_aggregate_id_idx" ON "tenant"."OutboxEvent"("aggregate_type" ASC, "aggregate_id" ASC);
-- CreateIndex
CREATE INDEX "OutboxEvent_status_created_at_idx" ON "tenant"."OutboxEvent"("status" ASC, "created_at" ASC);
-- CreateIndex
CREATE INDEX "OutboxEvent_tenant_id_idx" ON "tenant"."OutboxEvent"("tenant_id" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "documents_tenant_id_id_key" ON "tenant"."documents"("tenant_id" ASC, "id" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "knowledge_base_entries_slug_key" ON "tenant"."knowledge_base_entries"("slug" ASC);
-- CreateIndex
CREATE INDEX "knowledge_base_entries_tenant_id_category_idx" ON "tenant"."knowledge_base_entries"("tenant_id" ASC, "category" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "knowledge_base_entries_tenant_id_slug_key" ON "tenant"."knowledge_base_entries"("tenant_id" ASC, "slug" ASC);
-- CreateIndex
CREATE INDEX "knowledge_base_entries_tenant_id_status_idx" ON "tenant"."knowledge_base_entries"("tenant_id" ASC, "status" ASC);
-- CreateIndex
...
-- CreateIndex
CREATE INDEX "manifest_entity_tenant_id_entity_type_idx" ON "tenant"."manifest_entity"("tenant_id" ASC, "entity_type" ASC);
-- CreateIndex
CREATE INDEX "manifest_idempotency_expires_at_idx" ON "tenant"."manifest_idempotency"("expires_at" ASC);
-- CreateIndex
...
-- CreateIndex
CREATE UNIQUE INDEX "venues_id_key" ON "tenant"."venues"("id" ASC);
-- CreateIndex
CREATE INDEX "venues_tenant_id_city_idx" ON "tenant"."venues"("tenant_id" ASC, "city" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "venues_tenant_id_id_key" ON "tenant"."venues"("tenant_id" ASC, "id" ASC);
-- CreateIndex
CREATE INDEX "venues_tenant_id_is_active_idx" ON "tenant"."venues"("tenant_id" ASC, "is_active" ASC);
-- CreateIndex
CREATE INDEX "venues_tenant_id_venue_type_idx" ON "tenant"."venues"("tenant_id" ASC, "venue_type" ASC);
-- CreateIndex
...
-- CreateIndex
CREATE UNIQUE INDEX "collection_actions_id_key" ON "tenant_accounting"."collection_actions"("id" ASC);
-- CreateIndex
CREATE INDEX "collection_actions_tenant_id_collection_case_id_idx" ON "tenant_accounting"."collection_actions"("tenant_id" ASC, "collection_case_id" ASC);
-- CreateIndex
CREATE INDEX "collection_actions_tenant_id_idx" ON "tenant_accounting"."collection_actions"("tenant_id" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "collection_cases_id_key" ON "tenant_accounting"."collection_cases"("id" ASC);
-- CreateIndex
CREATE INDEX "collection_cases_tenant_id_client_id_idx" ON "tenant_accounting"."collection_cases"("tenant_id" ASC, "client_id" ASC);
-- CreateIndex
CREATE INDEX "collection_cases_tenant_id_days_overdue_idx" ON "tenant_accounting"."collection_cases"("tenant_id" ASC, "days_overdue" ASC);
-- CreateIndex
CREATE INDEX "collection_cases_tenant_id_idx" ON "tenant_accounting"."collection_cases"("tenant_id" ASC);
-- CreateIndex
CREATE INDEX "collection_cases_tenant_id_invoice_id_idx" ON "tenant_accounting"."collection_cases"("tenant_id" ASC, "invoice_id" ASC);
-- CreateIndex
CREATE INDEX "collection_cases_tenant_id_status_idx" ON "tenant_accounting"."collection_cases"("tenant_id" ASC, "status" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "collection_payment_plans_id_key" ON "tenant_accounting"."collection_payment_plans"("id" ASC);
-- CreateIndex
CREATE INDEX "collection_payment_plans_tenant_id_collection_case_id_idx" ON "tenant_accounting"."collection_payment_plans"("tenant_id" ASC, "collection_case_id" ASC);
-- CreateIndex
CREATE INDEX "collection_payment_plans_tenant_id_idx" ON "tenant_accounting"."collection_payment_plans"("tenant_id" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "invoices_id_key" ON "tenant_accounting"."invoices"("id" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "invoices_invoice_number_key" ON "tenant_accounting"."invoices"("invoice_number" ASC);
-- CreateIndex
CREATE INDEX "invoices_tenant_id_client_id_idx" ON "tenant_accounting"."invoices"("tenant_id" ASC, "client_id" ASC);
-- CreateIndex
CREATE INDEX "invoices_tenant_id_due_date_idx" ON "tenant_accounting"."invoices"("tenant_id" ASC, "due_date" ASC);
-- CreateIndex
CREATE INDEX "invoices_tenant_id_event_id_idx" ON "tenant_accounting"."invoices"("tenant_id" ASC, "event_id" ASC);
-- CreateIndex
CREATE INDEX "invoices_tenant_id_idx" ON "tenant_accounting"."invoices"("tenant_id" ASC);
-- CreateIndex
CREATE INDEX "invoices_tenant_id_status_idx" ON "tenant_accounting"."invoices"("tenant_id" ASC, "status" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "payment_methods_id_key" ON "tenant_accounting"."payment_methods"("id" ASC);
-- CreateIndex
CREATE INDEX "payment_methods_tenant_id_client_id_idx" ON "tenant_accounting"."payment_methods"("tenant_id" ASC, "client_id" ASC);
-- CreateIndex
CREATE INDEX "payment_methods_tenant_id_idx" ON "tenant_accounting"."payment_methods"("tenant_id" ASC);
-- CreateIndex
CREATE INDEX "payment_methods_tenant_id_is_default_idx" ON "tenant_accounting"."payment_methods"("tenant_id" ASC, "is_default" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "payment_refund_attempts_id_key" ON "tenant_accounting"."payment_refund_attempts"("id" ASC);
-- CreateIndex
CREATE INDEX "payment_refund_attempts_tenant_id_created_at_idx" ON "tenant_accounting"."payment_refund_attempts"("tenant_id" ASC, "created_at" DESC);
-- CreateIndex
CREATE INDEX "payment_refund_attempts_tenant_id_payment_id_idx" ON "tenant_accounting"."payment_refund_attempts"("tenant_id" ASC, "payment_id" ASC);
-- CreateIndex
CREATE INDEX "payment_refund_attempts_tenant_payment_idx" ON "tenant_accounting"."payment_refund_attempts"("tenant_id" ASC, "payment_id" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "payments_id_key" ON "tenant_accounting"."payments"("id" ASC);
-- CreateIndex
CREATE INDEX "payments_tenant_id_client_id_idx" ON "tenant_accounting"."payments"("tenant_id" ASC, "client_id" ASC);
-- CreateIndex
CREATE INDEX "payments_tenant_id_event_id_idx" ON "tenant_accounting"."payments"("tenant_id" ASC, "event_id" ASC);
-- CreateIndex
CREATE INDEX "payments_tenant_id_idx" ON "tenant_accounting"."payments"("tenant_id" ASC);
-- CreateIndex
CREATE INDEX "payments_tenant_id_invoice_id_idx" ON "tenant_accounting"."payments"("tenant_id" ASC, "invoice_id" ASC);
-- CreateIndex
CREATE INDEX "payments_tenant_id_status_idx" ON "tenant_accounting"."payments"("tenant_id" ASC, "status" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "revenue_recognition_lines_id_key" ON "tenant_accounting"."revenue_recognition_lines"("id" ASC);
-- CreateIndex
CREATE INDEX "revenue_recognition_lines_tenant_id_idx" ON "tenant_accounting"."revenue_recognition_lines"("tenant_id" ASC);
-- CreateIndex
CREATE INDEX "revenue_recognition_lines_tenant_id_schedule_id_idx" ON "tenant_accounting"."revenue_recognition_lines"("tenant_id" ASC, "schedule_id" ASC);
-- CreateIndex
CREATE INDEX "revenue_recognition_lines_tenant_id_schedule_id_sequence_idx" ON "tenant_accounting"."revenue_recognition_lines"("tenant_id" ASC, "schedule_id" ASC, "sequence" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "revenue_recognition_schedules_id_key" ON "tenant_accounting"."revenue_recognition_schedules"("id" ASC);
-- CreateIndex
CREATE INDEX "revenue_recognition_schedules_tenant_id_client_id_idx" ON "tenant_accounting"."revenue_recognition_schedules"("tenant_id" ASC, "client_id" ASC);
-- CreateIndex
CREATE INDEX "revenue_recognition_schedules_tenant_id_event_id_idx" ON "tenant_accounting"."revenue_recognition_schedules"("tenant_id" ASC, "event_id" ASC);
-- CreateIndex
CREATE INDEX "revenue_recognition_schedules_tenant_id_idx" ON "tenant_accounting"."revenue_recognition_schedules"("tenant_id" ASC);
-- CreateIndex
CREATE INDEX "revenue_recognition_schedules_tenant_id_invoice_id_idx" ON "tenant_accounting"."revenue_recognition_schedules"("tenant_id" ASC, "invoice_id" ASC);
-- CreateIndex
CREATE INDEX "revenue_recognition_schedules_tenant_id_status_idx" ON "tenant_accounting"."revenue_recognition_schedules"("tenant_id" ASC, "status" ASC);
-- CreateIndex
CREATE INDEX "ActivityFeed_tenant_id_activity_type_created_at_idx" ON "tenant_admin"."ActivityFeed"("tenant_id" ASC, "activity_type" ASC, "created_at" ASC);
-- CreateIndex
CREATE INDEX "ActivityFeed_tenant_id_correlation_id_idx" ON "tenant_admin"."ActivityFeed"("tenant_id" ASC, "correlation_id" ASC);
-- CreateIndex
CREATE INDEX "ActivityFeed_tenant_id_created_at_idx" ON "tenant_admin"."ActivityFeed"("tenant_id" ASC, "created_at" ASC);
-- CreateIndex
CREATE INDEX "ActivityFeed_tenant_id_entity_type_entity_id_idx" ON "tenant_admin"."ActivityFeed"("tenant_id" ASC, "entity_type" ASC, "entity_id" ASC);
-- CreateIndex
CREATE INDEX "ActivityFeed_tenant_id_performed_by_created_at_idx" ON "tenant_admin"."ActivityFeed"("tenant_id" ASC, "performed_by" ASC, "created_at" ASC);
-- CreateIndex
...
-- CreateIndex
CREATE INDEX "email_logs_tenant_id_created_at_idx" ON "tenant_admin"."email_logs"("tenant_id" ASC, "created_at" DESC);
-- CreateIndex
CREATE INDEX "email_logs_tenant_id_recipient_email_idx" ON "tenant_admin"."email_logs"("tenant_id" ASC, "recipient_email" ASC);
-- CreateIndex
CREATE INDEX "email_logs_tenant_id_status_idx" ON "tenant_admin"."email_logs"("tenant_id" ASC, "status" ASC);
-- CreateIndex
CREATE INDEX "email_logs_tenant_id_workflow_id_idx" ON "tenant_admin"."email_logs"("tenant_id" ASC, "workflow_id" ASC);
-- CreateIndex
CREATE INDEX "email_templates_tenant_id_is_active_idx" ON "tenant_admin"."email_templates"("tenant_id" ASC, "is_active" ASC);
-- CreateIndex
CREATE INDEX "email_templates_tenant_id_is_default_idx" ON "tenant_admin"."email_templates"("tenant_id" ASC, "is_default" ASC);
-- CreateIndex
CREATE INDEX "email_templates_tenant_id_template_type_idx" ON "tenant_admin"."email_templates"("tenant_id" ASC, "template_type" ASC);
-- CreateIndex
CREATE INDEX "email_workflows_tenant_id_is_active_idx" ON "tenant_admin"."email_workflows"("tenant_id" ASC, "is_active" ASC);
-- CreateIndex
CREATE INDEX "email_workflows_tenant_id_trigger_type_idx" ON "tenant_admin"."email_workflows"("tenant_id" ASC, "trigger_type" ASC);
-- CreateIndex
CREATE INDEX "goodshuffle_event_syncs_tenant_id_convoy_event_id_idx" ON "tenant_admin"."goodshuffle_event_syncs"("tenant_id" ASC, "convoy_event_id" ASC);
-- CreateIndex
CREATE INDEX "goodshuffle_event_syncs_tenant_id_event_date_idx" ON "tenant_admin"."goodshuffle_event_syncs"("tenant_id" ASC, "event_date" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "goodshuffle_event_syncs_tenant_id_goodshuffle_event_id_key" ON "tenant_admin"."goodshuffle_event_syncs"("tenant_id" ASC, "goodshuffle_event_id" ASC);
-- CreateIndex
CREATE INDEX "goodshuffle_event_syncs_tenant_id_status_idx" ON "tenant_admin"."goodshuffle_event_syncs"("tenant_id" ASC, "status" ASC);
-- CreateIndex
CREATE INDEX "goodshuffle_inventory_syncs_tenant_id_convoy_inventory_item_idx" ON "tenant_admin"."goodshuffle_inventory_syncs"("tenant_id" ASC, "convoy_inventory_item_id" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "goodshuffle_inventory_syncs_tenant_id_goodshuffle_item_id_key" ON "tenant_admin"."goodshuffle_inventory_syncs"("tenant_id" ASC, "goodshuffle_item_id" ASC);
-- CreateIndex
CREATE INDEX "goodshuffle_inventory_syncs_tenant_id_status_idx" ON "tenant_admin"."goodshuffle_inventory_syncs"("tenant_id" ASC, "status" ASC);
-- CreateIndex
CREATE INDEX "goodshuffle_invoice_syncs_tenant_id_convoy_invoice_id_idx" ON "tenant_admin"."goodshuffle_invoice_syncs"("tenant_id" ASC, "convoy_invoice_id" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "goodshuffle_invoice_syncs_tenant_id_goodshuffle_invoice_id_key" ON "tenant_admin"."goodshuffle_invoice_syncs"("tenant_id" ASC, "goodshuffle_invoice_id" ASC);
-- CreateIndex
CREATE INDEX "goodshuffle_invoice_syncs_tenant_id_status_idx" ON "tenant_admin"."goodshuffle_invoice_syncs"("tenant_id" ASC, "status" ASC);
-- CreateIndex
CREATE INDEX "manifest_command_telemetry_executed_at_idx" ON "tenant_admin"."manifest_command_telemetry"("executed_at" ASC);
-- CreateIndex
CREATE INDEX "manifest_command_telemetry_tenant_id_command_name_executed__idx" ON "tenant_admin"."manifest_command_telemetry"("tenant_id" ASC, "command_name" ASC, "executed_at" ASC);
-- CreateIndex
CREATE INDEX "manifest_command_telemetry_tenant_id_correlation_id_idx" ON "tenant_admin"."manifest_command_telemetry"("tenant_id" ASC, "correlation_id" ASC);
-- CreateIndex
CREATE INDEX "manifest_command_telemetry_tenant_id_entity_name_executed_a_idx" ON "tenant_admin"."manifest_command_telemetry"("tenant_id" ASC, "entity_name" ASC, "executed_at" ASC);
-- CreateIndex
CREATE INDEX "manifest_command_telemetry_tenant_id_performed_by_executed__idx" ON "tenant_admin"."manifest_command_telemetry"("tenant_id" ASC, "performed_by" ASC, "executed_at" ASC);
-- CreateIndex
CREATE INDEX "manifest_command_telemetry_tenant_id_status_executed_at_idx" ON "tenant_admin"."manifest_command_telemetry"("tenant_id" ASC, "status" ASC, "executed_at" ASC);
-- CreateIndex
...
-- CreateIndex
CREATE INDEX "nowsta_employee_mappings_tenant_id_convoy_employee_id_idx" ON "tenant_admin"."nowsta_employee_mappings"("tenant_id" ASC, "convoy_employee_id" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "nowsta_employee_mappings_tenant_id_nowsta_employee_id_key" ON "tenant_admin"."nowsta_employee_mappings"("tenant_id" ASC, "nowsta_employee_id" ASC);
-- CreateIndex
CREATE INDEX "nowsta_shift_syncs_tenant_id_nowsta_employee_id_idx" ON "tenant_admin"."nowsta_shift_syncs"("tenant_id" ASC, "nowsta_employee_id" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "nowsta_shift_syncs_tenant_id_nowsta_shift_id_key" ON "tenant_admin"."nowsta_shift_syncs"("tenant_id" ASC, "nowsta_shift_id" ASC);
-- CreateIndex
CREATE INDEX "nowsta_shift_syncs_tenant_id_shift_start_idx" ON "tenant_admin"."nowsta_shift_syncs"("tenant_id" ASC, "shift_start" ASC);
-- CreateIndex
CREATE INDEX "nowsta_shift_syncs_tenant_id_status_idx" ON "tenant_admin"."nowsta_shift_syncs"("tenant_id" ASC, "status" ASC);
-- CreateIndex
CREATE INDEX "outbound_webhooks_tenant_id_created_at_idx" ON "tenant_admin"."outbound_webhooks"("tenant_id" ASC, "created_at" DESC);
-- CreateIndex
CREATE INDEX "outbound_webhooks_tenant_id_status_idx" ON "tenant_admin"."outbound_webhooks"("tenant_id" ASC, "status" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "provider_syncs_tenant_id_provider_key" ON "tenant_admin"."provider_syncs"("tenant_id" ASC, "provider" ASC);
-- CreateIndex
CREATE INDEX "provider_syncs_tenant_id_status_idx" ON "tenant_admin"."provider_syncs"("tenant_id" ASC, "status" ASC);
-- CreateIndex
CREATE INDEX "rate_limit_configs_tenant_id_is_active_idx" ON "tenant_admin"."rate_limit_configs"("tenant_id" ASC, "is_active" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "rate_limit_configs_tenant_id_name_key" ON "tenant_admin"."rate_limit_configs"("tenant_id" ASC, "name" ASC);
-- CreateIndex
CREATE INDEX "rate_limit_configs_tenant_id_priority_idx" ON "tenant_admin"."rate_limit_configs"("tenant_id" ASC, "priority" ASC);
-- CreateIndex
CREATE INDEX "rate_limit_events_tenant_id_allowed_idx" ON "tenant_admin"."rate_limit_events"("tenant_id" ASC, "allowed" ASC);
-- CreateIndex
CREATE INDEX "rate_limit_events_tenant_id_endpoint_idx" ON "tenant_admin"."rate_limit_events"("tenant_id" ASC, "endpoint" ASC);
-- CreateIndex
CREATE INDEX "rate_limit_events_tenant_id_timestamp_idx" ON "tenant_admin"."rate_limit_events"("tenant_id" ASC, "timestamp" ASC);
-- CreateIndex
CREATE INDEX "rate_limit_events_tenant_id_user_id_idx" ON "tenant_admin"."rate_limit_events"("tenant_id" ASC, "user_id" ASC);
-- CreateIndex
CREATE INDEX "rate_limit_usage_tenant_id_bucket_start_idx" ON "tenant_admin"."rate_limit_usage"("tenant_id" ASC, "bucket_start" ASC);
-- CreateIndex
CREATE INDEX "rate_limit_usage_tenant_id_endpoint_idx" ON "tenant_admin"."rate_limit_usage"("tenant_id" ASC, "endpoint" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "rate_limit_usage_tenant_id_endpoint_method_bucket_start_key" ON "tenant_admin"."rate_limit_usage"("tenant_id" ASC, "endpoint" ASC, "method" ASC, "bucket_start" ASC);
-- CreateIndex
...
-- CreateIndex
CREATE INDEX "sms_automation_rules_tenant_id_is_active_idx" ON "tenant_admin"."sms_automation_rules"("tenant_id" ASC, "is_active" ASC);
-- CreateIndex
CREATE INDEX "sms_automation_rules_tenant_id_priority_idx" ON "tenant_admin"."sms_automation_rules"("tenant_id" ASC, "priority" ASC);
-- CreateIndex
CREATE INDEX "sms_automation_rules_tenant_id_trigger_type_idx" ON "tenant_admin"."sms_automation_rules"("tenant_id" ASC, "trigger_type" ASC);
-- CreateIndex
CREATE INDEX "sms_logs_tenant_id_created_at_idx" ON "tenant_admin"."sms_logs"("tenant_id" ASC, "created_at" DESC);
-- CreateIndex
CREATE INDEX "sms_logs_tenant_id_employee_id_idx" ON "tenant_admin"."sms_logs"("tenant_id" ASC, "employee_id" ASC);
-- CreateIndex
CREATE INDEX "sms_logs_tenant_id_status_idx" ON "tenant_admin"."sms_logs"("tenant_id" ASC, "status" ASC);
-- CreateIndex
CREATE INDEX "webhook_dead_letter_queue_tenant_id_entity_type_entity_id_idx" ON "tenant_admin"."webhook_dead_letter_queue"("tenant_id" ASC, "entity_type" ASC, "entity_id" ASC);
-- CreateIndex
CREATE INDEX "webhook_dead_letter_queue_tenant_id_moved_to_dlq_at_idx" ON "tenant_admin"."webhook_dead_letter_queue"("tenant_id" ASC, "moved_to_dlq_at" DESC);
-- CreateIndex
CREATE INDEX "webhook_dead_letter_queue_tenant_id_reviewed_at_idx" ON "tenant_admin"."webhook_dead_letter_queue"("tenant_id" ASC, "reviewed_at" ASC);
-- CreateIndex
CREATE INDEX "webhook_dead_letter_queue_tenant_id_webhook_id_idx" ON "tenant_admin"."webhook_dead_letter_queue"("tenant_id" ASC, "webhook_id" ASC);
-- CreateIndex
CREATE INDEX "webhook_delivery_logs_tenant_id_created_at_idx" ON "tenant_admin"."webhook_delivery_logs"("tenant_id" ASC, "created_at" DESC);
-- CreateIndex
CREATE INDEX "webhook_delivery_logs_tenant_id_entity_type_entity_id_idx" ON "tenant_admin"."webhook_delivery_logs"("tenant_id" ASC, "entity_type" ASC, "entity_id" ASC);
-- CreateIndex
CREATE INDEX "webhook_delivery_logs_tenant_id_next_retry_at_idx" ON "tenant_admin"."webhook_delivery_logs"("tenant_id" ASC, "next_retry_at" ASC);
-- CreateIndex
CREATE INDEX "webhook_delivery_logs_tenant_id_status_idx" ON "tenant_admin"."webhook_delivery_logs"("tenant_id" ASC, "status" ASC);
-- CreateIndex
CREATE INDEX "webhook_delivery_logs_tenant_id_webhook_id_idx" ON "tenant_admin"."webhook_delivery_logs"("tenant_id" ASC, "webhook_id" ASC);
-- CreateIndex
...
-- CreateIndex
CREATE INDEX "client_contacts_client_id_idx" ON "tenant_crm"."client_contacts"("client_id" ASC);
-- CreateIndex
CREATE INDEX "client_interactions_client_id_idx" ON "tenant_crm"."client_interactions"("client_id" ASC);
-- CreateIndex
CREATE INDEX "client_interactions_employee_idx" ON "tenant_crm"."client_interactions"("employee_id" ASC);
-- CreateIndex
CREATE INDEX "client_interactions_lead_id_idx" ON "tenant_crm"."client_interactions"("lead_id" ASC);
-- CreateIndex
...
-- CreateIndex
CREATE INDEX "crm_scoring_rules_tenant_active_priority_idx" ON "tenant_crm"."crm_scoring_rules"("tenant_id" ASC, "is_active" ASC, "priority" ASC);
-- CreateIndex
...
-- CreateIndex
CREATE UNIQUE INDEX "proposal_templates_id_key" ON "tenant_crm"."proposal_templates"("id" ASC);
-- CreateIndex
CREATE INDEX "proposal_templates_tenant_id_event_type_idx" ON "tenant_crm"."proposal_templates"("tenant_id" ASC, "event_type" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "proposal_templates_tenant_id_id_key" ON "tenant_crm"."proposal_templates"("tenant_id" ASC, "id" ASC);
-- CreateIndex
CREATE INDEX "proposal_templates_tenant_id_is_active_idx" ON "tenant_crm"."proposal_templates"("tenant_id" ASC, "is_active" ASC);
-- CreateIndex
CREATE INDEX "proposal_templates_tenant_id_is_default_idx" ON "tenant_crm"."proposal_templates"("tenant_id" ASC, "is_default" ASC);
-- CreateIndex
CREATE INDEX "proposals_client_id_idx" ON "tenant_crm"."proposals"("client_id" ASC);
-- CreateIndex
CREATE INDEX "proposals_event_id_idx" ON "tenant_crm"."proposals"("event_id" ASC);
-- CreateIndex
CREATE INDEX "proposals_lead_id_idx" ON "tenant_crm"."proposals"("lead_id" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "proposals_public_token_key" ON "tenant_crm"."proposals"("public_token" ASC);
-- CreateIndex
CREATE INDEX "proposals_template_id_idx" ON "tenant_crm"."proposals"("template_id" ASC);
-- CreateIndex
...
-- CreateIndex
CREATE INDEX "board_annotations_board_id_idx" ON "tenant_events"."board_annotations"("board_id" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "board_projections_board_id_entity_type_entity_id_key" ON "tenant_events"."board_projections"("board_id" ASC, "entity_type" ASC, "entity_id" ASC);
-- CreateIndex
CREATE INDEX "board_projections_board_id_idx" ON "tenant_events"."board_projections"("board_id" ASC);
-- CreateIndex
CREATE INDEX "board_projections_entity_type_entity_id_idx" ON "tenant_events"."board_projections"("entity_type" ASC, "entity_id" ASC);
-- CreateIndex
...
-- CreateIndex
CREATE INDEX "document_versions_tenant_id_created_at_idx" ON "tenant_events"."document_versions"("tenant_id" ASC, "created_at" ASC);
-- CreateIndex
CREATE INDEX "document_versions_tenant_id_document_type_document_id_idx" ON "tenant_events"."document_versions"("tenant_id" ASC, "document_type" ASC, "document_id" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "document_versions_tenant_id_document_type_document_id_versi_key" ON "tenant_events"."document_versions"("tenant_id" ASC, "document_type" ASC, "document_id" ASC, "version_number" ASC);
-- CreateIndex
...
-- CreateIndex
CREATE INDEX "event_contracts_signing_token_idx" ON "tenant_events"."event_contracts"("signing_token" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "event_contracts_signing_token_key" ON "tenant_events"."event_contracts"("signing_token" ASC);
-- CreateIndex
...
-- CreateIndex
CREATE INDEX "event_followups_tenant_id_event_id_idx" ON "tenant_events"."event_followups"("tenant_id" ASC, "event_id" ASC);
-- CreateIndex
CREATE INDEX "event_followups_tenant_id_status_idx" ON "tenant_events"."event_followups"("tenant_id" ASC, "status" ASC);
-- CreateIndex
...
-- CreateIndex
CREATE INDEX "event_guests_event_id_rsvp_status_idx" ON "tenant_events"."event_guests"("event_id" ASC, "rsvp_status" ASC);
-- CreateIndex
CREATE INDEX "event_guests_event_id_waitlist_position_idx" ON "tenant_events"."event_guests"("event_id" ASC, "waitlist_position" ASC);
-- CreateIndex
...
-- CreateIndex
CREATE INDEX "event_timeline_event_id_idx" ON "tenant_events"."event_timeline"("event_id" ASC);
-- CreateIndex
CREATE INDEX "events_client_id_idx" ON "tenant_events"."events"("client_id" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "events_id_key" ON "tenant_events"."events"("id" ASC);
-- CreateIndex
CREATE INDEX "events_location_id_idx" ON "tenant_events"."events"("location_id" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "events_tenant_id_id_key" ON "tenant_events"."events"("tenant_id" ASC, "id" ASC);
-- CreateIndex
CREATE INDEX "idx_events_venue_entity_id" ON "tenant_events"."events"("tenant_id" ASC, "venue_entity_id" ASC);
-- CreateIndex
...
-- CreateIndex
CREATE UNIQUE INDEX "facilities_tenant_id_code_key" ON "tenant_facilities"."facilities"("tenant_id" ASC, "code" ASC);
-- CreateIndex
CREATE INDEX "facilities_tenant_id_facility_type_idx" ON "tenant_facilities"."facilities"("tenant_id" ASC, "facility_type" ASC);
-- CreateIndex
CREATE INDEX "facilities_tenant_id_status_idx" ON "tenant_facilities"."facilities"("tenant_id" ASC, "status" ASC);
-- CreateIndex
CREATE INDEX "facility_areas_tenant_id_areaType_idx" ON "tenant_facilities"."facility_areas"("tenant_id" ASC, "areaType" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "facility_areas_tenant_id_code_key" ON "tenant_facilities"."facility_areas"("tenant_id" ASC, "code" ASC);
-- CreateIndex
CREATE INDEX "facility_areas_tenant_id_venue_id_idx" ON "tenant_facilities"."facility_areas"("tenant_id" ASC, "venue_id" ASC);
-- CreateIndex
CREATE INDEX "facility_assets_tenant_id_area_id_idx" ON "tenant_facilities"."facility_assets"("tenant_id" ASC, "area_id" ASC);
-- CreateIndex
CREATE INDEX "facility_assets_tenant_id_asset_type_idx" ON "tenant_facilities"."facility_assets"("tenant_id" ASC, "asset_type" ASC);
-- CreateIndex
CREATE INDEX "facility_assets_tenant_id_status_idx" ON "tenant_facilities"."facility_assets"("tenant_id" ASC, "status" ASC);
-- CreateIndex
CREATE INDEX "maintenance_work_orders_tenant_id_area_id_idx" ON "tenant_facilities"."maintenance_work_orders"("tenant_id" ASC, "area_id" ASC);
-- CreateIndex
CREATE INDEX "maintenance_work_orders_tenant_id_priority_idx" ON "tenant_facilities"."maintenance_work_orders"("tenant_id" ASC, "priority" ASC);
-- CreateIndex
CREATE INDEX "maintenance_work_orders_tenant_id_scheduled_date_idx" ON "tenant_facilities"."maintenance_work_orders"("tenant_id" ASC, "scheduled_date" ASC);
-- CreateIndex
CREATE INDEX "maintenance_work_orders_tenant_id_status_idx" ON "tenant_facilities"."maintenance_work_orders"("tenant_id" ASC, "status" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "maintenance_work_orders_tenant_id_work_order_number_key" ON "tenant_facilities"."maintenance_work_orders"("tenant_id" ASC, "work_order_number" ASC);
-- CreateIndex
CREATE INDEX "preventive_maintenance_schedules_tenant_id_next_due_at_idx" ON "tenant_facilities"."preventive_maintenance_schedules"("tenant_id" ASC, "next_due_at" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "preventive_maintenance_schedules_tenant_id_schedule_number_key" ON "tenant_facilities"."preventive_maintenance_schedules"("tenant_id" ASC, "schedule_number" ASC);
-- CreateIndex
CREATE INDEX "preventive_maintenance_schedules_tenant_id_status_idx" ON "tenant_facilities"."preventive_maintenance_schedules"("tenant_id" ASC, "status" ASC);
-- CreateIndex
CREATE INDEX "audit_schedules_tenant_id_frequency_idx" ON "tenant_inventory"."audit_schedules"("tenant_id" ASC, "frequency" ASC);
-- CreateIndex
CREATE INDEX "audit_schedules_tenant_id_is_active_idx" ON "tenant_inventory"."audit_schedules"("tenant_id" ASC, "is_active" ASC);
-- CreateIndex
CREATE INDEX "bulk_order_rules_tenant_id_catalog_entry_id_idx" ON "tenant_inventory"."bulk_order_rules"("tenant_id" ASC, "catalog_entry_id" ASC);
-- CreateIndex
CREATE INDEX "bulk_order_rules_tenant_id_rule_type_idx" ON "tenant_inventory"."bulk_order_rules"("tenant_id" ASC, "rule_type" ASC);
-- CreateIndex
...
-- CreateIndex
CREATE INDEX "inventory_transfer_items_tenant_id_item_id_idx" ON "tenant_inventory"."inventory_transfer_items"("tenant_id" ASC, "item_id" ASC);
-- CreateIndex
CREATE INDEX "inventory_transfer_items_tenant_id_transfer_id_idx" ON "tenant_inventory"."inventory_transfer_items"("tenant_id" ASC, "transfer_id" ASC);
-- CreateIndex
CREATE INDEX "inventory_transfers_tenant_id_from_location_id_idx" ON "tenant_inventory"."inventory_transfers"("tenant_id" ASC, "from_location_id" ASC);
-- CreateIndex
CREATE INDEX "inventory_transfers_tenant_id_requested_at_idx" ON "tenant_inventory"."inventory_transfers"("tenant_id" ASC, "requested_at" ASC);
-- CreateIndex
CREATE INDEX "inventory_transfers_tenant_id_status_idx" ON "tenant_inventory"."inventory_transfers"("tenant_id" ASC, "status" ASC);
-- CreateIndex
CREATE INDEX "inventory_transfers_tenant_id_to_location_id_idx" ON "tenant_inventory"."inventory_transfers"("tenant_id" ASC, "to_location_id" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "inventory_transfers_tenant_id_transfer_number_key" ON "tenant_inventory"."inventory_transfers"("tenant_id" ASC, "transfer_number" ASC);
-- CreateIndex
CREATE INDEX "pricing_tiers_tenant_id_catalog_entry_id_idx" ON "tenant_inventory"."pricing_tiers"("tenant_id" ASC, "catalog_entry_id" ASC);
-- CreateIndex
CREATE INDEX "pricing_tiers_tenant_id_catalog_entry_id_min_quantity_idx" ON "tenant_inventory"."pricing_tiers"("tenant_id" ASC, "catalog_entry_id" ASC, "min_quantity" ASC);
-- CreateIndex
CREATE INDEX "procurement_budget_alerts_ack_idx" ON "tenant_inventory"."procurement_budget_alerts"("tenant_id" ASC, "is_acknowledged" ASC);
-- CreateIndex
CREATE INDEX "procurement_budget_alerts_budget_idx" ON "tenant_inventory"."procurement_budget_alerts"("tenant_id" ASC, "budget_id" ASC);
-- CreateIndex
CREATE INDEX "procurement_budgets_tenant_category_idx" ON "tenant_inventory"."procurement_budgets"("tenant_id" ASC, "category" ASC);
-- CreateIndex
CREATE INDEX "procurement_budgets_tenant_status_idx" ON "tenant_inventory"."procurement_budgets"("tenant_id" ASC, "status" ASC);
-- CreateIndex
CREATE INDEX "procurement_budgets_tenant_year_idx" ON "tenant_inventory"."procurement_budgets"("tenant_id" ASC, "fiscal_year" ASC);
-- CreateIndex
...
-- CreateIndex
CREATE UNIQUE INDEX "purchase_requisition_items_id_key" ON "tenant_inventory"."purchase_requisition_items"("id" ASC);
-- CreateIndex
CREATE INDEX "purchase_requisition_items_tenant_item_idx" ON "tenant_inventory"."purchase_requisition_items"("tenant_id" ASC, "item_id" ASC);
-- CreateIndex
CREATE INDEX "purchase_requisition_items_tenant_req_idx" ON "tenant_inventory"."purchase_requisition_items"("tenant_id" ASC, "requisition_id" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "purchase_requisitions_converted_to_po_id_key" ON "tenant_inventory"."purchase_requisitions"("converted_to_po_id" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "purchase_requisitions_id_key" ON "tenant_inventory"."purchase_requisitions"("id" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "purchase_requisitions_requisition_number_key" ON "tenant_inventory"."purchase_requisitions"("requisition_number" ASC);
-- CreateIndex
CREATE INDEX "purchase_requisitions_tenant_date_idx" ON "tenant_inventory"."purchase_requisitions"("tenant_id" ASC, "request_date" ASC);
-- CreateIndex
CREATE INDEX "purchase_requisitions_tenant_department_idx" ON "tenant_inventory"."purchase_requisitions"("tenant_id" ASC, "department" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "purchase_requisitions_tenant_id_id_key" ON "tenant_inventory"."purchase_requisitions"("tenant_id" ASC, "id" ASC);
-- CreateIndex
CREATE INDEX "purchase_requisitions_tenant_requester_idx" ON "tenant_inventory"."purchase_requisitions"("tenant_id" ASC, "requested_by" ASC);
-- CreateIndex
CREATE INDEX "purchase_requisitions_tenant_status_idx" ON "tenant_inventory"."purchase_requisitions"("tenant_id" ASC, "status" ASC);
-- CreateIndex
...
-- CreateIndex
CREATE INDEX "shipment_items_tenant_id_item_id_idx" ON "tenant_inventory"."shipment_items"("tenant_id" ASC, "item_id" ASC);
-- CreateIndex
CREATE INDEX "shipment_items_tenant_id_lot_number_idx" ON "tenant_inventory"."shipment_items"("tenant_id" ASC, "lot_number" ASC);
-- CreateIndex
CREATE INDEX "shipment_items_tenant_id_shipment_id_idx" ON "tenant_inventory"."shipment_items"("tenant_id" ASC, "shipment_id" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "shipments_id_key" ON "tenant_inventory"."shipments"("id" ASC);
-- CreateIndex
CREATE INDEX "shipments_location_id_idx" ON "tenant_inventory"."shipments"("location_id" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "shipments_shipment_number_key" ON "tenant_inventory"."shipments"("shipment_number" ASC);
-- CreateIndex
CREATE INDEX "shipments_tenant_id_event_id_idx" ON "tenant_inventory"."shipments"("tenant_id" ASC, "event_id" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "shipments_tenant_id_id_key" ON "tenant_inventory"."shipments"("tenant_id" ASC, "id" ASC);
-- CreateIndex
CREATE INDEX "shipments_tenant_id_status_idx" ON "tenant_inventory"."shipments"("tenant_id" ASC, "status" ASC);
-- CreateIndex
CREATE INDEX "shipments_tenant_id_supplier_id_idx" ON "tenant_inventory"."shipments"("tenant_id" ASC, "supplier_id" ASC);
-- CreateIndex
CREATE INDEX "shipments_tracking_number_idx" ON "tenant_inventory"."shipments"("tracking_number" ASC);
-- CreateIndex
CREATE INDEX "supplier_sync_logs_connector_idx" ON "tenant_inventory"."supplier_sync_logs"("connector_id" ASC);
-- CreateIndex
CREATE INDEX "supplier_sync_logs_created_at_idx" ON "tenant_inventory"."supplier_sync_logs"("created_at" ASC);
-- CreateIndex
CREATE INDEX "supplier_sync_logs_status_idx" ON "tenant_inventory"."supplier_sync_logs"("status" ASC);
-- CreateIndex
CREATE INDEX "supplier_sync_logs_tenant_supplier_idx" ON "tenant_inventory"."supplier_sync_logs"("tenant_id" ASC, "supplier_id" ASC);
-- CreateIndex
...
-- CreateIndex
CREATE INDEX "vendor_catalogs_tenant_id_category_idx" ON "tenant_inventory"."vendor_catalogs"("tenant_id" ASC, "category" ASC);
-- CreateIndex
CREATE INDEX "vendor_catalogs_tenant_id_item_number_idx" ON "tenant_inventory"."vendor_catalogs"("tenant_id" ASC, "item_number" ASC);
-- CreateIndex
CREATE INDEX "vendor_catalogs_tenant_id_supplier_id_idx" ON "tenant_inventory"."vendor_catalogs"("tenant_id" ASC, "supplier_id" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "vendor_catalogs_tenant_id_supplier_id_item_number_key" ON "tenant_inventory"."vendor_catalogs"("tenant_id" ASC, "supplier_id" ASC, "item_number" ASC);
-- CreateIndex
CREATE INDEX "vendor_contacts_tenant_supplier_idx" ON "tenant_inventory"."vendor_contacts"("tenant_id" ASC, "supplier_id" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "vendor_contracts_contract_number_key" ON "tenant_inventory"."vendor_contracts"("contract_number" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "vendor_contracts_id_key" ON "tenant_inventory"."vendor_contracts"("id" ASC);
-- CreateIndex
CREATE INDEX "vendor_contracts_tenant_end_date_idx" ON "tenant_inventory"."vendor_contracts"("tenant_id" ASC, "end_date" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "vendor_contracts_tenant_id_id_key" ON "tenant_inventory"."vendor_contracts"("tenant_id" ASC, "id" ASC);
-- CreateIndex
CREATE INDEX "vendor_contracts_tenant_status_idx" ON "tenant_inventory"."vendor_contracts"("tenant_id" ASC, "status" ASC);
-- CreateIndex
CREATE INDEX "vendor_contracts_tenant_vendor_idx" ON "tenant_inventory"."vendor_contracts"("tenant_id" ASC, "vendor_id" ASC);
-- CreateIndex
CREATE INDEX "vendor_ratings_tenant_supplier_idx" ON "tenant_inventory"."vendor_ratings"("tenant_id" ASC, "supplier_id" ASC);
-- CreateIndex
...
-- CreateIndex
CREATE UNIQUE INDEX "corrective_actions_tenant_id_action_number_key" ON "tenant_kitchen"."corrective_actions"("tenant_id" ASC, "action_number" ASC);
-- CreateIndex
CREATE INDEX "corrective_actions_tenant_id_event_id_idx" ON "tenant_kitchen"."corrective_actions"("tenant_id" ASC, "event_id" ASC);
-- CreateIndex
CREATE INDEX "corrective_actions_tenant_id_severity_idx" ON "tenant_kitchen"."corrective_actions"("tenant_id" ASC, "severity" ASC);
-- CreateIndex
CREATE INDEX "corrective_actions_tenant_id_status_idx" ON "tenant_kitchen"."corrective_actions"("tenant_id" ASC, "status" ASC);
-- CreateIndex
CREATE INDEX "dishes_recipe_id_idx" ON "tenant_kitchen"."dishes"("recipe_id" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "equipment_tenant_id_id_key" ON "tenant_kitchen"."equipment"("tenant_id" ASC, "id" ASC);
-- CreateIndex
CREATE INDEX "equipment_tenant_id_iot_device_id_idx" ON "tenant_kitchen"."equipment"("tenant_id" ASC, "iot_device_id" ASC);
-- CreateIndex
CREATE INDEX "equipment_tenant_id_location_id_idx" ON "tenant_kitchen"."equipment"("tenant_id" ASC, "location_id" ASC);
-- CreateIndex
CREATE INDEX "equipment_tenant_id_next_maintenance_date_idx" ON "tenant_kitchen"."equipment"("tenant_id" ASC, "next_maintenance_date" ASC);
-- CreateIndex
CREATE INDEX "equipment_tenant_id_status_idx" ON "tenant_kitchen"."equipment"("tenant_id" ASC, "status" ASC);
-- CreateIndex
CREATE INDEX "ingredients_allergens_idx" ON "tenant_kitchen"."ingredients" USING GIN ("allergens");
-- CreateIndex
CREATE INDEX "iot_alert_rules_tenant_id_equipment_id_idx" ON "tenant_kitchen"."iot_alert_rules"("tenant_id" ASC, "equipment_id" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "iot_alert_rules_tenant_id_id_key" ON "tenant_kitchen"."iot_alert_rules"("tenant_id" ASC, "id" ASC);
-- CreateIndex
CREATE INDEX "iot_alert_rules_tenant_id_is_active_idx" ON "tenant_kitchen"."iot_alert_rules"("tenant_id" ASC, "is_active" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "iot_alerts_tenant_id_alert_number_key" ON "tenant_kitchen"."iot_alerts"("tenant_id" ASC, "alert_number" ASC);
-- CreateIndex
CREATE INDEX "iot_alerts_tenant_id_alert_type_idx" ON "tenant_kitchen"."iot_alerts"("tenant_id" ASC, "alert_type" ASC);
-- CreateIndex
CREATE INDEX "iot_alerts_tenant_id_probe_id_idx" ON "tenant_kitchen"."iot_alerts"("tenant_id" ASC, "probe_id" ASC);
-- CreateIndex
CREATE INDEX "iot_alerts_tenant_id_status_idx" ON "tenant_kitchen"."iot_alerts"("tenant_id" ASC, "status" ASC);
-- CreateIndex
CREATE INDEX "iot_alerts_tenant_id_triggered_at_idx" ON "tenant_kitchen"."iot_alerts"("tenant_id" ASC, "triggered_at" ASC);
-- CreateIndex
...
-- CreateIndex
CREATE UNIQUE INDEX "menu_dishes_tenant_id_menu_id_dish_id_key" ON "tenant_kitchen"."menu_dishes"("tenant_id" ASC, "menu_id" ASC, "dish_id" ASC);
-- CreateIndex
...
-- CreateIndex
CREATE INDEX "prep_comments_employee_id_idx" ON "tenant_kitchen"."prep_comments"("employee_id" ASC);
-- CreateIndex
CREATE INDEX "prep_comments_task_id_idx" ON "tenant_kitchen"."prep_comments"("task_id" ASC);
-- CreateIndex
...
-- CreateIndex
CREATE INDEX "prep_task_plan_workflows_tenant_id_created_at_idx" ON "tenant_kitchen"."prep_task_plan_workflows"("tenant_id" ASC, "created_at" DESC);
-- CreateIndex
CREATE INDEX "prep_task_plan_workflows_tenant_id_event_id_idx" ON "tenant_kitchen"."prep_task_plan_workflows"("tenant_id" ASC, "event_id" ASC);
-- CreateIndex
CREATE INDEX "prep_task_plan_workflows_tenant_id_status_idx" ON "tenant_kitchen"."prep_task_plan_workflows"("tenant_id" ASC, "status" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "prep_task_plan_workflows_tenant_idempotency_key" ON "tenant_kitchen"."prep_task_plan_workflows"("tenant_id" ASC, "idempotency_key" ASC);
-- CreateIndex
CREATE INDEX "prep_task_plan_workflows_tenant_status_idx" ON "tenant_kitchen"."prep_task_plan_workflows"("tenant_id" ASC, "status" ASC);
-- CreateIndex
...
-- CreateIndex
CREATE INDEX "quality_check_items_tenant_id_check_id_idx" ON "tenant_kitchen"."quality_check_items"("tenant_id" ASC, "check_id" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "quality_checks_tenant_id_check_number_key" ON "tenant_kitchen"."quality_checks"("tenant_id" ASC, "check_number" ASC);
-- CreateIndex
CREATE INDEX "quality_checks_tenant_id_check_type_idx" ON "tenant_kitchen"."quality_checks"("tenant_id" ASC, "check_type" ASC);
-- CreateIndex
CREATE INDEX "quality_checks_tenant_id_event_id_idx" ON "tenant_kitchen"."quality_checks"("tenant_id" ASC, "event_id" ASC);
-- CreateIndex
CREATE INDEX "quality_checks_tenant_id_status_idx" ON "tenant_kitchen"."quality_checks"("tenant_id" ASC, "status" ASC);
-- CreateIndex
CREATE INDEX "recipe_ingredients_ingredient_id_idx" ON "tenant_kitchen"."recipe_ingredients"("ingredient_id" ASC);
-- CreateIndex
CREATE INDEX "recipe_ingredients_recipe_version_id_idx" ON "tenant_kitchen"."recipe_ingredients"("recipe_version_id" ASC);
-- CreateIndex
...
-- CreateIndex
CREATE INDEX "recipe_versions_recipe_id_idx" ON "tenant_kitchen"."recipe_versions"("recipe_id" ASC);
-- CreateIndex
...
-- CreateIndex
CREATE INDEX "task_claims_employee_id_idx" ON "tenant_kitchen"."task_claims"("employee_id" ASC);
-- CreateIndex
...
-- CreateIndex
CREATE INDEX "temperature_logs_tenant_id_event_id_idx" ON "tenant_kitchen"."temperature_logs"("tenant_id" ASC, "event_id" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "temperature_logs_tenant_id_log_number_key" ON "tenant_kitchen"."temperature_logs"("tenant_id" ASC, "log_number" ASC);
-- CreateIndex
CREATE INDEX "temperature_logs_tenant_id_log_type_idx" ON "tenant_kitchen"."temperature_logs"("tenant_id" ASC, "log_type" ASC);
-- CreateIndex
CREATE INDEX "temperature_logs_tenant_id_logged_at_idx" ON "tenant_kitchen"."temperature_logs"("tenant_id" ASC, "logged_at" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "temperature_probes_probe_id_key" ON "tenant_kitchen"."temperature_probes"("probe_id" ASC);
-- CreateIndex
CREATE INDEX "temperature_probes_tenant_id_location_id_idx" ON "tenant_kitchen"."temperature_probes"("tenant_id" ASC, "location_id" ASC);
-- CreateIndex
CREATE INDEX "temperature_probes_tenant_id_next_calibration_idx" ON "tenant_kitchen"."temperature_probes"("tenant_id" ASC, "next_calibration" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "temperature_probes_tenant_id_probe_id_key" ON "tenant_kitchen"."temperature_probes"("tenant_id" ASC, "probe_id" ASC);
-- CreateIndex
CREATE INDEX "temperature_probes_tenant_id_status_idx" ON "tenant_kitchen"."temperature_probes"("tenant_id" ASC, "status" ASC);
-- CreateIndex
CREATE INDEX "temperature_readings_tenant_id_event_id_idx" ON "tenant_kitchen"."temperature_readings"("tenant_id" ASC, "event_id" ASC);
-- CreateIndex
CREATE INDEX "temperature_readings_tenant_id_logged_at_idx" ON "tenant_kitchen"."temperature_readings"("tenant_id" ASC, "logged_at" ASC);
-- CreateIndex
CREATE INDEX "temperature_readings_tenant_id_probe_id_idx" ON "tenant_kitchen"."temperature_readings"("tenant_id" ASC, "probe_id" ASC);
-- CreateIndex
...
-- CreateIndex
CREATE INDEX "work_orders_tenant_id_equipment_id_idx" ON "tenant_kitchen"."work_orders"("tenant_id" ASC, "equipment_id" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "work_orders_tenant_id_id_key" ON "tenant_kitchen"."work_orders"("tenant_id" ASC, "id" ASC);
-- CreateIndex
CREATE INDEX "work_orders_tenant_id_priority_idx" ON "tenant_kitchen"."work_orders"("tenant_id" ASC, "priority" ASC);
-- CreateIndex
CREATE INDEX "work_orders_tenant_id_scheduled_date_idx" ON "tenant_kitchen"."work_orders"("tenant_id" ASC, "scheduled_date" ASC);
-- CreateIndex
CREATE INDEX "work_orders_tenant_id_status_idx" ON "tenant_kitchen"."work_orders"("tenant_id" ASC, "status" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "delivery_routes_id_key" ON "tenant_logistics"."delivery_routes"("id" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "delivery_routes_tenant_id_route_number_key" ON "tenant_logistics"."delivery_routes"("tenant_id" ASC, "route_number" ASC);
-- CreateIndex
CREATE INDEX "delivery_routes_tenant_id_scheduled_date_idx" ON "tenant_logistics"."delivery_routes"("tenant_id" ASC, "scheduled_date" ASC);
-- CreateIndex
CREATE INDEX "delivery_routes_tenant_id_status_idx" ON "tenant_logistics"."delivery_routes"("tenant_id" ASC, "status" ASC);
-- CreateIndex
CREATE INDEX "drivers_tenant_id_status_idx" ON "tenant_logistics"."drivers"("tenant_id" ASC, "status" ASC);
-- CreateIndex
CREATE INDEX "drivers_tenant_id_vehicle_id_idx" ON "tenant_logistics"."drivers"("tenant_id" ASC, "vehicle_id" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "route_stops_id_key" ON "tenant_logistics"."route_stops"("id" ASC);
-- CreateIndex
CREATE INDEX "route_stops_route_id_status_idx" ON "tenant_logistics"."route_stops"("route_id" ASC, "status" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "route_stops_route_id_stop_number_key" ON "tenant_logistics"."route_stops"("route_id" ASC, "stop_number" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "vehicles_id_key" ON "tenant_logistics"."vehicles"("id" ASC);
-- CreateIndex
CREATE INDEX "vehicles_tenant_id_status_idx" ON "tenant_logistics"."vehicles"("tenant_id" ASC, "status" ASC);
-- CreateIndex
CREATE INDEX "employee_deductions_employee_idx" ON "tenant_staff"."EmployeeDeduction"("employee_id" ASC);
-- CreateIndex
CREATE INDEX "action_milestones_action_idx" ON "tenant_staff"."action_milestones"("disciplinary_action_id" ASC);
-- CreateIndex
...
-- CreateIndex
CREATE INDEX "departments_active_idx" ON "tenant_staff"."departments"("tenant_id" ASC, "is_active" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "departments_name_unique" ON "tenant_staff"."departments"("tenant_id" ASC, "name" ASC);
-- CreateIndex
CREATE INDEX "disciplinary_actions_employee_idx" ON "tenant_staff"."disciplinary_actions"("employee_id" ASC);
-- CreateIndex
CREATE INDEX "disciplinary_actions_status_idx" ON "tenant_staff"."disciplinary_actions"("status" ASC);
-- CreateIndex
CREATE INDEX "employee_availability_employee_idx" ON "tenant_staff"."employee_availability"("employee_id" ASC);
-- CreateIndex
CREATE INDEX "employee_bank_accounts_employee_idx" ON "tenant_staff"."employee_bank_accounts"("tenant_id" ASC, "employee_id" ASC);
-- CreateIndex
CREATE INDEX "employee_bank_accounts_status_idx" ON "tenant_staff"."employee_bank_accounts"("tenant_id" ASC, "status" ASC);
-- CreateIndex
...
-- CreateIndex
CREATE UNIQUE INDEX "employee_payroll_prefs_employee_unique" ON "tenant_staff"."employee_payroll_prefs"("tenant_id" ASC, "employee_id" ASC);
-- CreateIndex
CREATE INDEX "employee_pin_access_logs_accessor_idx" ON "tenant_staff"."employee_pin_access_logs"("accessed_by_id" ASC);
-- CreateIndex
CREATE INDEX "employee_pin_access_logs_created_idx" ON "tenant_staff"."employee_pin_access_logs"("created_at" ASC);
-- CreateIndex
CREATE INDEX "employee_pin_access_logs_employee_idx" ON "tenant_staff"."employee_pin_access_logs"("employee_id" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "employee_pins_employee_id_key" ON "tenant_staff"."employee_pins"("employee_id" ASC);
-- CreateIndex
...
-- CreateIndex
CREATE UNIQUE INDEX "employee_tax_info_employee_unique" ON "tenant_staff"."employee_tax_info"("tenant_id" ASC, "employee_id" ASC);
-- CreateIndex
CREATE INDEX "employee_time_off_requests_employee_idx" ON "tenant_staff"."employee_time_off_requests"("employee_id" ASC);
-- CreateIndex
CREATE INDEX "employee_time_off_requests_start_date_idx" ON "tenant_staff"."employee_time_off_requests"("start_date" ASC);
-- CreateIndex
CREATE INDEX "employee_time_off_requests_status_idx" ON "tenant_staff"."employee_time_off_requests"("status" ASC);
-- CreateIndex
CREATE INDEX "employees_role_id_idx" ON "tenant_staff"."employees"("role_id" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "employees_tenant_auth_user_idx" ON "tenant_staff"."employees"("tenant_id" ASC, "auth_user_id" ASC);
-- CreateIndex
...
-- CreateIndex
CREATE INDEX "onboarding_completions_employee_idx" ON "tenant_staff"."onboarding_completions"("employee_id" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "onboarding_completions_unique" ON "tenant_staff"."onboarding_completions"("tenant_id" ASC, "employee_id" ASC, "task_id" ASC);
-- CreateIndex
CREATE INDEX "onboarding_tasks_type_idx" ON "tenant_staff"."onboarding_tasks"("task_type" ASC);
-- CreateIndex
CREATE INDEX "payroll_approval_history_tenant_id_payroll_run_id_idx" ON "tenant_staff"."payroll_approval_history"("tenant_id" ASC, "payroll_run_id" ASC);
-- CreateIndex
CREATE INDEX "payroll_approval_history_tenant_id_performed_by_idx" ON "tenant_staff"."payroll_approval_history"("tenant_id" ASC, "performed_by" ASC);
-- CreateIndex
CREATE INDEX "payroll_audit_log_tenant_id_action_idx" ON "tenant_staff"."payroll_audit_log"("tenant_id" ASC, "action" ASC);
-- CreateIndex
CREATE INDEX "payroll_audit_log_tenant_id_created_at_idx" ON "tenant_staff"."payroll_audit_log"("tenant_id" ASC, "created_at" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "payroll_audit_log_tenant_id_id_key" ON "tenant_staff"."payroll_audit_log"("tenant_id" ASC, "id" ASC);
-- CreateIndex
CREATE INDEX "payroll_audit_log_tenant_id_period_id_idx" ON "tenant_staff"."payroll_audit_log"("tenant_id" ASC, "period_id" ASC);
-- CreateIndex
CREATE INDEX "payroll_line_items_employee_idx" ON "tenant_staff"."payroll_line_items"("employee_id" ASC);
-- CreateIndex
CREATE INDEX "performance_reviews_employee_idx" ON "tenant_staff"."performance_reviews"("employee_id" ASC);
-- CreateIndex
CREATE INDEX "performance_reviews_reviewer_idx" ON "tenant_staff"."performance_reviews"("reviewer_id" ASC);
-- CreateIndex
CREATE INDEX "performance_reviews_scheduled_idx" ON "tenant_staff"."performance_reviews"("scheduled_date" ASC);
-- CreateIndex
CREATE INDEX "role_policies_tenant_id_is_active_idx" ON "tenant_staff"."role_policies"("tenant_id" ASC, "is_active" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "role_policies_tenant_id_role_id_key" ON "tenant_staff"."role_policies"("tenant_id" ASC, "role_id" ASC);
-- CreateIndex
...
-- CreateIndex
CREATE INDEX "tax_configurations_tenant_id_is_active_idx" ON "tenant_staff"."tax_configurations"("tenant_id" ASC, "is_active" ASC);
-- CreateIndex
CREATE INDEX "tax_configurations_tenant_id_tax_type_idx" ON "tenant_staff"."tax_configurations"("tenant_id" ASC, "tax_type" ASC);
-- CreateIndex
...
-- CreateIndex
CREATE INDEX "tip_pools_period_idx" ON "tenant_staff"."tip_pools"("tenant_id" ASC, "period_id" ASC);
-- CreateIndex
CREATE INDEX "training_assignments_employee_idx" ON "tenant_staff"."training_assignments"("employee_id" ASC);
-- CreateIndex
CREATE INDEX "training_assignments_module_idx" ON "tenant_staff"."training_assignments"("module_id" ASC);
-- CreateIndex
CREATE INDEX "training_assignments_status_idx" ON "tenant_staff"."training_assignments"("status" ASC);
-- CreateIndex
CREATE INDEX "training_completions_employee_idx" ON "tenant_staff"."training_completions"("employee_id" ASC);
-- CreateIndex
CREATE INDEX "training_completions_module_idx" ON "tenant_staff"."training_completions"("module_id" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "training_completions_unique" ON "tenant_staff"."training_completions"("tenant_id" ASC, "employee_id" ASC, "module_id" ASC);
-- CreateIndex
CREATE INDEX "training_modules_category_idx" ON "tenant_staff"."training_modules"("category" ASC);
-- CreateIndex
CREATE INDEX "training_modules_required_idx" ON "tenant_staff"."training_modules"("is_required" ASC);
-- CreateIndex
CREATE INDEX "user_preferences_tenant_id_category_idx" ON "tenant_staff"."user_preferences"("tenant_id" ASC, "category" ASC);
-- CreateIndex
CREATE UNIQUE INDEX "user_preferences_tenant_id_user_id_preference_key_category_key" ON "tenant_staff"."user_preferences"("tenant_id" ASC, "user_id" ASC, "preference_key" ASC, "category" ASC);
