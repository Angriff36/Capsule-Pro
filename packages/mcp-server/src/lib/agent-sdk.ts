...
const introspect = require(join(sdkDir, "introspect.js")) as typeof import("@angriff36/manifest/agent-sdk");
const intentMapper = require(join(sdkDir, "intent-mapper.js")) as typeof import("@angriff36/manifest/agent-sdk");
