...
function drawPageFooter(doc) {
  ...
  for (let i = 0; i < pageCount; i++) {
    ...
    doc
      ...
      .lineTo(
        exports.PAGE.width - exports.PAGE.margin,
        exports.PAGE.height - 40
      )
    ...
    doc
      ...
      .text(
        ...
        exports.PAGE.margin,
        exports.PAGE.height - 32,
        { width: exports.PAGE.contentWidth / 2, lineBreak: false }
      );
    doc
      .fontSize(7)
      .font("Helvetica")
      ...
      .text(
        ...
        exports.PAGE.width / 2,
        exports.PAGE.height - 32,
        {
          width: exports.PAGE.contentWidth / 2,
          align: "right",
          lineBreak: false,
        }
      );
