...
async function generateQuarterlyPdf(metrics, config) {
  ...
  if (referrals.length > 0) {
    ...
    y = (0, components_1.drawSectionTitle)(
      doc,
      "Referral & Lead Source Performance",
      y
    );
    y = (0, components_1.drawTable)(doc, {
      x: document_1.PAGE.margin,
      ...
      rows: referrals
        ...
        .map(([source, data]) => [
          ...
          data.count > 0
            ? (0, formatting_1.formatCurrencyFull)(
  ...
  if (metrics.recommendations.length > 0) {
    ...
    y = (0, components_1.drawTextBlock)(
      doc,
      y,
  ...
  y = (0, components_1.drawMetricCards)(
    doc,
    y,
    [
      {
        label: "Revenue Target",
        value: (0, formatting_1.formatCurrencyFull)(
          metrics.nextQuarterGoals.revenueTarget
        ),
      ...
      {
        label: "Lead Target",
        value: (0, formatting_1.formatNumber)(
          metrics.nextQuarterGoals.leadTarget
        ),
        subtext: "To hit revenue goal",
      },
      {
        label: "Conversion Target",
        value: (0, formatting_1.formatPercent)(
          metrics.nextQuarterGoals.conversionTarget
        ),
