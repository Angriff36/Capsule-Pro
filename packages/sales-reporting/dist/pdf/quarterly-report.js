...
async function generateQuarterlyPdf(metrics, config) {
    ...
    const totalDeals = Object.values(metrics.customerSegments).reduce((sum, s) => sum + s.count, 0);
    ...
    y = (0, components_1.drawMetricCards)(doc, y, [
        ...
        },
        {
            ...
            value: metrics.salesCycleLength.avg > 0
    ...
    if (referrals.length > 0) {
        ...
        y = (0, components_1.drawTable)(doc, {
            ...
            rows: referrals
                ...
                data.count > 0
                    ? (0, formatting_1.formatCurrencyFull)(Math.round(data.revenue / data.count))
                    : "$0",
            ]),
        });
    }
