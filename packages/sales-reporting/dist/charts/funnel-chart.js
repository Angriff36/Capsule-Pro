...
function drawFunnelChart(doc, options) {
  ...
  stages.forEach((stage, i) => {
    ...
    doc
      .fontSize(10)
      .font("Helvetica-Bold")
      .fillColor(types_1.COLORS.white)
      .text(stage.label, centerX - 60, labelY, {
        width: 120,
        align: "center",
        lineBreak: false,
      });
    doc
      ...
      .fillColor(types_1.COLORS.white)
      .text(
        (0, formatting_1.formatNumber)(stage.value),
        centerX - 60,
        labelY + 14,
    ...
    if (i > 0) {
      ...
      doc
        ...
        .text(rateText, topRight + 10, topY + (stageHeight - gap) / 2 - 4, {
          lineBreak: false,
        });
    }
  });
