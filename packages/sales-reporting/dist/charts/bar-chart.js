...
function drawBarChart(doc, options) {
  ...
  if (title) {
    doc
      .fontSize(11)
      .font("Helvetica-Bold")
      .fillColor(types_1.COLORS.darkText)
  ...
  for (const tick of scale.ticks) {
    ...
    doc
      .fontSize(7)
      .font("Helvetica")
      .fillColor(types_1.COLORS.lightText)
      .text(
        (0, chart_utils_1.formatAxisLabel)(tick, showCurrency),
        x,
        tickY - 4,
  ...
  data.forEach((item, i) => {
    ...
    const labelText = showCurrency
      ? (0, formatting_1.formatCurrency)(item.value)
      : (0, formatting_1.formatNumber)(item.value);
    doc
      .fontSize(7)
      .font("Helvetica-Bold")
      .fillColor(types_1.COLORS.darkText)
    ...
    doc
      .fontSize(7)
      .font("Helvetica")
      .fillColor(types_1.COLORS.mediumText)
