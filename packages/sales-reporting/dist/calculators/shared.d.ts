...
export declare function filterByDateRange(
  records: SalesRecord[],
  start: Date,
  end: Date
): SalesRecord[];
export declare function filterByStatus(
  records: SalesRecord[],
  status: SalesRecord["status"]
): SalesRecord[];
export declare function sumRevenue(records: SalesRecord[]): number;
export declare function groupBy<K extends string>(
  records: SalesRecord[],
  keyFn: (r: SalesRecord) => K
): Record<K, SalesRecord[]>;
export declare function countByStatus(
  records: SalesRecord[]
