...
async function generateSalesReport(input) {
  ...
  switch (config.reportType) {
    case "weekly": {
      const metrics = (0, calculators_1.calculateWeeklyMetrics)(
        allRecords,
        start,
        end
      );
    ...
    case "monthly": {
      const metrics = (0, calculators_1.calculateMonthlyMetrics)(
        allRecords,
        start,
        end
      );
    ...
    case "quarterly": {
      const metrics = (0, calculators_1.calculateQuarterlyMetrics)(
        allRecords,
        start,
        end
      );
