...
import { generateSalesReport, type ReportInput } from "../src/index";

async function main() {
  const csvPath = path.join(import.meta.dirname, "sample-data.csv");
  ...
  for (const report of reports) {
    ...
    const outPath = path.join(import.meta.dirname, report.filename);
