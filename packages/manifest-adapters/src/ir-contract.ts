...
function inferOwnerEntityName(ir: IR, commandName: string): string {
...
function normalizeCommandOwners(ir: IR): IRCommand[] {
 ...
 */
export function enforceCommandOwnership(ir: IR): IR {
