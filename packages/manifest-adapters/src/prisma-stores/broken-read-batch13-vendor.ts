    ...
    return {
      ...
      minimumOrderQuantity:
        row.minimumOrderQuantity != null
          ...
          : null,
      orderMultiple:
        row.orderMultiple != null ? String(row.orderMultiple) : null,
...
export class VendorContractPrismaStore implements Store<EntityInstance> {
  ...
  async update(
    ...
    try {
      ...
      if (data.minimumOrderQuantity !== undefined)
        patch.minimumOrderQuantity = toDecimalRequired(
          data.minimumOrderQuantity,
          0
        );
      if (data.annualSpendCommitment !== undefined)
        patch.annualSpendCommitment = toDecimalRequired(
          data.annualSpendCommitment,
          0
        );
      ...
      if (data.onTimeDeliveryRate !== undefined)
        patch.onTimeDeliveryRate = toDecimalRequired(
