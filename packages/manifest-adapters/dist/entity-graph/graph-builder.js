 ...
 */
export function buildGraphFromIR(ir, graph) {
 ...
 * @returns The populated graph
 */
export function buildGraphFromKnownRelationships(graph) {
    ...
    for (const rel of KNOWN_RELATIONSHIPS) {
        ...
        g.addEdge(createEdge(sourceId, targetId, rel.type, rel.name, {
 ...
 */
export function getKnownRelationships() {
...
export function getRelationshipsForEntity(entityName) {
    return KNOWN_RELATIONSHIPS.filter((r) => r.from === entityName || r.to === entityName);
}
/**
 * Get outgoing relationships from an entity.
 */
export function getOutgoingRelationships(entityName) {
    return KNOWN_RELATIONSHIPS.filter((r) => r.from === entityName);
}
/**
 * Get incoming relationships to an entity.
 */
export function getIncomingRelationships(entityName) {
