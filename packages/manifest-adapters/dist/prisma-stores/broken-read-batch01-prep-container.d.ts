...
export declare class PrepMethodPrismaStore implements Store<EntityInstance> {
...
export declare class ContainerPrismaStore implements Store<EntityInstance> {
    private readonly prisma;
    private readonly tenantId;
    constructor(prisma: PrismaClient, tenantId: string);
    getAll(): Promise<EntityInstance[]>;
...
//# sourceMappingURL=broken-read-batch01-prep-container.d.ts.map