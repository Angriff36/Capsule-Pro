...
// ---------------------------------------------------------------------------
export class CycleCountSessionPrismaStore {
    prisma;
    tenantId;
    ...
    async update(id, data) {
        try {
            ...
            if (data.sessionName !== undefined)
                patch.sessionName = data.sessionName;
    ...
    async update(id, data) {
        try {
            ...
            if (data.portionSizeDescription !== undefined)
                patch.portionSizeDescription = asNullableString(data.portionSizeDescription);
