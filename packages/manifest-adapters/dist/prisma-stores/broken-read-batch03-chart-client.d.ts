...
export declare class ChartOfAccountPrismaStore implements Store<EntityInstance> {
...
export declare class ClientPrismaStore implements Store<EntityInstance> {
    private readonly prisma;
    private readonly tenantId;
    constructor(prisma: PrismaClient, tenantId: string);
    getAll(): Promise<EntityInstance[]>;
...
//# sourceMappingURL=broken-read-batch03-chart-client.d.ts.map