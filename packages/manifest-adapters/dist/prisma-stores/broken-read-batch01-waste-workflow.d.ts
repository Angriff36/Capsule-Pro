...
export declare class WasteEntryPrismaStore implements Store<EntityInstance> {
...
export declare class WorkflowPrismaStore implements Store<EntityInstance> {
    private readonly prisma;
    private readonly tenantId;
    constructor(prisma: PrismaClient, tenantId: string);
    getAll(): Promise<EntityInstance[]>;
...
//# sourceMappingURL=broken-read-batch01-waste-workflow.d.ts.map