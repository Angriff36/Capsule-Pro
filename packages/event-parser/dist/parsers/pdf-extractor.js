 ...
 */
const HEADER_PATTERN = /^category item special, production notes, container quantity\/?unit$/;
...
export async function extractPdfText(pdfBuffer) {
    ...
    try {
        ...
        errors.push(`Failed to load PDF: ${e instanceof Error ? e.message : "Unknown error"}`);
        return {
            lines: [],
            pageCount: 0,
            errors,
