...
export function updateChecklistQuestion(
  checklist: EventChecklist,
  questionId: string,
  updates: { value?: string | null; notes?: string | null }
): EventChecklist {
  let changed = false;
...
function buildBasicInfoSection(event: ParsedEvent): ChecklistSectionState {
...
function buildMenuSection(event: ParsedEvent): ChecklistSectionState {
...
function buildStaffingSection(event: ParsedEvent): ChecklistSectionState {
...
function buildTimelineSection(event: ParsedEvent): ChecklistSectionState {
...
function buildEquipmentSection(event: ParsedEvent): ChecklistSectionState {
...
function buildAdditionalSection(event: ParsedEvent): ChecklistSectionState {
...
function detectCustomMenuItems(event: ParsedEvent): {
  present: AutoAnswer;
  reviewed: AutoAnswer;
...
function summarizeStaffing(event: ParsedEvent): {
  lead: string;
  leadReason?: string;
  support: string;
...
function detectEquipmentNeeds(event: ParsedEvent): {
  value: string | null;
  notes?: string;
  autoReason?: string;
  changes?: string;
