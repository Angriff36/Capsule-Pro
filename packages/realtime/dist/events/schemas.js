 ...
 */
export const CommandBoardConnectionCreatedEventSchema = RealtimeEventBaseSchema.extend({
    eventType: z.literal("command.board.connection.created"),
    payload: CommandBoardConnectionCreatedPayloadSchema,
});
export const CommandBoardConnectionUpdatedEventSchema = RealtimeEventBaseSchema.extend({
    eventType: z.literal("command.board.connection.updated"),
    payload: CommandBoardConnectionUpdatedPayloadSchema,
});
export const CommandBoardConnectionDeletedEventSchema = RealtimeEventBaseSchema.extend({
 ...
 */
export function isKitchenEvent(data) {
 ...
 */
export function isCommandBoardEvent(data) {
    const result = parseRealtimeEvent(data);
    if (!result.success) {
        return false;
    }
 ...
 */
export function isInventoryStockEvent(data) {
    const result = parseRealtimeEvent(data);
    if (!result.success) {
        return false;
    }
